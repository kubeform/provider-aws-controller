...
// +kubebuilder:rbac:groups=iot.aws.kubeform.com,resources=policyattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iot.aws.kubeform.com,resources=policyattachments/status,verbs=get;update;patch
...
func (r *PolicyAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iotv1alpha1.PolicyAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", iotv1alpha1.PolicyAttachment{}.APIVersion, iotv1alpha1.PolicyAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iotv1alpha1.PolicyAttachment{}).
