...
// +kubebuilder:rbac:groups=backup.aws.kubeform.com,resources=vaults,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=backup.aws.kubeform.com,resources=vaults/status,verbs=get;update;patch
...
func (r *VaultReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &backupv1alpha1.Vault{}); err != nil {
			klog.Error(err, "unable to set up auditor", backupv1alpha1.Vault{}.APIVersion, backupv1alpha1.Vault{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&backupv1alpha1.Vault{}).
