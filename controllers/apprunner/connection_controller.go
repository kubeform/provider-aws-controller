...
// +kubebuilder:rbac:groups=apprunner.aws.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apprunner.aws.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apprunnerv1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", apprunnerv1alpha1.Connection{}.APIVersion, apprunnerv1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apprunnerv1alpha1.Connection{}).
