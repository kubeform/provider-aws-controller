...
// +kubebuilder:rbac:groups=lakeformation.aws.kubeform.com,resources=permissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lakeformation.aws.kubeform.com,resources=permissions/status,verbs=get;update;patch
...
func (r *PermissionsReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lakeformationv1alpha1.Permissions{}); err != nil {
			klog.Error(err, "unable to set up auditor", lakeformationv1alpha1.Permissions{}.APIVersion, lakeformationv1alpha1.Permissions{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lakeformationv1alpha1.Permissions{}).
