...
// +kubebuilder:rbac:groups=codestarconnections.aws.kubeform.com,resources=hosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codestarconnections.aws.kubeform.com,resources=hosts/status,verbs=get;update;patch
...
func (r *HostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codestarconnectionsv1alpha1.Host{}); err != nil {
			klog.Error(err, "unable to set up auditor", codestarconnectionsv1alpha1.Host{}.APIVersion, codestarconnectionsv1alpha1.Host{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codestarconnectionsv1alpha1.Host{}).
