...
// +kubebuilder:rbac:groups=docdb.aws.kubeform.com,resources=clustersnapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=docdb.aws.kubeform.com,resources=clustersnapshots/status,verbs=get;update;patch
...
func (r *ClusterSnapshotReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &docdbv1alpha1.ClusterSnapshot{}); err != nil {
			klog.Error(err, "unable to set up auditor", docdbv1alpha1.ClusterSnapshot{}.APIVersion, docdbv1alpha1.ClusterSnapshot{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&docdbv1alpha1.ClusterSnapshot{}).
