...
// +kubebuilder:rbac:groups=docdb.aws.kubeform.com,resources=clusterparametergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=docdb.aws.kubeform.com,resources=clusterparametergroups/status,verbs=get;update;patch
...
func (r *ClusterParameterGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &docdbv1alpha1.ClusterParameterGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", docdbv1alpha1.ClusterParameterGroup{}.APIVersion, docdbv1alpha1.ClusterParameterGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&docdbv1alpha1.ClusterParameterGroup{}).
