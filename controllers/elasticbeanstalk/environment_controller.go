...
// +kubebuilder:rbac:groups=elasticbeanstalk.aws.kubeform.com,resources=environments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticbeanstalk.aws.kubeform.com,resources=environments/status,verbs=get;update;patch
...
func (r *EnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &elasticbeanstalkv1alpha1.Environment{}); err != nil {
			klog.Error(err, "unable to set up auditor", elasticbeanstalkv1alpha1.Environment{}.APIVersion, elasticbeanstalkv1alpha1.Environment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&elasticbeanstalkv1alpha1.Environment{}).
