...
// +kubebuilder:rbac:groups=dax.aws.kubeform.com,resources=parametergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dax.aws.kubeform.com,resources=parametergroups/status,verbs=get;update;patch
...
func (r *ParameterGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &daxv1alpha1.ParameterGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", daxv1alpha1.ParameterGroup{}.APIVersion, daxv1alpha1.ParameterGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&daxv1alpha1.ParameterGroup{}).
