...
// +kubebuilder:rbac:groups=mq.aws.kubeform.com,resources=brokers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mq.aws.kubeform.com,resources=brokers/status,verbs=get;update;patch
...
func (r *BrokerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Broker")
...
func (r *BrokerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mqv1alpha1.Broker{}); err != nil {
			klog.Error(err, "unable to set up auditor", mqv1alpha1.Broker{}.APIVersion, mqv1alpha1.Broker{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mqv1alpha1.Broker{}).
...
func (r *BrokerReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Broker")
			return nil
		}
