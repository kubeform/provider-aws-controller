...
// +kubebuilder:rbac:groups=guardduty.aws.kubeform.com,resources=filters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=guardduty.aws.kubeform.com,resources=filters/status,verbs=get;update;patch
...
func (r *FilterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &guarddutyv1alpha1.Filter{}); err != nil {
			klog.Error(err, "unable to set up auditor", guarddutyv1alpha1.Filter{}.APIVersion, guarddutyv1alpha1.Filter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&guarddutyv1alpha1.Filter{}).
