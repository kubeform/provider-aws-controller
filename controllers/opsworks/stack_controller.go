...
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=stacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=stacks/status,verbs=get;update;patch
...
func (r *StackReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &opsworksv1alpha1.Stack{}); err != nil {
			klog.Error(err, "unable to set up auditor", opsworksv1alpha1.Stack{}.APIVersion, opsworksv1alpha1.Stack{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&opsworksv1alpha1.Stack{}).
...
func (r *StackReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Stack")
			return nil
		}
		...
		resourceList := &opsworksv1alpha1.StackList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Stack")
			return nil
		}
