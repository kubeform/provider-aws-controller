...
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=userprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=userprofiles/status,verbs=get;update;patch
...
func (r *UserProfileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &opsworksv1alpha1.UserProfile{}); err != nil {
			klog.Error(err, "unable to set up auditor", opsworksv1alpha1.UserProfile{}.APIVersion, opsworksv1alpha1.UserProfile{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&opsworksv1alpha1.UserProfile{}).
