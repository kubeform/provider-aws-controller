...
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=opsworks.aws.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &opsworksv1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", opsworksv1alpha1.Instance{}.APIVersion, opsworksv1alpha1.Instance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&opsworksv1alpha1.Instance{}).
