...
// +kubebuilder:rbac:groups=codepipeline.aws.kubeform.com,resources=webhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codepipeline.aws.kubeform.com,resources=webhooks/status,verbs=get;update;patch
...
func (r *WebhookReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codepipelinev1alpha1.Webhook{}); err != nil {
			klog.Error(err, "unable to set up auditor", codepipelinev1alpha1.Webhook{}.APIVersion, codepipelinev1alpha1.Webhook{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codepipelinev1alpha1.Webhook{}).
...
func (r *WebhookReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Webhook")
			return nil
		}
		...
		resourceList := &codepipelinev1alpha1.WebhookList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Webhook")
			return nil
		}
