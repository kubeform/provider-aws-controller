...
// +kubebuilder:rbac:groups=transfer.aws.kubeform.com,resources=sshkeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=transfer.aws.kubeform.com,resources=sshkeys/status,verbs=get;update;patch
...
func (r *SshKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &transferv1alpha1.SshKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", transferv1alpha1.SshKey{}.APIVersion, transferv1alpha1.SshKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&transferv1alpha1.SshKey{}).
