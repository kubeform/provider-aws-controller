...
// +kubebuilder:rbac:groups=ses.aws.kubeform.com,resources=templates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ses.aws.kubeform.com,resources=templates/status,verbs=get;update;patch
...
func (r *TemplateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sesv1alpha1.Template{}); err != nil {
			klog.Error(err, "unable to set up auditor", sesv1alpha1.Template{}.APIVersion, sesv1alpha1.Template{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sesv1alpha1.Template{}).
