...
// +kubebuilder:rbac:groups=devicefarm.aws.kubeform.com,resources=instanceprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=devicefarm.aws.kubeform.com,resources=instanceprofiles/status,verbs=get;update;patch

func (r *InstanceProfileReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch InstanceProfile")
...
func (r *InstanceProfileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &devicefarmv1alpha1.InstanceProfile{}); err != nil {
			klog.Error(err, "unable to set up auditor", devicefarmv1alpha1.InstanceProfile{}.APIVersion, devicefarmv1alpha1.InstanceProfile{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&devicefarmv1alpha1.InstanceProfile{}).
