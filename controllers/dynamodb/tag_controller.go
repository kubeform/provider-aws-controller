...
// +kubebuilder:rbac:groups=dynamodb.aws.kubeform.com,resources=tags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dynamodb.aws.kubeform.com,resources=tags/status,verbs=get;update;patch
...
func (r *TagReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dynamodbv1alpha1.Tag{}); err != nil {
			klog.Error(err, "unable to set up auditor", dynamodbv1alpha1.Tag{}.APIVersion, dynamodbv1alpha1.Tag{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dynamodbv1alpha1.Tag{}).
