...
// +kubebuilder:rbac:groups=imagebuilder.aws.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=imagebuilder.aws.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &imagebuilderv1alpha1.Image{}); err != nil {
			klog.Error(err, "unable to set up auditor", imagebuilderv1alpha1.Image{}.APIVersion, imagebuilderv1alpha1.Image{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&imagebuilderv1alpha1.Image{}).
