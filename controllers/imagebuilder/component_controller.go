...
// +kubebuilder:rbac:groups=imagebuilder.aws.kubeform.com,resources=components,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=imagebuilder.aws.kubeform.com,resources=components/status,verbs=get;update;patch
...
func (r *ComponentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &imagebuilderv1alpha1.Component{}); err != nil {
			klog.Error(err, "unable to set up auditor", imagebuilderv1alpha1.Component{}.APIVersion, imagebuilderv1alpha1.Component{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&imagebuilderv1alpha1.Component{}).
