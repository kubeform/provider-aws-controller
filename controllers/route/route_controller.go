...
// +kubebuilder:rbac:groups=route.aws.kubeform.com,resources=routes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route.aws.kubeform.com,resources=routes/status,verbs=get;update;patch
...
func (r *RouteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &routev1alpha1.Route{}); err != nil {
			klog.Error(err, "unable to set up auditor", routev1alpha1.Route{}.APIVersion, routev1alpha1.Route{}.Kind)
			return err
		}
	}
