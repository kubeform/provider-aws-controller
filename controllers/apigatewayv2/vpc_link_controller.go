...
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=vpclinks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=vpclinks/status,verbs=get;update;patch

func (r *VpcLinkReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch VpcLink")
...
func (r *VpcLinkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv2v1alpha1.VpcLink{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv2v1alpha1.VpcLink{}.APIVersion, apigatewayv2v1alpha1.VpcLink{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv2v1alpha1.VpcLink{}).
