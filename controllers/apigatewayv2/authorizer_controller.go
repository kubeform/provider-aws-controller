...
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=authorizers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=authorizers/status,verbs=get;update;patch
...
func (r *AuthorizerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv2v1alpha1.Authorizer{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv2v1alpha1.Authorizer{}.APIVersion, apigatewayv2v1alpha1.Authorizer{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv2v1alpha1.Authorizer{}).
