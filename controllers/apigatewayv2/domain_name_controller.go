...
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=domainnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigatewayv2.aws.kubeform.com,resources=domainnames/status,verbs=get;update;patch
...
func (r *DomainNameReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv2v1alpha1.DomainName{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv2v1alpha1.DomainName{}.APIVersion, apigatewayv2v1alpha1.DomainName{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv2v1alpha1.DomainName{}).
