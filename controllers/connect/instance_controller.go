...
// +kubebuilder:rbac:groups=connect.aws.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=connect.aws.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &connectv1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", connectv1alpha1.Instance{}.APIVersion, connectv1alpha1.Instance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&connectv1alpha1.Instance{}).
