...
// +kubebuilder:rbac:groups=connect.aws.kubeform.com,resources=queues,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=connect.aws.kubeform.com,resources=queues/status,verbs=get;update;patch
...
func (r *QueueReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &connectv1alpha1.Queue{}); err != nil {
			klog.Error(err, "unable to set up auditor", connectv1alpha1.Queue{}.APIVersion, connectv1alpha1.Queue{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&connectv1alpha1.Queue{}).
