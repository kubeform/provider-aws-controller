...
// +kubebuilder:rbac:groups=swf.aws.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=swf.aws.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &swfv1alpha1.Domain{}); err != nil {
			klog.Error(err, "unable to set up auditor", swfv1alpha1.Domain{}.APIVersion, swfv1alpha1.Domain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&swfv1alpha1.Domain{}).
