...
// +kubebuilder:rbac:groups=ebs.aws.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ebs.aws.kubeform.com,resources=volumes/status,verbs=get;update;patch
...
func (r *VolumeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ebsv1alpha1.Volume{}); err != nil {
			klog.Error(err, "unable to set up auditor", ebsv1alpha1.Volume{}.APIVersion, ebsv1alpha1.Volume{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ebsv1alpha1.Volume{}).
