...
// +kubebuilder:rbac:groups=alb.aws.kubeform.com,resources=albs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alb.aws.kubeform.com,resources=albs/status,verbs=get;update;patch
...
func (r *AlbReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &albv1alpha1.Alb{}); err != nil {
			klog.Error(err, "unable to set up auditor", albv1alpha1.Alb{}.APIVersion, albv1alpha1.Alb{}.Kind)
			return err
		}
	}
