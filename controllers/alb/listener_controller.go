...
// +kubebuilder:rbac:groups=alb.aws.kubeform.com,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alb.aws.kubeform.com,resources=listeners/status,verbs=get;update;patch
...
func (r *ListenerReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &albv1alpha1.ListenerList{}
