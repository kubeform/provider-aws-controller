...
// +kubebuilder:rbac:groups=fsx.aws.kubeform.com,resources=backups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=fsx.aws.kubeform.com,resources=backups/status,verbs=get;update;patch
...
func (r *BackupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &fsxv1alpha1.Backup{}); err != nil {
			klog.Error(err, "unable to set up auditor", fsxv1alpha1.Backup{}.APIVersion, fsxv1alpha1.Backup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&fsxv1alpha1.Backup{}).
