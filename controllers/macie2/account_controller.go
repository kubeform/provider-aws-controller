...
// +kubebuilder:rbac:groups=macie2.aws.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=macie2.aws.kubeform.com,resources=accounts/status,verbs=get;update;patch
...
func (r *AccountReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &macie2v1alpha1.Account{}); err != nil {
			klog.Error(err, "unable to set up auditor", macie2v1alpha1.Account{}.APIVersion, macie2v1alpha1.Account{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&macie2v1alpha1.Account{}).
