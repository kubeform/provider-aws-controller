...
// +kubebuilder:rbac:groups=macie2.aws.kubeform.com,resources=members,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=macie2.aws.kubeform.com,resources=members/status,verbs=get;update;patch
...
func (r *MemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &macie2v1alpha1.Member{}); err != nil {
			klog.Error(err, "unable to set up auditor", macie2v1alpha1.Member{}.APIVersion, macie2v1alpha1.Member{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&macie2v1alpha1.Member{}).
