...
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=builds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=builds/status,verbs=get;update;patch

func (r *BuildReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("build", req.NamespacedName)
...
func (r *BuildReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gameliftv1alpha1.Build{}); err != nil {
			klog.Error(err, "unable to set up auditor", gameliftv1alpha1.Build{}.APIVersion, gameliftv1alpha1.Build{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gameliftv1alpha1.Build{}).
