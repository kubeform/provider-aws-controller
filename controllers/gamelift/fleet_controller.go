...
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=fleet,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=fleet/status,verbs=get;update;patch
...
func (r *FleetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gameliftv1alpha1.Fleet{}); err != nil {
			klog.Error(err, "unable to set up auditor", gameliftv1alpha1.Fleet{}.APIVersion, gameliftv1alpha1.Fleet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gameliftv1alpha1.Fleet{}).
