...
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=aliases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gamelift.aws.kubeform.com,resources=aliases/status,verbs=get;update;patch
...
func (r *AliasReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gameliftv1alpha1.Alias{}); err != nil {
			klog.Error(err, "unable to set up auditor", gameliftv1alpha1.Alias{}.APIVersion, gameliftv1alpha1.Alias{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gameliftv1alpha1.Alias{}).
