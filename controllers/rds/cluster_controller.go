...
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rdsv1alpha1.Cluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", rdsv1alpha1.Cluster{}.APIVersion, rdsv1alpha1.Cluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rdsv1alpha1.Cluster{}).
...
func (r *ClusterReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &rdsv1alpha1.ClusterList{}
