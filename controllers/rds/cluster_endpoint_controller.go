...
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusterendpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusterendpoints/status,verbs=get;update;patch
...
func (r *ClusterEndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rdsv1alpha1.ClusterEndpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", rdsv1alpha1.ClusterEndpoint{}.APIVersion, rdsv1alpha1.ClusterEndpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rdsv1alpha1.ClusterEndpoint{}).
