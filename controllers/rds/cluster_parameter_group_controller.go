...
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusterparametergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rds.aws.kubeform.com,resources=clusterparametergroups/status,verbs=get;update;patch
...
func (r *ClusterParameterGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &rdsv1alpha1.ClusterParameterGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", rdsv1alpha1.ClusterParameterGroup{}.APIVersion, rdsv1alpha1.ClusterParameterGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&rdsv1alpha1.ClusterParameterGroup{}).
