...
// +kubebuilder:rbac:groups=dx.aws.kubeform.com,resources=bgppeers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dx.aws.kubeform.com,resources=bgppeers/status,verbs=get;update;patch
...
func (r *BgpPeerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dxv1alpha1.BgpPeer{}); err != nil {
			klog.Error(err, "unable to set up auditor", dxv1alpha1.BgpPeer{}.APIVersion, dxv1alpha1.BgpPeer{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dxv1alpha1.BgpPeer{}).
