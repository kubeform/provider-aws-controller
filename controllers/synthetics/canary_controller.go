...
// +kubebuilder:rbac:groups=synthetics.aws.kubeform.com,resources=canaries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=synthetics.aws.kubeform.com,resources=canaries/status,verbs=get;update;patch
...
func (r *CanaryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &syntheticsv1alpha1.Canary{}); err != nil {
			klog.Error(err, "unable to set up auditor", syntheticsv1alpha1.Canary{}.APIVersion, syntheticsv1alpha1.Canary{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&syntheticsv1alpha1.Canary{}).
