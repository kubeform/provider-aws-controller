...
// +kubebuilder:rbac:groups=secretsmanager.aws.kubeform.com,resources=secrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secretsmanager.aws.kubeform.com,resources=secrets/status,verbs=get;update;patch
...
func (r *SecretReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &secretsmanagerv1alpha1.Secret{}); err != nil {
			klog.Error(err, "unable to set up auditor", secretsmanagerv1alpha1.Secret{}.APIVersion, secretsmanagerv1alpha1.Secret{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&secretsmanagerv1alpha1.Secret{}).
