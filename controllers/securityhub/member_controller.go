...
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=members,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=members/status,verbs=get;update;patch
...
func (r *MemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &securityhubv1alpha1.Member{}); err != nil {
			klog.Error(err, "unable to set up auditor", securityhubv1alpha1.Member{}.APIVersion, securityhubv1alpha1.Member{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&securityhubv1alpha1.Member{}).
