...
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=accounts/status,verbs=get;update;patch
...
func (r *AccountReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &securityhubv1alpha1.Account{}); err != nil {
			klog.Error(err, "unable to set up auditor", securityhubv1alpha1.Account{}.APIVersion, securityhubv1alpha1.Account{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&securityhubv1alpha1.Account{}).
