...
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=organizationconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=securityhub.aws.kubeform.com,resources=organizationconfigurations/status,verbs=get;update;patch
...
func (r *OrganizationConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &securityhubv1alpha1.OrganizationConfiguration{}); err != nil {
			klog.Error(err, "unable to set up auditor", securityhubv1alpha1.OrganizationConfiguration{}.APIVersion, securityhubv1alpha1.OrganizationConfiguration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&securityhubv1alpha1.OrganizationConfiguration{}).
