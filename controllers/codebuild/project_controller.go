...
// +kubebuilder:rbac:groups=codebuild.aws.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codebuild.aws.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codebuildv1alpha1.Project{}); err != nil {
			klog.Error(err, "unable to set up auditor", codebuildv1alpha1.Project{}.APIVersion, codebuildv1alpha1.Project{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codebuildv1alpha1.Project{}).
...
func (r *ProjectReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Project")
			return nil
		}
		...
		resourceList := &codebuildv1alpha1.ProjectList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Project")
			return nil
		}
