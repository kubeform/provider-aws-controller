...
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=repositorypolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=repositorypolicies/status,verbs=get;update;patch
...
func (r *RepositoryPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecrv1alpha1.RepositoryPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecrv1alpha1.RepositoryPolicy{}.APIVersion, ecrv1alpha1.RepositoryPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecrv1alpha1.RepositoryPolicy{}).
