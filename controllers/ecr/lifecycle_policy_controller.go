...
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=lifecyclepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=lifecyclepolicies/status,verbs=get;update;patch
...
func (r *LifecyclePolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecrv1alpha1.LifecyclePolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecrv1alpha1.LifecyclePolicy{}.APIVersion, ecrv1alpha1.LifecyclePolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecrv1alpha1.LifecyclePolicy{}).
