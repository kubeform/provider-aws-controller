...
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=repositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecr.aws.kubeform.com,resources=repositories/status,verbs=get;update;patch
...
func (r *RepositoryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecrv1alpha1.Repository{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecrv1alpha1.Repository{}.APIVersion, ecrv1alpha1.Repository{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecrv1alpha1.Repository{}).
