...
// +kubebuilder:rbac:groups=redshift.aws.kubeform.com,resources=subnetgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=redshift.aws.kubeform.com,resources=subnetgroups/status,verbs=get;update;patch
...
func (r *SubnetGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &redshiftv1alpha1.SubnetGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", redshiftv1alpha1.SubnetGroup{}.APIVersion, redshiftv1alpha1.SubnetGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&redshiftv1alpha1.SubnetGroup{}).
