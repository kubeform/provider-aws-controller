...
// +kubebuilder:rbac:groups=key.aws.kubeform.com,resources=pairs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=key.aws.kubeform.com,resources=pairs/status,verbs=get;update;patch
...
func (r *PairReconciler) SetupWithManager(mgr ctrl.Manager) error {
