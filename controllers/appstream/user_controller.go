...
// +kubebuilder:rbac:groups=appstream.aws.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appstream.aws.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appstreamv1alpha1.User{}); err != nil {
			klog.Error(err, "unable to set up auditor", appstreamv1alpha1.User{}.APIVersion, appstreamv1alpha1.User{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appstreamv1alpha1.User{}).
