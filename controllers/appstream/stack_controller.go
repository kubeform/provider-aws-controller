...
// +kubebuilder:rbac:groups=appstream.aws.kubeform.com,resources=stacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appstream.aws.kubeform.com,resources=stacks/status,verbs=get;update;patch
...
func (r *StackReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appstreamv1alpha1.Stack{}); err != nil {
			klog.Error(err, "unable to set up auditor", appstreamv1alpha1.Stack{}.APIVersion, appstreamv1alpha1.Stack{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appstreamv1alpha1.Stack{}).
