...
// +kubebuilder:rbac:groups=licensemanager.aws.kubeform.com,resources=associations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=licensemanager.aws.kubeform.com,resources=associations/status,verbs=get;update;patch
...
func (r *AssociationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &licensemanagerv1alpha1.Association{}); err != nil {
			klog.Error(err, "unable to set up auditor", licensemanagerv1alpha1.Association{}.APIVersion, licensemanagerv1alpha1.Association{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&licensemanagerv1alpha1.Association{}).
