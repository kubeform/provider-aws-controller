...
// +kubebuilder:rbac:groups=codeartifact.aws.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codeartifact.aws.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codeartifactv1alpha1.Domain{}); err != nil {
			klog.Error(err, "unable to set up auditor", codeartifactv1alpha1.Domain{}.APIVersion, codeartifactv1alpha1.Domain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codeartifactv1alpha1.Domain{}).
