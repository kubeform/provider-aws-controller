...
// +kubebuilder:rbac:groups=security.aws.kubeform.com,resources=grouprules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=security.aws.kubeform.com,resources=grouprules/status,verbs=get;update;patch
...
func (r *GroupRuleReconciler) SetupWithManager(mgr ctrl.Manager) error {
