...
// +kubebuilder:rbac:groups=vpn.aws.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpn.aws.kubeform.com,resources=gateways/status,verbs=get;update;patch
