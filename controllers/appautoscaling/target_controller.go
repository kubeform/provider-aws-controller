...
// +kubebuilder:rbac:groups=appautoscaling.aws.kubeform.com,resources=targets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appautoscaling.aws.kubeform.com,resources=targets/status,verbs=get;update;patch
...
func (r *TargetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appautoscalingv1alpha1.Target{}); err != nil {
			klog.Error(err, "unable to set up auditor", appautoscalingv1alpha1.Target{}.APIVersion, appautoscalingv1alpha1.Target{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appautoscalingv1alpha1.Target{}).
