...
// +kubebuilder:rbac:groups=codestarnotifications.aws.kubeform.com,resources=notificationrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codestarnotifications.aws.kubeform.com,resources=notificationrules/status,verbs=get;update;patch
...
func (r *NotificationRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codestarnotificationsv1alpha1.NotificationRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", codestarnotificationsv1alpha1.NotificationRule{}.APIVersion, codestarnotificationsv1alpha1.NotificationRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codestarnotificationsv1alpha1.NotificationRule{}).
