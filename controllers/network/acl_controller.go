...
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=acls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=acls/status,verbs=get;update;patch
