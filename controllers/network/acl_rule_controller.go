...
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=aclrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=aclrules/status,verbs=get;update;patch
...
func (r *AclRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.AclRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.AclRule{}.APIVersion, networkv1alpha1.AclRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.AclRule{}).
