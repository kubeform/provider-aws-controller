...
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfaceattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfaceattachments/status,verbs=get;update;patch
...
func (r *InterfaceAttachmentReconciler) SetupWithManager(mgr ctrl.Manager) error {
