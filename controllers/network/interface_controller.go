...
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfaces/status,verbs=get;update;patch
