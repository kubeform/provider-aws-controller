...
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfacesgattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.aws.kubeform.com,resources=interfacesgattachments/status,verbs=get;update;patch
...
func (r *InterfaceSgAttachmentReconciler) SetupWithManager(mgr ctrl.Manager) error {
