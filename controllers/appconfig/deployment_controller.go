...
// +kubebuilder:rbac:groups=appconfig.aws.kubeform.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appconfig.aws.kubeform.com,resources=deployments/status,verbs=get;update;patch
...
func (r *DeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appconfigv1alpha1.Deployment{}); err != nil {
			klog.Error(err, "unable to set up auditor", appconfigv1alpha1.Deployment{}.APIVersion, appconfigv1alpha1.Deployment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appconfigv1alpha1.Deployment{}).
