...
// +kubebuilder:rbac:groups=appconfig.aws.kubeform.com,resources=environments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appconfig.aws.kubeform.com,resources=environments/status,verbs=get;update;patch
...
func (r *EnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appconfigv1alpha1.Environment{}); err != nil {
			klog.Error(err, "unable to set up auditor", appconfigv1alpha1.Environment{}.APIVersion, appconfigv1alpha1.Environment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appconfigv1alpha1.Environment{}).
