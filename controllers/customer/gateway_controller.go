...
// +kubebuilder:rbac:groups=customer.aws.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=customer.aws.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &customerv1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", customerv1alpha1.Gateway{}.APIVersion, customerv1alpha1.Gateway{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&customerv1alpha1.Gateway{}).
