...
// +kubebuilder:rbac:groups=cognito.aws.kubeform.com,resources=usergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cognito.aws.kubeform.com,resources=usergroups/status,verbs=get;update;patch
...
func (r *UserGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cognitov1alpha1.UserGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", cognitov1alpha1.UserGroup{}.APIVersion, cognitov1alpha1.UserGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cognitov1alpha1.UserGroup{}).
