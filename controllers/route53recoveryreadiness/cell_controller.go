...
// +kubebuilder:rbac:groups=route53recoveryreadiness.aws.kubeform.com,resources=cells,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53recoveryreadiness.aws.kubeform.com,resources=cells/status,verbs=get;update;patch
...
func (r *CellReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Cell")
...
func (r *CellReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &route53recoveryreadinessv1alpha1.Cell{}); err != nil {
			klog.Error(err, "unable to set up auditor", route53recoveryreadinessv1alpha1.Cell{}.APIVersion, route53recoveryreadinessv1alpha1.Cell{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&route53recoveryreadinessv1alpha1.Cell{}).
