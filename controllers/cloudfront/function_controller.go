...
// +kubebuilder:rbac:groups=cloudfront.aws.kubeform.com,resources=functions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudfront.aws.kubeform.com,resources=functions/status,verbs=get;update;patch
...
func (r *FunctionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudfrontv1alpha1.Function{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudfrontv1alpha1.Function{}.APIVersion, cloudfrontv1alpha1.Function{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudfrontv1alpha1.Function{}).
