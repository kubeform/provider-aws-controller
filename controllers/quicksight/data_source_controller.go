...
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=datasources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=datasources/status,verbs=get;update;patch
...
func (r *DataSourceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &quicksightv1alpha1.DataSource{}); err != nil {
			klog.Error(err, "unable to set up auditor", quicksightv1alpha1.DataSource{}.APIVersion, quicksightv1alpha1.DataSource{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&quicksightv1alpha1.DataSource{}).
...
func (r *DataSourceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for DataSource")
			return nil
		}
		...
		resourceList := &quicksightv1alpha1.DataSourceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list DataSource")
			return nil
		}
