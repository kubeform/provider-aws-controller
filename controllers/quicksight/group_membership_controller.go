...
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=groupmemberships,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=groupmemberships/status,verbs=get;update;patch
...
func (r *GroupMembershipReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &quicksightv1alpha1.GroupMembership{}); err != nil {
			klog.Error(err, "unable to set up auditor", quicksightv1alpha1.GroupMembership{}.APIVersion, quicksightv1alpha1.GroupMembership{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&quicksightv1alpha1.GroupMembership{}).
