...
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.aws.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &quicksightv1alpha1.User{}); err != nil {
			klog.Error(err, "unable to set up auditor", quicksightv1alpha1.User{}.APIVersion, quicksightv1alpha1.User{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&quicksightv1alpha1.User{}).
