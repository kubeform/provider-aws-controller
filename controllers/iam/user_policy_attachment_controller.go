...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=userpolicyattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=userpolicyattachments/status,verbs=get;update;patch
...
func (r *UserPolicyAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.UserPolicyAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.UserPolicyAttachment{}.APIVersion, iamv1alpha1.UserPolicyAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.UserPolicyAttachment{}).
