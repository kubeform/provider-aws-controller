...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=accountalias,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=accountalias/status,verbs=get;update;patch
...
func (r *AccountAliasReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.AccountAlias{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.AccountAlias{}.APIVersion, iamv1alpha1.AccountAlias{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.AccountAlias{}).
