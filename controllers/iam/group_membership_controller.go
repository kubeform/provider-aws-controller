...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=groupmemberships,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=groupmemberships/status,verbs=get;update;patch
...
func (r *GroupMembershipReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.GroupMembership{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.GroupMembership{}.APIVersion, iamv1alpha1.GroupMembership{}.Kind)
			return err
		}
	}
