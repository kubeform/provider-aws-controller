...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=instanceprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=instanceprofiles/status,verbs=get;update;patch
...
func (r *InstanceProfileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.InstanceProfile{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.InstanceProfile{}.APIVersion, iamv1alpha1.InstanceProfile{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.InstanceProfile{}).
