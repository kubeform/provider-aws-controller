...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=servercertificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=servercertificates/status,verbs=get;update;patch
...
func (r *ServerCertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.ServerCertificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.ServerCertificate{}.APIVersion, iamv1alpha1.ServerCertificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.ServerCertificate{}).
...
func (r *ServerCertificateReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for ServerCertificate")
			return nil
		}
		...
		resourceList := &iamv1alpha1.ServerCertificateList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list ServerCertificate")
			return nil
		}
