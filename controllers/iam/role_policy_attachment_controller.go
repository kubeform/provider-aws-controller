...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=rolepolicyattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=rolepolicyattachments/status,verbs=get;update;patch
...
func (r *RolePolicyAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.RolePolicyAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.RolePolicyAttachment{}.APIVersion, iamv1alpha1.RolePolicyAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.RolePolicyAttachment{}).
