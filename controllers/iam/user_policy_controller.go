...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=userpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=userpolicies/status,verbs=get;update;patch
