...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=policies/status,verbs=get;update;patch
...
func (r *PolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.Policy{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.Policy{}.APIVersion, iamv1alpha1.Policy{}.Kind)
			return err
		}
	}
