...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=policyattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=policyattachments/status,verbs=get;update;patch
...
func (r *PolicyAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.PolicyAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.PolicyAttachment{}.APIVersion, iamv1alpha1.PolicyAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.PolicyAttachment{}).
