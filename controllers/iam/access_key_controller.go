...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=accesskeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=accesskeys/status,verbs=get;update;patch
...
func (r *AccessKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.AccessKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.AccessKey{}.APIVersion, iamv1alpha1.AccessKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.AccessKey{}).
...
func (r *AccessKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &iamv1alpha1.AccessKeyList{}
