...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.User{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.User{}.APIVersion, iamv1alpha1.User{}.Kind)
			return err
		}
	}
