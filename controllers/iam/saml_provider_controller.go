...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=samlproviders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=samlproviders/status,verbs=get;update;patch
...
func (r *SamlProviderReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.SamlProvider{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.SamlProvider{}.APIVersion, iamv1alpha1.SamlProvider{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.SamlProvider{}).
