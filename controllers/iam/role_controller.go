...
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=roles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.aws.kubeform.com,resources=roles/status,verbs=get;update;patch
...
func (r *RoleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.Role{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.Role{}.APIVersion, iamv1alpha1.Role{}.Kind)
			return err
		}
	}
