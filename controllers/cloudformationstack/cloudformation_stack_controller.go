...
// +kubebuilder:rbac:groups=cloudformationstack.aws.kubeform.com,resources=cloudformationstacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudformationstack.aws.kubeform.com,resources=cloudformationstacks/status,verbs=get;update;patch
...
func (r *CloudformationStackReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudformationstackv1alpha1.CloudformationStack{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudformationstackv1alpha1.CloudformationStack{}.APIVersion, cloudformationstackv1alpha1.CloudformationStack{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudformationstackv1alpha1.CloudformationStack{}).
