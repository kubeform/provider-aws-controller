...
// +kubebuilder:rbac:groups=inspector.aws.kubeform.com,resources=resourcegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=inspector.aws.kubeform.com,resources=resourcegroups/status,verbs=get;update;patch
...
func (r *ResourceGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &inspectorv1alpha1.ResourceGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", inspectorv1alpha1.ResourceGroup{}.APIVersion, inspectorv1alpha1.ResourceGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&inspectorv1alpha1.ResourceGroup{}).
