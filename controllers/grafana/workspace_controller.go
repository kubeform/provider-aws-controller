...
// +kubebuilder:rbac:groups=grafana.aws.kubeform.com,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=grafana.aws.kubeform.com,resources=workspaces/status,verbs=get;update;patch
...
func (r *WorkspaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &grafanav1alpha1.Workspace{}); err != nil {
			klog.Error(err, "unable to set up auditor", grafanav1alpha1.Workspace{}.APIVersion, grafanav1alpha1.Workspace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&grafanav1alpha1.Workspace{}).
