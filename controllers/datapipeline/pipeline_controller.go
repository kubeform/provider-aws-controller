...
// +kubebuilder:rbac:groups=datapipeline.aws.kubeform.com,resources=pipelines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datapipeline.aws.kubeform.com,resources=pipelines/status,verbs=get;update;patch
...
func (r *PipelineReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datapipelinev1alpha1.Pipeline{}); err != nil {
			klog.Error(err, "unable to set up auditor", datapipelinev1alpha1.Pipeline{}.APIVersion, datapipelinev1alpha1.Pipeline{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datapipelinev1alpha1.Pipeline{}).
