...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=accounts/status,verbs=get;update;patch
...
func (r *AccountReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.Account{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.Account{}.APIVersion, apigatewayv1alpha1.Account{}.Kind)
			return err
		}
	}
