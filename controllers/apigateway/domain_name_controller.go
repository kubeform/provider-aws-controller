...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=domainnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=domainnames/status,verbs=get;update;patch
...
func (r *DomainNameReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.DomainName{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.DomainName{}.APIVersion, apigatewayv1alpha1.DomainName{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.DomainName{}).
...
func (r *DomainNameReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for DomainName")
			return nil
		}
		...
		resourceList := &apigatewayv1alpha1.DomainNameList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list DomainName")
			return nil
		}
