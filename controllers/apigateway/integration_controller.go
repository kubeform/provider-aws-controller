...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=integrations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=integrations/status,verbs=get;update;patch
...
func (r *IntegrationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.Integration{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.Integration{}.APIVersion, apigatewayv1alpha1.Integration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.Integration{}).
