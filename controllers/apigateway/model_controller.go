...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=models,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=models/status,verbs=get;update;patch
...
func (r *ModelReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.Model{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.Model{}.APIVersion, apigatewayv1alpha1.Model{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.Model{}).
