...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=stages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=stages/status,verbs=get;update;patch
...
func (r *StageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.Stage{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.Stage{}.APIVersion, apigatewayv1alpha1.Stage{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.Stage{}).
