...
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=documentationversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigateway.aws.kubeform.com,resources=documentationversions/status,verbs=get;update;patch

func (r *DocumentationVersionReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch DocumentationVersion")
...
func (r *DocumentationVersionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigatewayv1alpha1.DocumentationVersion{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigatewayv1alpha1.DocumentationVersion{}.APIVersion, apigatewayv1alpha1.DocumentationVersion{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigatewayv1alpha1.DocumentationVersion{}).
