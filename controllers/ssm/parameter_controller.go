...
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=parameters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=parameters/status,verbs=get;update;patch
...
func (r *ParameterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ssmv1alpha1.Parameter{}); err != nil {
			klog.Error(err, "unable to set up auditor", ssmv1alpha1.Parameter{}.APIVersion, ssmv1alpha1.Parameter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ssmv1alpha1.Parameter{}).
...
func (r *ParameterReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Parameter")
			return nil
		}
		...
		resourceList := &ssmv1alpha1.ParameterList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Parameter")
			return nil
		}
