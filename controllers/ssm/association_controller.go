...
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=associations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=associations/status,verbs=get;update;patch
...
func (r *AssociationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ssmv1alpha1.Association{}); err != nil {
			klog.Error(err, "unable to set up auditor", ssmv1alpha1.Association{}.APIVersion, ssmv1alpha1.Association{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ssmv1alpha1.Association{}).
