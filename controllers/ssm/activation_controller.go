...
// ActivationReconciler reconciles a Activation object
...
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=activations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.aws.kubeform.com,resources=activations/status,verbs=get;update;patch

func (r *ActivationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("activation", req.NamespacedName)
...
func (r *ActivationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ssmv1alpha1.Activation{}); err != nil {
			klog.Error(err, "unable to set up auditor", ssmv1alpha1.Activation{}.APIVersion, ssmv1alpha1.Activation{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ssmv1alpha1.Activation{}).
