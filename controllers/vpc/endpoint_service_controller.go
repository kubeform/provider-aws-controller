...
// +kubebuilder:rbac:groups=vpc.aws.kubeform.com,resources=endpointservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpc.aws.kubeform.com,resources=endpointservices/status,verbs=get;update;patch
...
func (r *EndpointServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vpcv1alpha1.EndpointService{}); err != nil {
			klog.Error(err, "unable to set up auditor", vpcv1alpha1.EndpointService{}.APIVersion, vpcv1alpha1.EndpointService{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vpcv1alpha1.EndpointService{}).
