...
// +kubebuilder:rbac:groups=vpc.aws.kubeform.com,resources=vpcs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vpc.aws.kubeform.com,resources=vpcs/status,verbs=get;update;patch
