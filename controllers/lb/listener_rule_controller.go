...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listenerrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listenerrules/status,verbs=get;update;patch
...
func (r *ListenerRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.ListenerRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.ListenerRule{}.APIVersion, lbv1alpha1.ListenerRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lbv1alpha1.ListenerRule{}).
...
func (r *ListenerRuleReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &lbv1alpha1.ListenerRuleList{}
