...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=cookiestickinesspolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=cookiestickinesspolicies/status,verbs=get;update;patch
...
func (r *CookieStickinessPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.CookieStickinessPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.CookieStickinessPolicy{}.APIVersion, lbv1alpha1.CookieStickinessPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lbv1alpha1.CookieStickinessPolicy{}).
