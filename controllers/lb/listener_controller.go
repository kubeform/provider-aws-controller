...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listeners/status,verbs=get;update;patch
...
func (r *ListenerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.Listener{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.Listener{}.APIVersion, lbv1alpha1.Listener{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lbv1alpha1.Listener{}).
...
func (r *ListenerReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Listener")
			return nil
		}
		...
		resourceList := &lbv1alpha1.ListenerList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Listener")
			return nil
		}
