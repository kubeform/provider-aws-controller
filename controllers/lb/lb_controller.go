...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=lbs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=lbs/status,verbs=get;update;patch
