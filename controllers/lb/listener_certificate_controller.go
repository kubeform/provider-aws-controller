...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listenercertificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=listenercertificates/status,verbs=get;update;patch
...
func (r *ListenerCertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.ListenerCertificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.ListenerCertificate{}.APIVersion, lbv1alpha1.ListenerCertificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lbv1alpha1.ListenerCertificate{}).
