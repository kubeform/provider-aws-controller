...
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=targetgroupattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.aws.kubeform.com,resources=targetgroupattachments/status,verbs=get;update;patch
...
func (r *TargetGroupAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.TargetGroupAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.TargetGroupAttachment{}.APIVersion, lbv1alpha1.TargetGroupAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lbv1alpha1.TargetGroupAttachment{}).
