...
// +kubebuilder:rbac:groups=acm.aws.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acm.aws.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &acmv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", acmv1alpha1.Certificate{}.APIVersion, acmv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&acmv1alpha1.Certificate{}).
...
func (r *CertificateReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &acmv1alpha1.CertificateList{}
