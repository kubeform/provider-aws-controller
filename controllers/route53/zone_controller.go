...
// +kubebuilder:rbac:groups=route53.aws.kubeform.com,resources=zones,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.aws.kubeform.com,resources=zones/status,verbs=get;update;patch
...
func (r *ZoneReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &route53v1alpha1.Zone{}); err != nil {
			klog.Error(err, "unable to set up auditor", route53v1alpha1.Zone{}.APIVersion, route53v1alpha1.Zone{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&route53v1alpha1.Zone{}).
