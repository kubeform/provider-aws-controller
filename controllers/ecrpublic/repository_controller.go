...
// +kubebuilder:rbac:groups=ecrpublic.aws.kubeform.com,resources=repositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecrpublic.aws.kubeform.com,resources=repositories/status,verbs=get;update;patch
...
func (r *RepositoryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecrpublicv1alpha1.Repository{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecrpublicv1alpha1.Repository{}.APIVersion, ecrpublicv1alpha1.Repository{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecrpublicv1alpha1.Repository{}).
