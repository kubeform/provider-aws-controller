...
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=connections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=connections/status,verbs=get;update;patch
...
func (r *ConnectionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gluev1alpha1.Connection{}); err != nil {
			klog.Error(err, "unable to set up auditor", gluev1alpha1.Connection{}.APIVersion, gluev1alpha1.Connection{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gluev1alpha1.Connection{}).
...
func (r *ConnectionReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Connection")
			return nil
		}
		...
		resourceList := &gluev1alpha1.ConnectionList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Connection")
			return nil
		}
