...
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=resourcepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=resourcepolicies/status,verbs=get;update;patch
...
func (r *ResourcePolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gluev1alpha1.ResourcePolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", gluev1alpha1.ResourcePolicy{}.APIVersion, gluev1alpha1.ResourcePolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gluev1alpha1.ResourcePolicy{}).
