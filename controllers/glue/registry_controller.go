...
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=registries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.aws.kubeform.com,resources=registries/status,verbs=get;update;patch
...
func (r *RegistryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &gluev1alpha1.Registry{}); err != nil {
			klog.Error(err, "unable to set up auditor", gluev1alpha1.Registry{}.APIVersion, gluev1alpha1.Registry{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&gluev1alpha1.Registry{}).
