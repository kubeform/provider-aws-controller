...
// +kubebuilder:rbac:groups=wafregional.aws.kubeform.com,resources=ipsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wafregional.aws.kubeform.com,resources=ipsets/status,verbs=get;update;patch
...
func (r *IpsetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafregionalv1alpha1.Ipset{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafregionalv1alpha1.Ipset{}.APIVersion, wafregionalv1alpha1.Ipset{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafregionalv1alpha1.Ipset{}).
