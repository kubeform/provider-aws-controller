...
// +kubebuilder:rbac:groups=config.aws.kubeform.com,resources=configurationrecorders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=config.aws.kubeform.com,resources=configurationrecorders/status,verbs=get;update;patch
...
func (r *ConfigurationRecorderReconciler) SetupWithManager(mgr ctrl.Manager) error {
