...
// +kubebuilder:rbac:groups=config.aws.kubeform.com,resources=deliverychannels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=config.aws.kubeform.com,resources=deliverychannels/status,verbs=get;update;patch
...
func (r *DeliveryChannelReconciler) SetupWithManager(mgr ctrl.Manager) error {
