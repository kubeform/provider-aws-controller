...
// +kubebuilder:rbac:groups=amplify.aws.kubeform.com,resources=webhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=amplify.aws.kubeform.com,resources=webhooks/status,verbs=get;update;patch
...
func (r *WebhookReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &amplifyv1alpha1.Webhook{}); err != nil {
			klog.Error(err, "unable to set up auditor", amplifyv1alpha1.Webhook{}.APIVersion, amplifyv1alpha1.Webhook{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&amplifyv1alpha1.Webhook{}).
