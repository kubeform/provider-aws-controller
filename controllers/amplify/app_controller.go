...
// +kubebuilder:rbac:groups=amplify.aws.kubeform.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=amplify.aws.kubeform.com,resources=apps/status,verbs=get;update;patch
...
func (r *AppReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &amplifyv1alpha1.App{}); err != nil {
			klog.Error(err, "unable to set up auditor", amplifyv1alpha1.App{}.APIVersion, amplifyv1alpha1.App{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&amplifyv1alpha1.App{}).
...
func (r *AppReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for App")
			return nil
		}
