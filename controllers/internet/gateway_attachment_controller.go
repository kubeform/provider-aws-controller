...
// +kubebuilder:rbac:groups=internet.aws.kubeform.com,resources=gatewayattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=internet.aws.kubeform.com,resources=gatewayattachments/status,verbs=get;update;patch
...
func (r *GatewayAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &internetv1alpha1.GatewayAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", internetv1alpha1.GatewayAttachment{}.APIVersion, internetv1alpha1.GatewayAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&internetv1alpha1.GatewayAttachment{}).
