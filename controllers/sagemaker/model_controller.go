...
// +kubebuilder:rbac:groups=sagemaker.aws.kubeform.com,resources=models,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.aws.kubeform.com,resources=models/status,verbs=get;update;patch
...
func (r *ModelReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sagemakerv1alpha1.Model{}); err != nil {
			klog.Error(err, "unable to set up auditor", sagemakerv1alpha1.Model{}.APIVersion, sagemakerv1alpha1.Model{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sagemakerv1alpha1.Model{}).
