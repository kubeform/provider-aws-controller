...
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketpolicies/status,verbs=get;update;patch
...
func (r *BucketPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3v1alpha1.BucketPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3v1alpha1.BucketPolicy{}.APIVersion, s3v1alpha1.BucketPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3v1alpha1.BucketPolicy{}).
