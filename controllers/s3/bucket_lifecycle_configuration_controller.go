...
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketlifecycleconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketlifecycleconfigurations/status,verbs=get;update;patch
...
func (r *BucketLifecycleConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3v1alpha1.BucketLifecycleConfiguration{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3v1alpha1.BucketLifecycleConfiguration{}.APIVersion, s3v1alpha1.BucketLifecycleConfiguration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3v1alpha1.BucketLifecycleConfiguration{}).
