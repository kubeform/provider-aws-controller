...
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=accesspoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=accesspoints/status,verbs=get;update;patch
...
func (r *AccessPointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3v1alpha1.AccessPoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3v1alpha1.AccessPoint{}.APIVersion, s3v1alpha1.AccessPoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3v1alpha1.AccessPoint{}).
