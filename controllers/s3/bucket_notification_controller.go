...
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketnotifications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketnotifications/status,verbs=get;update;patch

func (r *BucketNotificationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch BucketNotification")
...
func (r *BucketNotificationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3v1alpha1.BucketNotification{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3v1alpha1.BucketNotification{}.APIVersion, s3v1alpha1.BucketNotification{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3v1alpha1.BucketNotification{}).
