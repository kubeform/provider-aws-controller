...
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketobjects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3.aws.kubeform.com,resources=bucketobjects/status,verbs=get;update;patch
...
func (r *BucketObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3v1alpha1.BucketObject{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3v1alpha1.BucketObject{}.APIVersion, s3v1alpha1.BucketObject{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3v1alpha1.BucketObject{}).
