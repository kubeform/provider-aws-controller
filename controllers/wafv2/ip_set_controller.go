...
// +kubebuilder:rbac:groups=wafv2.aws.kubeform.com,resources=ipsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=wafv2.aws.kubeform.com,resources=ipsets/status,verbs=get;update;patch
...
func (r *IpSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv2v1alpha1.IpSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv2v1alpha1.IpSet{}.APIVersion, wafv2v1alpha1.IpSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv2v1alpha1.IpSet{}).
