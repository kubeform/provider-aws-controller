...
// +kubebuilder:rbac:groups=lex.aws.kubeform.com,resources=intents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lex.aws.kubeform.com,resources=intents/status,verbs=get;update;patch
...
func (r *IntentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Intent")
...
func (r *IntentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lexv1alpha1.Intent{}); err != nil {
			klog.Error(err, "unable to set up auditor", lexv1alpha1.Intent{}.APIVersion, lexv1alpha1.Intent{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lexv1alpha1.Intent{}).
