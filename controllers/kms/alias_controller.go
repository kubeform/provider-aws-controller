...
// +kubebuilder:rbac:groups=kms.aws.kubeform.com,resources=aliases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kms.aws.kubeform.com,resources=aliases/status,verbs=get;update;patch
