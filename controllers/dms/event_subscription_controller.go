...
// +kubebuilder:rbac:groups=dms.aws.kubeform.com,resources=eventsubscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dms.aws.kubeform.com,resources=eventsubscriptions/status,verbs=get;update;patch
...
func (r *EventSubscriptionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dmsv1alpha1.EventSubscription{}); err != nil {
			klog.Error(err, "unable to set up auditor", dmsv1alpha1.EventSubscription{}.APIVersion, dmsv1alpha1.EventSubscription{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dmsv1alpha1.EventSubscription{}).
