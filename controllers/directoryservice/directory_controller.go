...
// +kubebuilder:rbac:groups=directoryservice.aws.kubeform.com,resources=directories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=directoryservice.aws.kubeform.com,resources=directories/status,verbs=get;update;patch
...
func (r *DirectoryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &directoryservicev1alpha1.Directory{}); err != nil {
			klog.Error(err, "unable to set up auditor", directoryservicev1alpha1.Directory{}.APIVersion, directoryservicev1alpha1.Directory{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&directoryservicev1alpha1.Directory{}).
...
func (r *DirectoryReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Directory")
			return nil
		}
		...
		resourceList := &directoryservicev1alpha1.DirectoryList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Directory")
			return nil
		}
