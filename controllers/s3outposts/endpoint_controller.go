...
// +kubebuilder:rbac:groups=s3outposts.aws.kubeform.com,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=s3outposts.aws.kubeform.com,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &s3outpostsv1alpha1.Endpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", s3outpostsv1alpha1.Endpoint{}.APIVersion, s3outpostsv1alpha1.Endpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&s3outpostsv1alpha1.Endpoint{}).
