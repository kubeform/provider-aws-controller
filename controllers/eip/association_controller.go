...
// +kubebuilder:rbac:groups=eip.aws.kubeform.com,resources=associations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eip.aws.kubeform.com,resources=associations/status,verbs=get;update;patch
