...
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=instancegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=instancegroups/status,verbs=get;update;patch
...
func (r *InstanceGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &emrv1alpha1.InstanceGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", emrv1alpha1.InstanceGroup{}.APIVersion, emrv1alpha1.InstanceGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&emrv1alpha1.InstanceGroup{}).
