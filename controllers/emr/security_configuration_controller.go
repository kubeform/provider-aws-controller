...
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=securityconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=securityconfigurations/status,verbs=get;update;patch
...
func (r *SecurityConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &emrv1alpha1.SecurityConfiguration{}); err != nil {
			klog.Error(err, "unable to set up auditor", emrv1alpha1.SecurityConfiguration{}.APIVersion, emrv1alpha1.SecurityConfiguration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&emrv1alpha1.SecurityConfiguration{}).
