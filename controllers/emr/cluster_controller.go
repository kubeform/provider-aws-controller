...
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emr.aws.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &emrv1alpha1.ClusterList{}
