...
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=regexmatchsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=regexmatchsets/status,verbs=get;update;patch
...
func (r *RegexMatchSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv1alpha1.RegexMatchSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv1alpha1.RegexMatchSet{}.APIVersion, wafv1alpha1.RegexMatchSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv1alpha1.RegexMatchSet{}).
