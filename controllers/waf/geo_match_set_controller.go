...
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=geomatchsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=geomatchsets/status,verbs=get;update;patch
...
func (r *GeoMatchSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv1alpha1.GeoMatchSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv1alpha1.GeoMatchSet{}.APIVersion, wafv1alpha1.GeoMatchSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv1alpha1.GeoMatchSet{}).
