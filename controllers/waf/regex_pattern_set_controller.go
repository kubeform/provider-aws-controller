...
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=regexpatternsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=regexpatternsets/status,verbs=get;update;patch
...
func (r *RegexPatternSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv1alpha1.RegexPatternSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv1alpha1.RegexPatternSet{}.APIVersion, wafv1alpha1.RegexPatternSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv1alpha1.RegexPatternSet{}).
