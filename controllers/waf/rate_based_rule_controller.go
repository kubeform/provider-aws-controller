...
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=ratebasedrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=ratebasedrules/status,verbs=get;update;patch
...
func (r *RateBasedRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv1alpha1.RateBasedRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv1alpha1.RateBasedRule{}.APIVersion, wafv1alpha1.RateBasedRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv1alpha1.RateBasedRule{}).
