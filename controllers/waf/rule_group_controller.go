...
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=rulegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=waf.aws.kubeform.com,resources=rulegroups/status,verbs=get;update;patch
...
func (r *RuleGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &wafv1alpha1.RuleGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", wafv1alpha1.RuleGroup{}.APIVersion, wafv1alpha1.RuleGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&wafv1alpha1.RuleGroup{}).
