...
// +kubebuilder:rbac:groups=lightsail.aws.kubeform.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lightsail.aws.kubeform.com,resources=domains/status,verbs=get;update;patch
...
func (r *DomainReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lightsailv1alpha1.Domain{}); err != nil {
			klog.Error(err, "unable to set up auditor", lightsailv1alpha1.Domain{}.APIVersion, lightsailv1alpha1.Domain{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lightsailv1alpha1.Domain{}).
