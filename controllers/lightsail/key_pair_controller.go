...
// +kubebuilder:rbac:groups=lightsail.aws.kubeform.com,resources=keypairs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lightsail.aws.kubeform.com,resources=keypairs/status,verbs=get;update;patch
...
func (r *KeyPairReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lightsailv1alpha1.KeyPair{}); err != nil {
			klog.Error(err, "unable to set up auditor", lightsailv1alpha1.KeyPair{}.APIVersion, lightsailv1alpha1.KeyPair{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lightsailv1alpha1.KeyPair{}).
