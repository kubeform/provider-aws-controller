...
// +kubebuilder:rbac:groups=detective.aws.kubeform.com,resources=invitationaccepters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=detective.aws.kubeform.com,resources=invitationaccepters/status,verbs=get;update;patch
...
func (r *InvitationAccepterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &detectivev1alpha1.InvitationAccepter{}); err != nil {
			klog.Error(err, "unable to set up auditor", detectivev1alpha1.InvitationAccepter{}.APIVersion, detectivev1alpha1.InvitationAccepter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&detectivev1alpha1.InvitationAccepter{}).
