...
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=accesspoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=accesspoints/status,verbs=get;update;patch
...
func (r *AccessPointReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch AccessPoint")
...
func (r *AccessPointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &efsv1alpha1.AccessPoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", efsv1alpha1.AccessPoint{}.APIVersion, efsv1alpha1.AccessPoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&efsv1alpha1.AccessPoint{}).
