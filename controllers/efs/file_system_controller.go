...
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=filesystems,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=filesystems/status,verbs=get;update;patch
...
func (r *FileSystemReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &efsv1alpha1.FileSystem{}); err != nil {
			klog.Error(err, "unable to set up auditor", efsv1alpha1.FileSystem{}.APIVersion, efsv1alpha1.FileSystem{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&efsv1alpha1.FileSystem{}).
