...
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=mounttargets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=efs.aws.kubeform.com,resources=mounttargets/status,verbs=get;update;patch
...
func (r *MountTargetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &efsv1alpha1.MountTarget{}); err != nil {
			klog.Error(err, "unable to set up auditor", efsv1alpha1.MountTarget{}.APIVersion, efsv1alpha1.MountTarget{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&efsv1alpha1.MountTarget{}).
