...
// +kubebuilder:rbac:groups=cloudhsmv2.aws.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudhsmv2.aws.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudhsmv2v1alpha1.Cluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudhsmv2v1alpha1.Cluster{}.APIVersion, cloudhsmv2v1alpha1.Cluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudhsmv2v1alpha1.Cluster{}).
