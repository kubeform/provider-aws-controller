...
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=datasources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=datasources/status,verbs=get;update;patch
...
func (r *DatasourceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appsyncv1alpha1.Datasource{}); err != nil {
			klog.Error(err, "unable to set up auditor", appsyncv1alpha1.Datasource{}.APIVersion, appsyncv1alpha1.Datasource{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appsyncv1alpha1.Datasource{}).
