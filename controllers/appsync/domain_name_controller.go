...
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=domainnames,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=domainnames/status,verbs=get;update;patch
...
func (r *DomainNameReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appsyncv1alpha1.DomainName{}); err != nil {
			klog.Error(err, "unable to set up auditor", appsyncv1alpha1.DomainName{}.APIVersion, appsyncv1alpha1.DomainName{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appsyncv1alpha1.DomainName{}).
