...
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=apikeys/status,verbs=get;update;patch
...
func (r *ApiKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appsyncv1alpha1.ApiKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", appsyncv1alpha1.ApiKey{}.APIVersion, appsyncv1alpha1.ApiKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appsyncv1alpha1.ApiKey{}).
...
func (r *ApiKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &appsyncv1alpha1.ApiKeyList{}
