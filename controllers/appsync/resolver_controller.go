...
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=resolvers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appsync.aws.kubeform.com,resources=resolvers/status,verbs=get;update;patch

func (r *ResolverReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("resolver", req.NamespacedName)
...
func (r *ResolverReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appsyncv1alpha1.Resolver{}); err != nil {
			klog.Error(err, "unable to set up auditor", appsyncv1alpha1.Resolver{}.APIVersion, appsyncv1alpha1.Resolver{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appsyncv1alpha1.Resolver{}).
