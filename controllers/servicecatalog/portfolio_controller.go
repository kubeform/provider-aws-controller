...
// PortfolioReconciler reconciles a Portfolio object
...
// +kubebuilder:rbac:groups=servicecatalog.aws.kubeform.com,resources=portfolios,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=servicecatalog.aws.kubeform.com,resources=portfolios/status,verbs=get;update;patch
...
func (r *PortfolioReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Portfolio")
...
func (r *PortfolioReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicecatalogv1alpha1.Portfolio{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicecatalogv1alpha1.Portfolio{}.APIVersion, servicecatalogv1alpha1.Portfolio{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicecatalogv1alpha1.Portfolio{}).
