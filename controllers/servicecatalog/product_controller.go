...
// +kubebuilder:rbac:groups=servicecatalog.aws.kubeform.com,resources=products,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=servicecatalog.aws.kubeform.com,resources=products/status,verbs=get;update;patch
...
func (r *ProductReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &servicecatalogv1alpha1.Product{}); err != nil {
			klog.Error(err, "unable to set up auditor", servicecatalogv1alpha1.Product{}.APIVersion, servicecatalogv1alpha1.Product{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&servicecatalogv1alpha1.Product{}).
