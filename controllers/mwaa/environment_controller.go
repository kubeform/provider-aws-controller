...
// +kubebuilder:rbac:groups=mwaa.aws.kubeform.com,resources=environments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=mwaa.aws.kubeform.com,resources=environments/status,verbs=get;update;patch
...
func (r *EnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mwaav1alpha1.Environment{}); err != nil {
			klog.Error(err, "unable to set up auditor", mwaav1alpha1.Environment{}.APIVersion, mwaav1alpha1.Environment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mwaav1alpha1.Environment{}).
...
func (r *EnvironmentReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Environment")
			return nil
		}
		...
		resourceList := &mwaav1alpha1.EnvironmentList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Environment")
			return nil
		}
