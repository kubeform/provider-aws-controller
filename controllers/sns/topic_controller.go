...
// +kubebuilder:rbac:groups=sns.aws.kubeform.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sns.aws.kubeform.com,resources=topics/status,verbs=get;update;patch
...
func (r *TopicReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &snsv1alpha1.Topic{}); err != nil {
			klog.Error(err, "unable to set up auditor", snsv1alpha1.Topic{}.APIVersion, snsv1alpha1.Topic{}.Kind)
			return err
		}
	}
