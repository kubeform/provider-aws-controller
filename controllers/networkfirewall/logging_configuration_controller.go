...
// +kubebuilder:rbac:groups=networkfirewall.aws.kubeform.com,resources=loggingconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkfirewall.aws.kubeform.com,resources=loggingconfigurations/status,verbs=get;update;patch

func (r *LoggingConfigurationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("loggingconfiguration", req.NamespacedName)
...
func (r *LoggingConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkfirewallv1alpha1.LoggingConfiguration{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkfirewallv1alpha1.LoggingConfiguration{}.APIVersion, networkfirewallv1alpha1.LoggingConfiguration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkfirewallv1alpha1.LoggingConfiguration{}).
