...
// +kubebuilder:rbac:groups=networkfirewall.aws.kubeform.com,resources=firewalls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkfirewall.aws.kubeform.com,resources=firewalls/status,verbs=get;update;patch
...
func (r *FirewallReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkfirewallv1alpha1.Firewall{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkfirewallv1alpha1.Firewall{}.APIVersion, networkfirewallv1alpha1.Firewall{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkfirewallv1alpha1.Firewall{}).
