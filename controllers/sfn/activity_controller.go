...
// ActivityReconciler reconciles a Activity object
...
// +kubebuilder:rbac:groups=sfn.aws.kubeform.com,resources=activities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sfn.aws.kubeform.com,resources=activities/status,verbs=get;update;patch
...
func (r *ActivityReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sfnv1alpha1.Activity{}); err != nil {
			klog.Error(err, "unable to set up auditor", sfnv1alpha1.Activity{}.APIVersion, sfnv1alpha1.Activity{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sfnv1alpha1.Activity{}).
