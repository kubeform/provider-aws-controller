...
// +kubebuilder:rbac:groups=codedeploy.aws.kubeform.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=codedeploy.aws.kubeform.com,resources=apps/status,verbs=get;update;patch
...
func (r *AppReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &codedeployv1alpha1.App{}); err != nil {
			klog.Error(err, "unable to set up auditor", codedeployv1alpha1.App{}.APIVersion, codedeployv1alpha1.App{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&codedeployv1alpha1.App{}).
