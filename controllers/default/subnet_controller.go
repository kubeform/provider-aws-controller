...
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=subnets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=subnets/status,verbs=get;update;patch
...
func (r *SubnetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &defaultv1alpha1.Subnet{}); err != nil {
			klog.Error(err, "unable to set up auditor", defaultv1alpha1.Subnet{}.APIVersion, defaultv1alpha1.Subnet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&defaultv1alpha1.Subnet{}).
