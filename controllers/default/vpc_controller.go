...
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=vpcs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=vpcs/status,verbs=get;update;patch
...
func (r *VpcReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &defaultv1alpha1.Vpc{}); err != nil {
			klog.Error(err, "unable to set up auditor", defaultv1alpha1.Vpc{}.APIVersion, defaultv1alpha1.Vpc{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&defaultv1alpha1.Vpc{}).
