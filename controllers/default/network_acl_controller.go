...
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=networkacls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=default.aws.kubeform.com,resources=networkacls/status,verbs=get;update;patch
...
func (r *NetworkACLReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &defaultv1alpha1.NetworkACL{}); err != nil {
			klog.Error(err, "unable to set up auditor", defaultv1alpha1.NetworkACL{}.APIVersion, defaultv1alpha1.NetworkACL{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&defaultv1alpha1.NetworkACL{}).
