...
// +kubebuilder:rbac:groups=globalaccelerator.aws.kubeform.com,resources=accelerators,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=globalaccelerator.aws.kubeform.com,resources=accelerators/status,verbs=get;update;patch
...
func (r *AcceleratorReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &globalacceleratorv1alpha1.Accelerator{}); err != nil {
			klog.Error(err, "unable to set up auditor", globalacceleratorv1alpha1.Accelerator{}.APIVersion, globalacceleratorv1alpha1.Accelerator{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&globalacceleratorv1alpha1.Accelerator{}).
