...
// +kubebuilder:rbac:groups=globalaccelerator.aws.kubeform.com,resources=listeners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=globalaccelerator.aws.kubeform.com,resources=listeners/status,verbs=get;update;patch
...
func (r *ListenerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &globalacceleratorv1alpha1.Listener{}); err != nil {
			klog.Error(err, "unable to set up auditor", globalacceleratorv1alpha1.Listener{}.APIVersion, globalacceleratorv1alpha1.Listener{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&globalacceleratorv1alpha1.Listener{}).
