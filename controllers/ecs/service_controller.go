...
// +kubebuilder:rbac:groups=ecs.aws.kubeform.com,resources=services,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.aws.kubeform.com,resources=services/status,verbs=get;update;patch
...
func (r *ServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecsv1alpha1.Service{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecsv1alpha1.Service{}.APIVersion, ecsv1alpha1.Service{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ecsv1alpha1.Service{}).
