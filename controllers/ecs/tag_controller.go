...
// +kubebuilder:rbac:groups=ecs.aws.kubeform.com,resources=tags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.aws.kubeform.com,resources=tags/status,verbs=get;update;patch
...
func (r *TagReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ecsv1alpha1.Tag{}); err != nil {
			klog.Error(err, "unable to set up auditor", ecsv1alpha1.Tag{}.APIVersion, ecsv1alpha1.Tag{}.Kind)
			return err
		}
	}
