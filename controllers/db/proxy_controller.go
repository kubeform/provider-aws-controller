...
// +kubebuilder:rbac:groups=db.aws.kubeform.com,resources=proxies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=db.aws.kubeform.com,resources=proxies/status,verbs=get;update;patch

func (r *ProxyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("proxy", req.NamespacedName)
...
func (r *ProxyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dbv1alpha1.Proxy{}); err != nil {
			klog.Error(err, "unable to set up auditor", dbv1alpha1.Proxy{}.APIVersion, dbv1alpha1.Proxy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dbv1alpha1.Proxy{}).
