...
// +kubebuilder:rbac:groups=appmesh.aws.kubeform.com,resources=virtualnodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appmesh.aws.kubeform.com,resources=virtualnodes/status,verbs=get;update;patch
...
func (r *VirtualNodeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appmeshv1alpha1.VirtualNode{}); err != nil {
			klog.Error(err, "unable to set up auditor", appmeshv1alpha1.VirtualNode{}.APIVersion, appmeshv1alpha1.VirtualNode{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appmeshv1alpha1.VirtualNode{}).
