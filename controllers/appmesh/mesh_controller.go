...
// +kubebuilder:rbac:groups=appmesh.aws.kubeform.com,resources=meshes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appmesh.aws.kubeform.com,resources=meshes/status,verbs=get;update;patch
...
func (r *MeshReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appmeshv1alpha1.Mesh{}); err != nil {
			klog.Error(err, "unable to set up auditor", appmeshv1alpha1.Mesh{}.APIVersion, appmeshv1alpha1.Mesh{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appmeshv1alpha1.Mesh{}).
