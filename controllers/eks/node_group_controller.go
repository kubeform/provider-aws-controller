...
// +kubebuilder:rbac:groups=eks.aws.kubeform.com,resources=nodegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.aws.kubeform.com,resources=nodegroups/status,verbs=get;update;patch

func (r *NodeGroupReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("nodegroup", req.NamespacedName)
...
func (r *NodeGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eksv1alpha1.NodeGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", eksv1alpha1.NodeGroup{}.APIVersion, eksv1alpha1.NodeGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eksv1alpha1.NodeGroup{}).
