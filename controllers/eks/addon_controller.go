...
// +kubebuilder:rbac:groups=eks.aws.kubeform.com,resources=addons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eks.aws.kubeform.com,resources=addons/status,verbs=get;update;patch
...
func (r *AddonReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eksv1alpha1.Addon{}); err != nil {
			klog.Error(err, "unable to set up auditor", eksv1alpha1.Addon{}.APIVersion, eksv1alpha1.Addon{}.Kind)
			return err
		}
	}
