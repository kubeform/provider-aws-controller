...
// +kubebuilder:rbac:groups=datasync.aws.kubeform.com,resources=tasks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datasync.aws.kubeform.com,resources=tasks/status,verbs=get;update;patch
...
func (r *TaskReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datasyncv1alpha1.Task{}); err != nil {
			klog.Error(err, "unable to set up auditor", datasyncv1alpha1.Task{}.APIVersion, datasyncv1alpha1.Task{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datasyncv1alpha1.Task{}).
