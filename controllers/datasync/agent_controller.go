...
// +kubebuilder:rbac:groups=datasync.aws.kubeform.com,resources=agents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=datasync.aws.kubeform.com,resources=agents/status,verbs=get;update;patch
...
func (r *AgentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datasyncv1alpha1.Agent{}); err != nil {
			klog.Error(err, "unable to set up auditor", datasyncv1alpha1.Agent{}.APIVersion, datasyncv1alpha1.Agent{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datasyncv1alpha1.Agent{}).
