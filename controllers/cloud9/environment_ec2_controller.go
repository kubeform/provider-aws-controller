...
// +kubebuilder:rbac:groups=cloud9.aws.kubeform.com,resources=environmentec2s,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloud9.aws.kubeform.com,resources=environmentec2s/status,verbs=get;update;patch

func (r *EnvironmentEc2Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch EnvironmentEc2")
...
func (r *EnvironmentEc2Reconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloud9v1alpha1.EnvironmentEc2{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloud9v1alpha1.EnvironmentEc2{}.APIVersion, cloud9v1alpha1.EnvironmentEc2{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloud9v1alpha1.EnvironmentEc2{}).
