...
// +kubebuilder:rbac:groups=lambda.aws.kubeform.com,resources=permissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.aws.kubeform.com,resources=permissions/status,verbs=get;update;patch
...
func (r *PermissionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lambdav1alpha1.Permission{}); err != nil {
			klog.Error(err, "unable to set up auditor", lambdav1alpha1.Permission{}.APIVersion, lambdav1alpha1.Permission{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&lambdav1alpha1.Permission{}).
