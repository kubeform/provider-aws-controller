...
// +kubebuilder:rbac:groups=dataexchange.aws.kubeform.com,resources=datasets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dataexchange.aws.kubeform.com,resources=datasets/status,verbs=get;update;patch
...
func (r *DataSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dataexchangev1alpha1.DataSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", dataexchangev1alpha1.DataSet{}.APIVersion, dataexchangev1alpha1.DataSet{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dataexchangev1alpha1.DataSet{}).
