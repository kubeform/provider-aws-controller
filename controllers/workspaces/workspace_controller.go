...
// +kubebuilder:rbac:groups=workspaces.aws.kubeform.com,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=workspaces.aws.kubeform.com,resources=workspaces/status,verbs=get;update;patch
...
func (r *WorkspaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &workspacesv1alpha1.Workspace{}); err != nil {
			klog.Error(err, "unable to set up auditor", workspacesv1alpha1.Workspace{}.APIVersion, workspacesv1alpha1.Workspace{}.Kind)
			return err
		}
	}
