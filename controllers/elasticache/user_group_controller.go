...
// +kubebuilder:rbac:groups=elasticache.aws.kubeform.com,resources=usergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticache.aws.kubeform.com,resources=usergroups/status,verbs=get;update;patch
...
func (r *UserGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &elasticachev1alpha1.UserGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", elasticachev1alpha1.UserGroup{}.APIVersion, elasticachev1alpha1.UserGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&elasticachev1alpha1.UserGroup{}).
