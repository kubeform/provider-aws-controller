...
// +kubebuilder:rbac:groups=ec2.aws.kubeform.com,resources=trafficmirrorfilters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.aws.kubeform.com,resources=trafficmirrorfilters/status,verbs=get;update;patch
...
func (r *TrafficMirrorFilterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ec2v1alpha1.TrafficMirrorFilter{}); err != nil {
			klog.Error(err, "unable to set up auditor", ec2v1alpha1.TrafficMirrorFilter{}.APIVersion, ec2v1alpha1.TrafficMirrorFilter{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ec2v1alpha1.TrafficMirrorFilter{}).
