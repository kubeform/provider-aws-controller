...
// ManagedPrefixListReconciler reconciles a ManagedPrefixList object
...
// +kubebuilder:rbac:groups=ec2.aws.kubeform.com,resources=managedprefixlists,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.aws.kubeform.com,resources=managedprefixlists/status,verbs=get;update;patch

func (r *ManagedPrefixListReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("managedprefixlist", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch ManagedPrefixList")
...
func (r *ManagedPrefixListReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ec2v1alpha1.ManagedPrefixList{}); err != nil {
			klog.Error(err, "unable to set up auditor", ec2v1alpha1.ManagedPrefixList{}.APIVersion, ec2v1alpha1.ManagedPrefixList{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ec2v1alpha1.ManagedPrefixList{}).
