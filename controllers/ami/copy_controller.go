...
// +kubebuilder:rbac:groups=ami.aws.kubeform.com,resources=copies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ami.aws.kubeform.com,resources=copies/status,verbs=get;update;patch
...
func (r *CopyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &amiv1alpha1.Copy{}); err != nil {
			klog.Error(err, "unable to set up auditor", amiv1alpha1.Copy{}.APIVersion, amiv1alpha1.Copy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&amiv1alpha1.Copy{}).
