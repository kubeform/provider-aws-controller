...
// +kubebuilder:rbac:groups=cloudwatch.aws.kubeform.com,resources=eventrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudwatch.aws.kubeform.com,resources=eventrules/status,verbs=get;update;patch
...
func (r *EventRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudwatchv1alpha1.EventRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudwatchv1alpha1.EventRule{}.APIVersion, cloudwatchv1alpha1.EventRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudwatchv1alpha1.EventRule{}).
