...
// +kubebuilder:rbac:groups=cloudwatch.aws.kubeform.com,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudwatch.aws.kubeform.com,resources=dashboards/status,verbs=get;update;patch
...
func (r *DashboardReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudwatchv1alpha1.Dashboard{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudwatchv1alpha1.Dashboard{}.APIVersion, cloudwatchv1alpha1.Dashboard{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudwatchv1alpha1.Dashboard{}).
