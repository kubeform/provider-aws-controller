module kubeform.dev/provider-aws-controller
...
require (
	...
	github.com/hashicorp/terraform-provider-aws v1.60.1-0.20220325193134-2def2996f8dc
	...
	kubeform.dev/provider-aws-api v0.5.0
