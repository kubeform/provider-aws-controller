...
func newSecurityProfiles(c *ConnectV1alpha1Client, namespace string) *securityProfiles {
...
func (c *securityProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SecurityProfile, err error) {
	result = &v1alpha1.SecurityProfile{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *securityProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SecurityProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SecurityProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("securityprofiles").
...
func (c *securityProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *securityProfiles) Create(ctx context.Context, securityProfile *v1alpha1.SecurityProfile, opts v1.CreateOptions) (result *v1alpha1.SecurityProfile, err error) {
	result = &v1alpha1.SecurityProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("securityprofiles").
...
func (c *securityProfiles) Update(ctx context.Context, securityProfile *v1alpha1.SecurityProfile, opts v1.UpdateOptions) (result *v1alpha1.SecurityProfile, err error) {
	result = &v1alpha1.SecurityProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("securityprofiles").
...
func (c *securityProfiles) UpdateStatus(ctx context.Context, securityProfile *v1alpha1.SecurityProfile, opts v1.UpdateOptions) (result *v1alpha1.SecurityProfile, err error) {
	result = &v1alpha1.SecurityProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("securityprofiles").
...
func (c *securityProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *securityProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *securityProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SecurityProfile, err error) {
	result = &v1alpha1.SecurityProfile{}
