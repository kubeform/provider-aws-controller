...
// FleetStackAssociationsGetter has a method to return a FleetStackAssociationInterface.
...
// fleetStackAssociations implements FleetStackAssociationInterface
type fleetStackAssociations struct {
	client rest.Interface
	ns     string
}

// newFleetStackAssociations returns a FleetStackAssociations
func newFleetStackAssociations(c *AppstreamV1alpha1Client, namespace string) *fleetStackAssociations {
	return &fleetStackAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *fleetStackAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FleetStackAssociation, err error) {
	result = &v1alpha1.FleetStackAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *fleetStackAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FleetStackAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FleetStackAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fleetstackassociations").
...
func (c *fleetStackAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fleetStackAssociations) Create(ctx context.Context, fleetStackAssociation *v1alpha1.FleetStackAssociation, opts v1.CreateOptions) (result *v1alpha1.FleetStackAssociation, err error) {
	result = &v1alpha1.FleetStackAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fleetstackassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fleetStackAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *fleetStackAssociations) Update(ctx context.Context, fleetStackAssociation *v1alpha1.FleetStackAssociation, opts v1.UpdateOptions) (result *v1alpha1.FleetStackAssociation, err error) {
	result = &v1alpha1.FleetStackAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fleetstackassociations").
		Name(fleetStackAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fleetStackAssociation).
		Do(ctx).
		Into(result)
...
func (c *fleetStackAssociations) UpdateStatus(ctx context.Context, fleetStackAssociation *v1alpha1.FleetStackAssociation, opts v1.UpdateOptions) (result *v1alpha1.FleetStackAssociation, err error) {
	result = &v1alpha1.FleetStackAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fleetstackassociations").
...
func (c *fleetStackAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fleetStackAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fleetStackAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FleetStackAssociation, err error) {
	result = &v1alpha1.FleetStackAssociation{}
