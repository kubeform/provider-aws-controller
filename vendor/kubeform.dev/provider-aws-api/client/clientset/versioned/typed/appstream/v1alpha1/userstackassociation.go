...
// UserStackAssociationsGetter has a method to return a UserStackAssociationInterface.
...
// userStackAssociations implements UserStackAssociationInterface
type userStackAssociations struct {
	client rest.Interface
	ns     string
}

// newUserStackAssociations returns a UserStackAssociations
func newUserStackAssociations(c *AppstreamV1alpha1Client, namespace string) *userStackAssociations {
...
func (c *userStackAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserStackAssociation, err error) {
	result = &v1alpha1.UserStackAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userStackAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserStackAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserStackAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("userstackassociations").
...
func (c *userStackAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userStackAssociations) Create(ctx context.Context, userStackAssociation *v1alpha1.UserStackAssociation, opts v1.CreateOptions) (result *v1alpha1.UserStackAssociation, err error) {
	result = &v1alpha1.UserStackAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userstackassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(userStackAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *userStackAssociations) Update(ctx context.Context, userStackAssociation *v1alpha1.UserStackAssociation, opts v1.UpdateOptions) (result *v1alpha1.UserStackAssociation, err error) {
	result = &v1alpha1.UserStackAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userstackassociations").
		Name(userStackAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(userStackAssociation).
		Do(ctx).
		Into(result)
...
func (c *userStackAssociations) UpdateStatus(ctx context.Context, userStackAssociation *v1alpha1.UserStackAssociation, opts v1.UpdateOptions) (result *v1alpha1.UserStackAssociation, err error) {
	result = &v1alpha1.UserStackAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userstackassociations").
...
func (c *userStackAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userStackAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userStackAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserStackAssociation, err error) {
	result = &v1alpha1.UserStackAssociation{}
