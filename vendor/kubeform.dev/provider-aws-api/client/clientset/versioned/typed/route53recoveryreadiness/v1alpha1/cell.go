...
func newCells(c *Route53recoveryreadinessV1alpha1Client, namespace string) *cells {
	return &cells{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cells) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Cell, err error) {
...
func (c *cells) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CellList, err error) {
...
func (c *cells) Create(ctx context.Context, cell *v1alpha1.Cell, opts v1.CreateOptions) (result *v1alpha1.Cell, err error) {
	result = &v1alpha1.Cell{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) Update(ctx context.Context, cell *v1alpha1.Cell, opts v1.UpdateOptions) (result *v1alpha1.Cell, err error) {
	result = &v1alpha1.Cell{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) UpdateStatus(ctx context.Context, cell *v1alpha1.Cell, opts v1.UpdateOptions) (result *v1alpha1.Cell, err error) {
	result = &v1alpha1.Cell{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cell, err error) {
	result = &v1alpha1.Cell{}
