...
// FieldLevelEncryptionConfigsGetter has a method to return a FieldLevelEncryptionConfigInterface.
...
// fieldLevelEncryptionConfigs implements FieldLevelEncryptionConfigInterface
type fieldLevelEncryptionConfigs struct {
	client rest.Interface
	ns     string
}

// newFieldLevelEncryptionConfigs returns a FieldLevelEncryptionConfigs
func newFieldLevelEncryptionConfigs(c *CloudfrontV1alpha1Client, namespace string) *fieldLevelEncryptionConfigs {
	return &fieldLevelEncryptionConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *fieldLevelEncryptionConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FieldLevelEncryptionConfig, err error) {
	result = &v1alpha1.FieldLevelEncryptionConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *fieldLevelEncryptionConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FieldLevelEncryptionConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FieldLevelEncryptionConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fieldlevelencryptionconfigs").
...
func (c *fieldLevelEncryptionConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fieldLevelEncryptionConfigs) Create(ctx context.Context, fieldLevelEncryptionConfig *v1alpha1.FieldLevelEncryptionConfig, opts v1.CreateOptions) (result *v1alpha1.FieldLevelEncryptionConfig, err error) {
	result = &v1alpha1.FieldLevelEncryptionConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fieldlevelencryptionconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fieldLevelEncryptionConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *fieldLevelEncryptionConfigs) Update(ctx context.Context, fieldLevelEncryptionConfig *v1alpha1.FieldLevelEncryptionConfig, opts v1.UpdateOptions) (result *v1alpha1.FieldLevelEncryptionConfig, err error) {
	result = &v1alpha1.FieldLevelEncryptionConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fieldlevelencryptionconfigs").
		Name(fieldLevelEncryptionConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fieldLevelEncryptionConfig).
		Do(ctx).
		Into(result)
...
func (c *fieldLevelEncryptionConfigs) UpdateStatus(ctx context.Context, fieldLevelEncryptionConfig *v1alpha1.FieldLevelEncryptionConfig, opts v1.UpdateOptions) (result *v1alpha1.FieldLevelEncryptionConfig, err error) {
	result = &v1alpha1.FieldLevelEncryptionConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fieldlevelencryptionconfigs").
...
func (c *fieldLevelEncryptionConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fieldLevelEncryptionConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fieldLevelEncryptionConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FieldLevelEncryptionConfig, err error) {
	result = &v1alpha1.FieldLevelEncryptionConfig{}
