...
type ApprunnerV1alpha1Interface interface {
	RESTClient() rest.Interface
	AutoScalingConfigurationVersionsGetter
	ConnectionsGetter
...
func (c *ApprunnerV1alpha1Client) AutoScalingConfigurationVersions(namespace string) AutoScalingConfigurationVersionInterface {
	return newAutoScalingConfigurationVersions(c, namespace)
}
...
func (c *ApprunnerV1alpha1Client) CustomDomainAssociations(namespace string) CustomDomainAssociationInterface {
	return newCustomDomainAssociations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ApprunnerV1alpha1Client, error) {
	...
	return &ApprunnerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ApprunnerV1alpha1Client for the given config and
...
func New(c rest.Interface) *ApprunnerV1alpha1Client {
	return &ApprunnerV1alpha1Client{c}
}
