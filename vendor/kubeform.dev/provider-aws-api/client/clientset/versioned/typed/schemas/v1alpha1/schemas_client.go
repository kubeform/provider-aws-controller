...
func (c *SchemasV1alpha1Client) Discoverers(namespace string) DiscovererInterface {
	return newDiscoverers(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*SchemasV1alpha1Client, error) {
	...
	return &SchemasV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SchemasV1alpha1Client for the given config and
...
func New(c rest.Interface) *SchemasV1alpha1Client {
	return &SchemasV1alpha1Client{c}
}
