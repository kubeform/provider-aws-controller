...
// SigningCertificatesGetter has a method to return a SigningCertificateInterface.
...
// signingCertificates implements SigningCertificateInterface
type signingCertificates struct {
	client rest.Interface
	ns     string
}

// newSigningCertificates returns a SigningCertificates
func newSigningCertificates(c *IamV1alpha1Client, namespace string) *signingCertificates {
...
func (c *signingCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SigningCertificate, err error) {
	result = &v1alpha1.SigningCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *signingCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SigningCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SigningCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("signingcertificates").
...
func (c *signingCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *signingCertificates) Create(ctx context.Context, signingCertificate *v1alpha1.SigningCertificate, opts v1.CreateOptions) (result *v1alpha1.SigningCertificate, err error) {
	result = &v1alpha1.SigningCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("signingcertificates").
...
func (c *signingCertificates) Update(ctx context.Context, signingCertificate *v1alpha1.SigningCertificate, opts v1.UpdateOptions) (result *v1alpha1.SigningCertificate, err error) {
	result = &v1alpha1.SigningCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("signingcertificates").
...
func (c *signingCertificates) UpdateStatus(ctx context.Context, signingCertificate *v1alpha1.SigningCertificate, opts v1.UpdateOptions) (result *v1alpha1.SigningCertificate, err error) {
	result = &v1alpha1.SigningCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("signingcertificates").
...
func (c *signingCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *signingCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *signingCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SigningCertificate, err error) {
	result = &v1alpha1.SigningCertificate{}
