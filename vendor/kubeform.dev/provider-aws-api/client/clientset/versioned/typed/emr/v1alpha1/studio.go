...
// StudiosGetter has a method to return a StudioInterface.
...
// studios implements StudioInterface
type studios struct {
	client rest.Interface
	ns     string
}

// newStudios returns a Studios
func newStudios(c *EmrV1alpha1Client, namespace string) *studios {
	return &studios{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *studios) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Studio, err error) {
	result = &v1alpha1.Studio{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("studios").
		Name(name).
...
func (c *studios) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StudioList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StudioList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("studios").
...
func (c *studios) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *studios) Create(ctx context.Context, studio *v1alpha1.Studio, opts v1.CreateOptions) (result *v1alpha1.Studio, err error) {
	result = &v1alpha1.Studio{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("studios").
...
func (c *studios) Update(ctx context.Context, studio *v1alpha1.Studio, opts v1.UpdateOptions) (result *v1alpha1.Studio, err error) {
	result = &v1alpha1.Studio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("studios").
...
func (c *studios) UpdateStatus(ctx context.Context, studio *v1alpha1.Studio, opts v1.UpdateOptions) (result *v1alpha1.Studio, err error) {
	result = &v1alpha1.Studio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("studios").
...
func (c *studios) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *studios) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *studios) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Studio, err error) {
	result = &v1alpha1.Studio{}
