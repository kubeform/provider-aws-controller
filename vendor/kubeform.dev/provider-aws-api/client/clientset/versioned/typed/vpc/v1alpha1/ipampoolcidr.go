...
// IpamPoolCIDRsGetter has a method to return a IpamPoolCIDRInterface.
...
// ipamPoolCIDRs implements IpamPoolCIDRInterface
type ipamPoolCIDRs struct {
	client rest.Interface
	ns     string
}

// newIpamPoolCIDRs returns a IpamPoolCIDRs
func newIpamPoolCIDRs(c *VpcV1alpha1Client, namespace string) *ipamPoolCIDRs {
...
func (c *ipamPoolCIDRs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPoolCIDR, err error) {
	result = &v1alpha1.IpamPoolCIDR{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ipamPoolCIDRs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPoolCIDRList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamPoolCIDRList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipampoolcidrs").
...
func (c *ipamPoolCIDRs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ipamPoolCIDRs) Create(ctx context.Context, ipamPoolCIDR *v1alpha1.IpamPoolCIDR, opts v1.CreateOptions) (result *v1alpha1.IpamPoolCIDR, err error) {
	result = &v1alpha1.IpamPoolCIDR{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipampoolcidrs").
...
func (c *ipamPoolCIDRs) Update(ctx context.Context, ipamPoolCIDR *v1alpha1.IpamPoolCIDR, opts v1.UpdateOptions) (result *v1alpha1.IpamPoolCIDR, err error) {
	result = &v1alpha1.IpamPoolCIDR{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampoolcidrs").
		Name(ipamPoolCIDR.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ipamPoolCIDR).
		Do(ctx).
		Into(result)
...
func (c *ipamPoolCIDRs) UpdateStatus(ctx context.Context, ipamPoolCIDR *v1alpha1.IpamPoolCIDR, opts v1.UpdateOptions) (result *v1alpha1.IpamPoolCIDR, err error) {
	result = &v1alpha1.IpamPoolCIDR{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampoolcidrs").
...
func (c *ipamPoolCIDRs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ipamPoolCIDRs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipamPoolCIDRs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPoolCIDR, err error) {
	result = &v1alpha1.IpamPoolCIDR{}
