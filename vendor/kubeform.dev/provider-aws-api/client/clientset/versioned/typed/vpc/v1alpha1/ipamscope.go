...
// IpamScopesGetter has a method to return a IpamScopeInterface.
...
// ipamScopes implements IpamScopeInterface
type ipamScopes struct {
	client rest.Interface
	ns     string
}

// newIpamScopes returns a IpamScopes
func newIpamScopes(c *VpcV1alpha1Client, namespace string) *ipamScopes {
	return &ipamScopes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ipamScopes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamScope, err error) {
	result = &v1alpha1.IpamScope{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipamscopes").
		Name(name).
...
func (c *ipamScopes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamScopeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamScopeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipamscopes").
...
func (c *ipamScopes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ipamScopes) Create(ctx context.Context, ipamScope *v1alpha1.IpamScope, opts v1.CreateOptions) (result *v1alpha1.IpamScope, err error) {
	result = &v1alpha1.IpamScope{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipamscopes").
...
func (c *ipamScopes) Update(ctx context.Context, ipamScope *v1alpha1.IpamScope, opts v1.UpdateOptions) (result *v1alpha1.IpamScope, err error) {
	result = &v1alpha1.IpamScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipamscopes").
...
func (c *ipamScopes) UpdateStatus(ctx context.Context, ipamScope *v1alpha1.IpamScope, opts v1.UpdateOptions) (result *v1alpha1.IpamScope, err error) {
	result = &v1alpha1.IpamScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipamscopes").
...
func (c *ipamScopes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ipamScopes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipamScopes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamScope, err error) {
	result = &v1alpha1.IpamScope{}
