...
func newIpams(c *VpcV1alpha1Client, namespace string) *ipams {
	return &ipams{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ipams) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ipam, err error) {
	result = &v1alpha1.Ipam{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipams").
		Name(name).
...
func (c *ipams) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipams").
...
func (c *ipams) Create(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.CreateOptions) (result *v1alpha1.Ipam, err error) {
	result = &v1alpha1.Ipam{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipams").
...
func (c *ipams) Update(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.UpdateOptions) (result *v1alpha1.Ipam, err error) {
	result = &v1alpha1.Ipam{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipams").
...
func (c *ipams) UpdateStatus(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.UpdateOptions) (result *v1alpha1.Ipam, err error) {
	result = &v1alpha1.Ipam{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipams").
...
func (c *ipams) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ipam, err error) {
	result = &v1alpha1.Ipam{}
