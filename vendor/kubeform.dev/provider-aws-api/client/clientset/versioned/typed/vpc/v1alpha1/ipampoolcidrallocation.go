...
// IpamPoolCIDRAllocationsGetter has a method to return a IpamPoolCIDRAllocationInterface.
...
// ipamPoolCIDRAllocations implements IpamPoolCIDRAllocationInterface
type ipamPoolCIDRAllocations struct {
	client rest.Interface
	ns     string
}

// newIpamPoolCIDRAllocations returns a IpamPoolCIDRAllocations
func newIpamPoolCIDRAllocations(c *VpcV1alpha1Client, namespace string) *ipamPoolCIDRAllocations {
	return &ipamPoolCIDRAllocations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *ipamPoolCIDRAllocations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	result = &v1alpha1.IpamPoolCIDRAllocation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ipamPoolCIDRAllocations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPoolCIDRAllocationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamPoolCIDRAllocationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipampoolcidrallocations").
...
func (c *ipamPoolCIDRAllocations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ipamPoolCIDRAllocations) Create(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.CreateOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	result = &v1alpha1.IpamPoolCIDRAllocation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipampoolcidrallocations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ipamPoolCIDRAllocation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ipamPoolCIDRAllocations) Update(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.UpdateOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	result = &v1alpha1.IpamPoolCIDRAllocation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampoolcidrallocations").
		Name(ipamPoolCIDRAllocation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ipamPoolCIDRAllocation).
		Do(ctx).
		Into(result)
...
func (c *ipamPoolCIDRAllocations) UpdateStatus(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.UpdateOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	result = &v1alpha1.IpamPoolCIDRAllocation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampoolcidrallocations").
...
func (c *ipamPoolCIDRAllocations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ipamPoolCIDRAllocations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipamPoolCIDRAllocations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	result = &v1alpha1.IpamPoolCIDRAllocation{}
