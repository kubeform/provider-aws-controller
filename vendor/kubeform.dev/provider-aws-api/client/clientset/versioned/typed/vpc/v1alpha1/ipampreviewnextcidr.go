...
// IpamPreviewNextCIDRsGetter has a method to return a IpamPreviewNextCIDRInterface.
...
// ipamPreviewNextCIDRs implements IpamPreviewNextCIDRInterface
type ipamPreviewNextCIDRs struct {
	client rest.Interface
	ns     string
}

// newIpamPreviewNextCIDRs returns a IpamPreviewNextCIDRs
func newIpamPreviewNextCIDRs(c *VpcV1alpha1Client, namespace string) *ipamPreviewNextCIDRs {
	return &ipamPreviewNextCIDRs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *ipamPreviewNextCIDRs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	result = &v1alpha1.IpamPreviewNextCIDR{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ipamPreviewNextCIDRs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPreviewNextCIDRList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamPreviewNextCIDRList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipampreviewnextcidrs").
...
func (c *ipamPreviewNextCIDRs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ipamPreviewNextCIDRs) Create(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.CreateOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	result = &v1alpha1.IpamPreviewNextCIDR{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipampreviewnextcidrs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ipamPreviewNextCIDR).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ipamPreviewNextCIDRs) Update(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.UpdateOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	result = &v1alpha1.IpamPreviewNextCIDR{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampreviewnextcidrs").
		Name(ipamPreviewNextCIDR.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ipamPreviewNextCIDR).
		Do(ctx).
		Into(result)
...
func (c *ipamPreviewNextCIDRs) UpdateStatus(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.UpdateOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	result = &v1alpha1.IpamPreviewNextCIDR{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampreviewnextcidrs").
...
func (c *ipamPreviewNextCIDRs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ipamPreviewNextCIDRs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipamPreviewNextCIDRs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	result = &v1alpha1.IpamPreviewNextCIDR{}
