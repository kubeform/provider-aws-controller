...
// EndpointConnectionAcceptersGetter has a method to return a EndpointConnectionAccepterInterface.
...
// endpointConnectionAccepters implements EndpointConnectionAccepterInterface
type endpointConnectionAccepters struct {
	client rest.Interface
	ns     string
}

// newEndpointConnectionAccepters returns a EndpointConnectionAccepters
func newEndpointConnectionAccepters(c *VpcV1alpha1Client, namespace string) *endpointConnectionAccepters {
	return &endpointConnectionAccepters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *endpointConnectionAccepters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	result = &v1alpha1.EndpointConnectionAccepter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointConnectionAccepters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointConnectionAccepterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointConnectionAccepterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointconnectionaccepters").
...
func (c *endpointConnectionAccepters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointConnectionAccepters) Create(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.CreateOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	result = &v1alpha1.EndpointConnectionAccepter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointconnectionaccepters").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointConnectionAccepter).
		Do(ctx).
		Into(result)
	return
}
...
func (c *endpointConnectionAccepters) Update(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.UpdateOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	result = &v1alpha1.EndpointConnectionAccepter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointconnectionaccepters").
		Name(endpointConnectionAccepter.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointConnectionAccepter).
		Do(ctx).
		Into(result)
...
func (c *endpointConnectionAccepters) UpdateStatus(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.UpdateOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	result = &v1alpha1.EndpointConnectionAccepter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointconnectionaccepters").
...
func (c *endpointConnectionAccepters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointConnectionAccepters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointConnectionAccepters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	result = &v1alpha1.EndpointConnectionAccepter{}
