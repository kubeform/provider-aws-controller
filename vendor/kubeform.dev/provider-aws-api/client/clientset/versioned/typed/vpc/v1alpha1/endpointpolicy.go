...
// EndpointPoliciesGetter has a method to return a EndpointPolicyInterface.
...
// endpointPolicies implements EndpointPolicyInterface
type endpointPolicies struct {
	client rest.Interface
	ns     string
}

// newEndpointPolicies returns a EndpointPolicies
func newEndpointPolicies(c *VpcV1alpha1Client, namespace string) *endpointPolicies {
...
func (c *endpointPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointPolicy, err error) {
	result = &v1alpha1.EndpointPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointpolicies").
...
func (c *endpointPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointPolicies) Create(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.CreateOptions) (result *v1alpha1.EndpointPolicy, err error) {
	result = &v1alpha1.EndpointPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointpolicies").
...
func (c *endpointPolicies) Update(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.UpdateOptions) (result *v1alpha1.EndpointPolicy, err error) {
	result = &v1alpha1.EndpointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointpolicies").
		Name(endpointPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointPolicy).
		Do(ctx).
		Into(result)
...
func (c *endpointPolicies) UpdateStatus(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.UpdateOptions) (result *v1alpha1.EndpointPolicy, err error) {
	result = &v1alpha1.EndpointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointpolicies").
...
func (c *endpointPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointPolicy, err error) {
	result = &v1alpha1.EndpointPolicy{}
