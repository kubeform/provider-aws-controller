...
func newIpamPools(c *VpcV1alpha1Client, namespace string) *ipamPools {
	return &ipamPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ipamPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPool, err error) {
	result = &v1alpha1.IpamPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipampools").
		Name(name).
...
func (c *ipamPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IpamPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ipampools").
...
func (c *ipamPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ipamPools) Create(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.CreateOptions) (result *v1alpha1.IpamPool, err error) {
	result = &v1alpha1.IpamPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ipampools").
...
func (c *ipamPools) Update(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.UpdateOptions) (result *v1alpha1.IpamPool, err error) {
	result = &v1alpha1.IpamPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampools").
...
func (c *ipamPools) UpdateStatus(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.UpdateOptions) (result *v1alpha1.IpamPool, err error) {
	result = &v1alpha1.IpamPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ipampools").
...
func (c *ipamPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ipamPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ipamPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPool, err error) {
	result = &v1alpha1.IpamPool{}
