...
type Macie2V1alpha1Interface interface {
	RESTClient() rest.Interface
	AccountsGetter
	ClassificationJobsGetter
	CustomDataIdentifiersGetter
	FindingsFiltersGetter
	InvitationAcceptersGetter
	MembersGetter
...
func NewForConfig(c *rest.Config) (*Macie2V1alpha1Client, error) {
	...
	return &Macie2V1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new Macie2V1alpha1Client for the given config and
...
func New(c rest.Interface) *Macie2V1alpha1Client {
	return &Macie2V1alpha1Client{c}
}
