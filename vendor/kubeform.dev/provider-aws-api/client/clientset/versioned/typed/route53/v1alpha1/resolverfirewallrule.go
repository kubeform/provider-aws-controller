...
// ResolverFirewallRulesGetter has a method to return a ResolverFirewallRuleInterface.
...
// resolverFirewallRules implements ResolverFirewallRuleInterface
type resolverFirewallRules struct {
	client rest.Interface
	ns     string
}

// newResolverFirewallRules returns a ResolverFirewallRules
func newResolverFirewallRules(c *Route53V1alpha1Client, namespace string) *resolverFirewallRules {
	return &resolverFirewallRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *resolverFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResolverFirewallRule, err error) {
	result = &v1alpha1.ResolverFirewallRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *resolverFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResolverFirewallRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ResolverFirewallRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("resolverfirewallrules").
...
func (c *resolverFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resolverFirewallRules) Create(ctx context.Context, resolverFirewallRule *v1alpha1.ResolverFirewallRule, opts v1.CreateOptions) (result *v1alpha1.ResolverFirewallRule, err error) {
	result = &v1alpha1.ResolverFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resolverfirewallrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(resolverFirewallRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *resolverFirewallRules) Update(ctx context.Context, resolverFirewallRule *v1alpha1.ResolverFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.ResolverFirewallRule, err error) {
	result = &v1alpha1.ResolverFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resolverfirewallrules").
		Name(resolverFirewallRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(resolverFirewallRule).
		Do(ctx).
		Into(result)
...
func (c *resolverFirewallRules) UpdateStatus(ctx context.Context, resolverFirewallRule *v1alpha1.ResolverFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.ResolverFirewallRule, err error) {
	result = &v1alpha1.ResolverFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resolverfirewallrules").
...
func (c *resolverFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resolverFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resolverFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResolverFirewallRule, err error) {
	result = &v1alpha1.ResolverFirewallRule{}
