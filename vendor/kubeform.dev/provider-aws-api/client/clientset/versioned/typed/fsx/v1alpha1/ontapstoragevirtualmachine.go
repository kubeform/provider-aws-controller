...
// OntapStorageVirtualMachinesGetter has a method to return a OntapStorageVirtualMachineInterface.
...
// ontapStorageVirtualMachines implements OntapStorageVirtualMachineInterface
type ontapStorageVirtualMachines struct {
	client rest.Interface
	ns     string
}

// newOntapStorageVirtualMachines returns a OntapStorageVirtualMachines
func newOntapStorageVirtualMachines(c *FsxV1alpha1Client, namespace string) *ontapStorageVirtualMachines {
	return &ontapStorageVirtualMachines{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *ontapStorageVirtualMachines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OntapStorageVirtualMachine, err error) {
	result = &v1alpha1.OntapStorageVirtualMachine{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ontapStorageVirtualMachines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OntapStorageVirtualMachineList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OntapStorageVirtualMachineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ontapstoragevirtualmachines").
...
func (c *ontapStorageVirtualMachines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ontapStorageVirtualMachines) Create(ctx context.Context, ontapStorageVirtualMachine *v1alpha1.OntapStorageVirtualMachine, opts v1.CreateOptions) (result *v1alpha1.OntapStorageVirtualMachine, err error) {
	result = &v1alpha1.OntapStorageVirtualMachine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ontapstoragevirtualmachines").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ontapStorageVirtualMachine).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ontapStorageVirtualMachines) Update(ctx context.Context, ontapStorageVirtualMachine *v1alpha1.OntapStorageVirtualMachine, opts v1.UpdateOptions) (result *v1alpha1.OntapStorageVirtualMachine, err error) {
	result = &v1alpha1.OntapStorageVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ontapstoragevirtualmachines").
		Name(ontapStorageVirtualMachine.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ontapStorageVirtualMachine).
		Do(ctx).
		Into(result)
...
func (c *ontapStorageVirtualMachines) UpdateStatus(ctx context.Context, ontapStorageVirtualMachine *v1alpha1.OntapStorageVirtualMachine, opts v1.UpdateOptions) (result *v1alpha1.OntapStorageVirtualMachine, err error) {
	result = &v1alpha1.OntapStorageVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ontapstoragevirtualmachines").
...
func (c *ontapStorageVirtualMachines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ontapStorageVirtualMachines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ontapStorageVirtualMachines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OntapStorageVirtualMachine, err error) {
	result = &v1alpha1.OntapStorageVirtualMachine{}
