...
// OpenzfsVolumesGetter has a method to return a OpenzfsVolumeInterface.
...
// openzfsVolumes implements OpenzfsVolumeInterface
type openzfsVolumes struct {
	client rest.Interface
	ns     string
}

// newOpenzfsVolumes returns a OpenzfsVolumes
func newOpenzfsVolumes(c *FsxV1alpha1Client, namespace string) *openzfsVolumes {
	return &openzfsVolumes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *openzfsVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OpenzfsVolume, err error) {
	result = &v1alpha1.OpenzfsVolume{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *openzfsVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OpenzfsVolumeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OpenzfsVolumeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("openzfsvolumes").
...
func (c *openzfsVolumes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *openzfsVolumes) Create(ctx context.Context, openzfsVolume *v1alpha1.OpenzfsVolume, opts v1.CreateOptions) (result *v1alpha1.OpenzfsVolume, err error) {
	result = &v1alpha1.OpenzfsVolume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("openzfsvolumes").
...
func (c *openzfsVolumes) Update(ctx context.Context, openzfsVolume *v1alpha1.OpenzfsVolume, opts v1.UpdateOptions) (result *v1alpha1.OpenzfsVolume, err error) {
	result = &v1alpha1.OpenzfsVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("openzfsvolumes").
		Name(openzfsVolume.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(openzfsVolume).
		Do(ctx).
		Into(result)
...
func (c *openzfsVolumes) UpdateStatus(ctx context.Context, openzfsVolume *v1alpha1.OpenzfsVolume, opts v1.UpdateOptions) (result *v1alpha1.OpenzfsVolume, err error) {
	result = &v1alpha1.OpenzfsVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("openzfsvolumes").
...
func (c *openzfsVolumes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *openzfsVolumes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *openzfsVolumes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OpenzfsVolume, err error) {
	result = &v1alpha1.OpenzfsVolume{}
