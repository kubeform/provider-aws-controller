...
// HumanTaskUisGetter has a method to return a HumanTaskUiInterface.
...
// humanTaskUis implements HumanTaskUiInterface
type humanTaskUis struct {
	client rest.Interface
	ns     string
}

// newHumanTaskUis returns a HumanTaskUis
func newHumanTaskUis(c *SagemakerV1alpha1Client, namespace string) *humanTaskUis {
	return &humanTaskUis{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *humanTaskUis) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HumanTaskUi, err error) {
	result = &v1alpha1.HumanTaskUi{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *humanTaskUis) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HumanTaskUiList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HumanTaskUiList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("humantaskuis").
...
func (c *humanTaskUis) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *humanTaskUis) Create(ctx context.Context, humanTaskUi *v1alpha1.HumanTaskUi, opts v1.CreateOptions) (result *v1alpha1.HumanTaskUi, err error) {
	result = &v1alpha1.HumanTaskUi{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("humantaskuis").
...
func (c *humanTaskUis) Update(ctx context.Context, humanTaskUi *v1alpha1.HumanTaskUi, opts v1.UpdateOptions) (result *v1alpha1.HumanTaskUi, err error) {
	result = &v1alpha1.HumanTaskUi{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("humantaskuis").
		Name(humanTaskUi.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(humanTaskUi).
		Do(ctx).
		Into(result)
...
func (c *humanTaskUis) UpdateStatus(ctx context.Context, humanTaskUi *v1alpha1.HumanTaskUi, opts v1.UpdateOptions) (result *v1alpha1.HumanTaskUi, err error) {
	result = &v1alpha1.HumanTaskUi{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("humantaskuis").
...
func (c *humanTaskUis) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *humanTaskUis) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *humanTaskUis) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HumanTaskUi, err error) {
	result = &v1alpha1.HumanTaskUi{}
