...
func (c *layerVersionPermissions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LayerVersionPermission, err error) {
...
func (c *layerVersionPermissions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LayerVersionPermissionList, err error) {
...
func (c *layerVersionPermissions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *layerVersionPermissions) Create(ctx context.Context, layerVersionPermission *v1alpha1.LayerVersionPermission, opts v1.CreateOptions) (result *v1alpha1.LayerVersionPermission, err error) {
	result = &v1alpha1.LayerVersionPermission{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("layerversionpermissions").
...
func (c *layerVersionPermissions) Update(ctx context.Context, layerVersionPermission *v1alpha1.LayerVersionPermission, opts v1.UpdateOptions) (result *v1alpha1.LayerVersionPermission, err error) {
	result = &v1alpha1.LayerVersionPermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("layerversionpermissions").
...
func (c *layerVersionPermissions) UpdateStatus(ctx context.Context, layerVersionPermission *v1alpha1.LayerVersionPermission, opts v1.UpdateOptions) (result *v1alpha1.LayerVersionPermission, err error) {
	result = &v1alpha1.LayerVersionPermission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("layerversionpermissions").
...
func (c *layerVersionPermissions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *layerVersionPermissions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *layerVersionPermissions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LayerVersionPermission, err error) {
	result = &v1alpha1.LayerVersionPermission{}
