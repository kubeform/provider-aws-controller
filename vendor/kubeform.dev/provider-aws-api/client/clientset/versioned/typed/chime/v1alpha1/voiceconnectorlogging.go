...
// VoiceConnectorLoggingsGetter has a method to return a VoiceConnectorLoggingInterface.
...
// voiceConnectorLoggings implements VoiceConnectorLoggingInterface
type voiceConnectorLoggings struct {
	client rest.Interface
	ns     string
}

// newVoiceConnectorLoggings returns a VoiceConnectorLoggings
func newVoiceConnectorLoggings(c *ChimeV1alpha1Client, namespace string) *voiceConnectorLoggings {
	return &voiceConnectorLoggings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *voiceConnectorLoggings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VoiceConnectorLogging, err error) {
	result = &v1alpha1.VoiceConnectorLogging{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *voiceConnectorLoggings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VoiceConnectorLoggingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VoiceConnectorLoggingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("voiceconnectorloggings").
...
func (c *voiceConnectorLoggings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *voiceConnectorLoggings) Create(ctx context.Context, voiceConnectorLogging *v1alpha1.VoiceConnectorLogging, opts v1.CreateOptions) (result *v1alpha1.VoiceConnectorLogging, err error) {
	result = &v1alpha1.VoiceConnectorLogging{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("voiceconnectorloggings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(voiceConnectorLogging).
		Do(ctx).
		Into(result)
	return
}
...
func (c *voiceConnectorLoggings) Update(ctx context.Context, voiceConnectorLogging *v1alpha1.VoiceConnectorLogging, opts v1.UpdateOptions) (result *v1alpha1.VoiceConnectorLogging, err error) {
	result = &v1alpha1.VoiceConnectorLogging{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("voiceconnectorloggings").
		Name(voiceConnectorLogging.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(voiceConnectorLogging).
		Do(ctx).
		Into(result)
...
func (c *voiceConnectorLoggings) UpdateStatus(ctx context.Context, voiceConnectorLogging *v1alpha1.VoiceConnectorLogging, opts v1.UpdateOptions) (result *v1alpha1.VoiceConnectorLogging, err error) {
	result = &v1alpha1.VoiceConnectorLogging{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("voiceconnectorloggings").
...
func (c *voiceConnectorLoggings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *voiceConnectorLoggings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *voiceConnectorLoggings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VoiceConnectorLogging, err error) {
	result = &v1alpha1.VoiceConnectorLogging{}
