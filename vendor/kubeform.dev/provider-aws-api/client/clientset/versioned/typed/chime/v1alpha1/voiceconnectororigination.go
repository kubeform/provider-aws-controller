...
// VoiceConnectorOriginationsGetter has a method to return a VoiceConnectorOriginationInterface.
...
// voiceConnectorOriginations implements VoiceConnectorOriginationInterface
type voiceConnectorOriginations struct {
	client rest.Interface
	ns     string
}

// newVoiceConnectorOriginations returns a VoiceConnectorOriginations
func newVoiceConnectorOriginations(c *ChimeV1alpha1Client, namespace string) *voiceConnectorOriginations {
	return &voiceConnectorOriginations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *voiceConnectorOriginations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VoiceConnectorOrigination, err error) {
	result = &v1alpha1.VoiceConnectorOrigination{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *voiceConnectorOriginations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VoiceConnectorOriginationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VoiceConnectorOriginationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("voiceconnectororiginations").
...
func (c *voiceConnectorOriginations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *voiceConnectorOriginations) Create(ctx context.Context, voiceConnectorOrigination *v1alpha1.VoiceConnectorOrigination, opts v1.CreateOptions) (result *v1alpha1.VoiceConnectorOrigination, err error) {
	result = &v1alpha1.VoiceConnectorOrigination{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("voiceconnectororiginations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(voiceConnectorOrigination).
		Do(ctx).
		Into(result)
	return
}
...
func (c *voiceConnectorOriginations) Update(ctx context.Context, voiceConnectorOrigination *v1alpha1.VoiceConnectorOrigination, opts v1.UpdateOptions) (result *v1alpha1.VoiceConnectorOrigination, err error) {
	result = &v1alpha1.VoiceConnectorOrigination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("voiceconnectororiginations").
		Name(voiceConnectorOrigination.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(voiceConnectorOrigination).
		Do(ctx).
		Into(result)
...
func (c *voiceConnectorOriginations) UpdateStatus(ctx context.Context, voiceConnectorOrigination *v1alpha1.VoiceConnectorOrigination, opts v1.UpdateOptions) (result *v1alpha1.VoiceConnectorOrigination, err error) {
	result = &v1alpha1.VoiceConnectorOrigination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("voiceconnectororiginations").
...
func (c *voiceConnectorOriginations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *voiceConnectorOriginations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *voiceConnectorOriginations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VoiceConnectorOrigination, err error) {
	result = &v1alpha1.VoiceConnectorOrigination{}
