...
func (c *tagOptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TagOption, err error) {
...
func (c *tagOptions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TagOptionList, err error) {
...
func (c *tagOptions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tagOptions) Create(ctx context.Context, tagOption *v1alpha1.TagOption, opts v1.CreateOptions) (result *v1alpha1.TagOption, err error) {
	result = &v1alpha1.TagOption{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tagoptions").
...
func (c *tagOptions) Update(ctx context.Context, tagOption *v1alpha1.TagOption, opts v1.UpdateOptions) (result *v1alpha1.TagOption, err error) {
	result = &v1alpha1.TagOption{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagoptions").
...
func (c *tagOptions) UpdateStatus(ctx context.Context, tagOption *v1alpha1.TagOption, opts v1.UpdateOptions) (result *v1alpha1.TagOption, err error) {
	result = &v1alpha1.TagOption{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tagoptions").
...
func (c *tagOptions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tagOptions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tagOptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TagOption, err error) {
	result = &v1alpha1.TagOption{}
