...
func newConstraints(c *ServicecatalogV1alpha1Client, namespace string) *constraints {
	return &constraints{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *constraints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Constraint, err error) {
	result = &v1alpha1.Constraint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *constraints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConstraintList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ConstraintList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("constraints").
...
func (c *constraints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *constraints) Create(ctx context.Context, constraint *v1alpha1.Constraint, opts v1.CreateOptions) (result *v1alpha1.Constraint, err error) {
	result = &v1alpha1.Constraint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("constraints").
...
func (c *constraints) Update(ctx context.Context, constraint *v1alpha1.Constraint, opts v1.UpdateOptions) (result *v1alpha1.Constraint, err error) {
	result = &v1alpha1.Constraint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("constraints").
...
func (c *constraints) UpdateStatus(ctx context.Context, constraint *v1alpha1.Constraint, opts v1.UpdateOptions) (result *v1alpha1.Constraint, err error) {
	result = &v1alpha1.Constraint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("constraints").
...
func (c *constraints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *constraints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *constraints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Constraint, err error) {
	result = &v1alpha1.Constraint{}
