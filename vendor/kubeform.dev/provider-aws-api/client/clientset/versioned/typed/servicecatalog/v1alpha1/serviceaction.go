...
func newServiceActions(c *ServicecatalogV1alpha1Client, namespace string) *serviceActions {
...
func (c *serviceActions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceAction, err error) {
	result = &v1alpha1.ServiceAction{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceActions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceActionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceActionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceactions").
...
func (c *serviceActions) Create(ctx context.Context, serviceAction *v1alpha1.ServiceAction, opts v1.CreateOptions) (result *v1alpha1.ServiceAction, err error) {
	result = &v1alpha1.ServiceAction{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceactions").
...
func (c *serviceActions) Update(ctx context.Context, serviceAction *v1alpha1.ServiceAction, opts v1.UpdateOptions) (result *v1alpha1.ServiceAction, err error) {
	result = &v1alpha1.ServiceAction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceactions").
...
func (c *serviceActions) UpdateStatus(ctx context.Context, serviceAction *v1alpha1.ServiceAction, opts v1.UpdateOptions) (result *v1alpha1.ServiceAction, err error) {
	result = &v1alpha1.ServiceAction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceactions").
...
func (c *serviceActions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceAction, err error) {
	result = &v1alpha1.ServiceAction{}
