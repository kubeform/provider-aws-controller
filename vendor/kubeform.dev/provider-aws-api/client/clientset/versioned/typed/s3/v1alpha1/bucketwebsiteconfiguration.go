...
// BucketWebsiteConfigurationsGetter has a method to return a BucketWebsiteConfigurationInterface.
...
// bucketWebsiteConfigurations implements BucketWebsiteConfigurationInterface
type bucketWebsiteConfigurations struct {
	client rest.Interface
	ns     string
}

// newBucketWebsiteConfigurations returns a BucketWebsiteConfigurations
func newBucketWebsiteConfigurations(c *S3V1alpha1Client, namespace string) *bucketWebsiteConfigurations {
	return &bucketWebsiteConfigurations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *bucketWebsiteConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketWebsiteConfiguration, err error) {
	result = &v1alpha1.BucketWebsiteConfiguration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketWebsiteConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketWebsiteConfigurationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketWebsiteConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketwebsiteconfigurations").
...
func (c *bucketWebsiteConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketWebsiteConfigurations) Create(ctx context.Context, bucketWebsiteConfiguration *v1alpha1.BucketWebsiteConfiguration, opts v1.CreateOptions) (result *v1alpha1.BucketWebsiteConfiguration, err error) {
	result = &v1alpha1.BucketWebsiteConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketwebsiteconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketWebsiteConfiguration).
		Do(ctx).
		Into(result)
	return
}
...
func (c *bucketWebsiteConfigurations) Update(ctx context.Context, bucketWebsiteConfiguration *v1alpha1.BucketWebsiteConfiguration, opts v1.UpdateOptions) (result *v1alpha1.BucketWebsiteConfiguration, err error) {
	result = &v1alpha1.BucketWebsiteConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketwebsiteconfigurations").
		Name(bucketWebsiteConfiguration.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bucketWebsiteConfiguration).
		Do(ctx).
		Into(result)
...
func (c *bucketWebsiteConfigurations) UpdateStatus(ctx context.Context, bucketWebsiteConfiguration *v1alpha1.BucketWebsiteConfiguration, opts v1.UpdateOptions) (result *v1alpha1.BucketWebsiteConfiguration, err error) {
	result = &v1alpha1.BucketWebsiteConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketwebsiteconfigurations").
...
func (c *bucketWebsiteConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketWebsiteConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketWebsiteConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketWebsiteConfiguration, err error) {
	result = &v1alpha1.BucketWebsiteConfiguration{}
