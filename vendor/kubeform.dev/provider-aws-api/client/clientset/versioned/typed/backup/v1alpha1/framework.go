...
func newFrameworks(c *BackupV1alpha1Client, namespace string) *frameworks {
	return &frameworks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *frameworks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Framework, err error) {
...
func (c *frameworks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FrameworkList, err error) {
...
func (c *frameworks) Create(ctx context.Context, framework *v1alpha1.Framework, opts v1.CreateOptions) (result *v1alpha1.Framework, err error) {
	result = &v1alpha1.Framework{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("frameworks").
...
func (c *frameworks) Update(ctx context.Context, framework *v1alpha1.Framework, opts v1.UpdateOptions) (result *v1alpha1.Framework, err error) {
	result = &v1alpha1.Framework{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("frameworks").
...
func (c *frameworks) UpdateStatus(ctx context.Context, framework *v1alpha1.Framework, opts v1.UpdateOptions) (result *v1alpha1.Framework, err error) {
	result = &v1alpha1.Framework{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("frameworks").
...
func (c *frameworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Framework, err error) {
	result = &v1alpha1.Framework{}
