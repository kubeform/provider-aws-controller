...
// ScriptsGetter has a method to return a ScriptInterface.
...
// scripts implements ScriptInterface
type scripts struct {
	client rest.Interface
	ns     string
}

// newScripts returns a Scripts
func newScripts(c *GameliftV1alpha1Client, namespace string) *scripts {
	return &scripts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *scripts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Script, err error) {
	result = &v1alpha1.Script{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scripts").
		Name(name).
...
func (c *scripts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScriptList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ScriptList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scripts").
...
func (c *scripts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *scripts) Create(ctx context.Context, script *v1alpha1.Script, opts v1.CreateOptions) (result *v1alpha1.Script, err error) {
	result = &v1alpha1.Script{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("scripts").
...
func (c *scripts) Update(ctx context.Context, script *v1alpha1.Script, opts v1.UpdateOptions) (result *v1alpha1.Script, err error) {
	result = &v1alpha1.Script{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scripts").
...
func (c *scripts) UpdateStatus(ctx context.Context, script *v1alpha1.Script, opts v1.UpdateOptions) (result *v1alpha1.Script, err error) {
	result = &v1alpha1.Script{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scripts").
...
func (c *scripts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *scripts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *scripts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Script, err error) {
	result = &v1alpha1.Script{}
