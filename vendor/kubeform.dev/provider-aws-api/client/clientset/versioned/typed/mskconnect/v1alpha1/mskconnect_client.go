...
type MskconnectV1alpha1Interface interface {
	RESTClient() rest.Interface
	CustomPluginsGetter
	WorkerConfigurationsGetter
}
...
func NewForConfig(c *rest.Config) (*MskconnectV1alpha1Client, error) {
	...
	return &MskconnectV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new MskconnectV1alpha1Client for the given config and
...
func New(c rest.Interface) *MskconnectV1alpha1Client {
	return &MskconnectV1alpha1Client{c}
}
