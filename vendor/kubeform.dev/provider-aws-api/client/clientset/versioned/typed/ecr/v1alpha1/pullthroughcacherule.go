...
// PullThroughCacheRulesGetter has a method to return a PullThroughCacheRuleInterface.
...
// pullThroughCacheRules implements PullThroughCacheRuleInterface
type pullThroughCacheRules struct {
	client rest.Interface
	ns     string
}

// newPullThroughCacheRules returns a PullThroughCacheRules
func newPullThroughCacheRules(c *EcrV1alpha1Client, namespace string) *pullThroughCacheRules {
...
func (c *pullThroughCacheRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PullThroughCacheRule, err error) {
	result = &v1alpha1.PullThroughCacheRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pullThroughCacheRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PullThroughCacheRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PullThroughCacheRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pullthroughcacherules").
...
func (c *pullThroughCacheRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pullThroughCacheRules) Create(ctx context.Context, pullThroughCacheRule *v1alpha1.PullThroughCacheRule, opts v1.CreateOptions) (result *v1alpha1.PullThroughCacheRule, err error) {
	result = &v1alpha1.PullThroughCacheRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pullthroughcacherules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pullThroughCacheRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *pullThroughCacheRules) Update(ctx context.Context, pullThroughCacheRule *v1alpha1.PullThroughCacheRule, opts v1.UpdateOptions) (result *v1alpha1.PullThroughCacheRule, err error) {
	result = &v1alpha1.PullThroughCacheRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullthroughcacherules").
		Name(pullThroughCacheRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pullThroughCacheRule).
		Do(ctx).
		Into(result)
...
func (c *pullThroughCacheRules) UpdateStatus(ctx context.Context, pullThroughCacheRule *v1alpha1.PullThroughCacheRule, opts v1.UpdateOptions) (result *v1alpha1.PullThroughCacheRule, err error) {
	result = &v1alpha1.PullThroughCacheRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pullthroughcacherules").
...
func (c *pullThroughCacheRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *pullThroughCacheRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pullThroughCacheRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PullThroughCacheRule, err error) {
	result = &v1alpha1.PullThroughCacheRule{}
