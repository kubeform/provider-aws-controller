...
type CloudwatchV1alpha1Interface interface {
	...
	DashboardsGetter
	EventAPIDestinationsGetter
	EventArchivesGetter
	EventBusesGetter
	EventBusPoliciesGetter
	EventConnectionsGetter
...
func (c *CloudwatchV1alpha1Client) EventAPIDestinations(namespace string) EventAPIDestinationInterface {
	return newEventAPIDestinations(c, namespace)
}
...
func (c *CloudwatchV1alpha1Client) EventConnections(namespace string) EventConnectionInterface {
	return newEventConnections(c, namespace)
}
...
func (c *CloudwatchV1alpha1Client) MetricStreams(namespace string) MetricStreamInterface {
	return newMetricStreams(c, namespace)
}
