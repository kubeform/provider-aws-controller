...
// ApiCachesGetter has a method to return a ApiCacheInterface.
...
// apiCaches implements ApiCacheInterface
type apiCaches struct {
	client rest.Interface
	ns     string
}

// newApiCaches returns a ApiCaches
func newApiCaches(c *AppsyncV1alpha1Client, namespace string) *apiCaches {
	return &apiCaches{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apiCaches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiCache, err error) {
	result = &v1alpha1.ApiCache{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apicaches").
		Name(name).
...
func (c *apiCaches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiCacheList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiCacheList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apicaches").
...
func (c *apiCaches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiCaches) Create(ctx context.Context, apiCache *v1alpha1.ApiCache, opts v1.CreateOptions) (result *v1alpha1.ApiCache, err error) {
	result = &v1alpha1.ApiCache{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apicaches").
...
func (c *apiCaches) Update(ctx context.Context, apiCache *v1alpha1.ApiCache, opts v1.UpdateOptions) (result *v1alpha1.ApiCache, err error) {
	result = &v1alpha1.ApiCache{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apicaches").
...
func (c *apiCaches) UpdateStatus(ctx context.Context, apiCache *v1alpha1.ApiCache, opts v1.UpdateOptions) (result *v1alpha1.ApiCache, err error) {
	result = &v1alpha1.ApiCache{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apicaches").
...
func (c *apiCaches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiCaches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiCaches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiCache, err error) {
	result = &v1alpha1.ApiCache{}
