...
type DetectiveV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*DetectiveV1alpha1Client, error) {
	...
	return &DetectiveV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DetectiveV1alpha1Client for the given config and
...
func New(c rest.Interface) *DetectiveV1alpha1Client {
	return &DetectiveV1alpha1Client{c}
}
