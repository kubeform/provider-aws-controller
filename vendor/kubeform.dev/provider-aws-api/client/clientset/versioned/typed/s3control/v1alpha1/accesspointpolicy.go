...
// AccessPointPoliciesGetter has a method to return a AccessPointPolicyInterface.
...
// accessPointPolicies implements AccessPointPolicyInterface
type accessPointPolicies struct {
	client rest.Interface
	ns     string
}

// newAccessPointPolicies returns a AccessPointPolicies
func newAccessPointPolicies(c *S3controlV1alpha1Client, namespace string) *accessPointPolicies {
	return &accessPointPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accessPointPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccessPointPolicy, err error) {
	result = &v1alpha1.AccessPointPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accessPointPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessPointPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccessPointPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accesspointpolicies").
...
func (c *accessPointPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accessPointPolicies) Create(ctx context.Context, accessPointPolicy *v1alpha1.AccessPointPolicy, opts v1.CreateOptions) (result *v1alpha1.AccessPointPolicy, err error) {
	result = &v1alpha1.AccessPointPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accesspointpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accessPointPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accessPointPolicies) Update(ctx context.Context, accessPointPolicy *v1alpha1.AccessPointPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccessPointPolicy, err error) {
	result = &v1alpha1.AccessPointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accesspointpolicies").
		Name(accessPointPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accessPointPolicy).
		Do(ctx).
		Into(result)
...
func (c *accessPointPolicies) UpdateStatus(ctx context.Context, accessPointPolicy *v1alpha1.AccessPointPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccessPointPolicy, err error) {
	result = &v1alpha1.AccessPointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accesspointpolicies").
...
func (c *accessPointPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accessPointPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accessPointPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccessPointPolicy, err error) {
	result = &v1alpha1.AccessPointPolicy{}
