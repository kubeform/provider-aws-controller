...
type AmplifyV1alpha1Interface interface {
	RESTClient() rest.Interface
	AppsGetter
	BackendEnvironmentsGetter
	BranchesGetter
	DomainAssociationsGetter
	WebhooksGetter
}
...
func (c *AmplifyV1alpha1Client) BackendEnvironments(namespace string) BackendEnvironmentInterface {
	return newBackendEnvironments(c, namespace)
}
...
func (c *AmplifyV1alpha1Client) DomainAssociations(namespace string) DomainAssociationInterface {
	return newDomainAssociations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*AmplifyV1alpha1Client, error) {
	...
	return &AmplifyV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AmplifyV1alpha1Client for the given config and
...
func New(c rest.Interface) *AmplifyV1alpha1Client {
	return &AmplifyV1alpha1Client{c}
}
