...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-appconfig-aws-kubeform-com-v1alpha1-deployment,mutating=false,failurePolicy=fail,groups=appconfig.aws.kubeform.com,resources=deployments,versions=v1alpha1,name=deployment.appconfig.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
