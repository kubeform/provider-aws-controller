...
type DeploymentStrategy struct {
	...
	Spec              DeploymentStrategySpec   `json:"spec,omitempty"`
	Status            DeploymentStrategyStatus `json:"status,omitempty"`
}

type DeploymentStrategySpec struct {
	State *DeploymentStrategySpecResource `json:"state,omitempty" tf:"-"`

	Resource DeploymentStrategySpecResource `json:"resource" tf:"resource"`
...
type DeploymentStrategySpecResource struct {
...
// DeploymentStrategyList is a list of DeploymentStrategys
type DeploymentStrategyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of DeploymentStrategy CRD objects
	Items []DeploymentStrategy `json:"items,omitempty"`
}
