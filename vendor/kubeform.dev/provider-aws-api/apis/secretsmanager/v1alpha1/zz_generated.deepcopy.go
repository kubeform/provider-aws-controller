...
func (in *SecretPolicySpec) DeepCopyInto(out *SecretPolicySpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(SecretPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *SecretRotationSpec) DeepCopyInto(out *SecretRotationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SecretRotationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *SecretSpecResource) DeepCopyInto(out *SecretSpecResource) {
	*out = *in
	...
	if in.Replica != nil {
		...
		*out = make([]SecretSpecReplica, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SecretVersionSpec) DeepCopyInto(out *SecretVersionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SecretVersionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
