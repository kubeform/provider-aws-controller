...
func (in *ReplicationInstanceSpec) DeepCopyInto(out *ReplicationInstanceSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ReplicationInstanceSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationInstanceSpecResource) DeepCopyInto(out *ReplicationInstanceSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *ReplicationInstanceSpecResource) DeepCopy() *ReplicationInstanceSpecResource {
	if in == nil {
		return nil
	}
	out := new(ReplicationInstanceSpecResource)
...
func (in *ReplicationSubnetGroupSpec) DeepCopyInto(out *ReplicationSubnetGroupSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ReplicationSubnetGroupSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationSubnetGroupSpecResource) DeepCopyInto(out *ReplicationSubnetGroupSpecResource) {
	*out = *in
...
func (in *ReplicationSubnetGroupSpecResource) DeepCopy() *ReplicationSubnetGroupSpecResource {
	if in == nil {
		return nil
	}
	out := new(ReplicationSubnetGroupSpecResource)
...
func (in *ReplicationTaskSpec) DeepCopyInto(out *ReplicationTaskSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ReplicationTaskSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationTaskSpecResource) DeepCopyInto(out *ReplicationTaskSpecResource) {
	*out = *in
...
func (in *ReplicationTaskSpecResource) DeepCopy() *ReplicationTaskSpecResource {
	if in == nil {
		return nil
	}
	out := new(ReplicationTaskSpecResource)
