...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-cloudsearch-aws-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=cloudsearch.aws.kubeform.com,resources=domains,versions=v1alpha1,name=domain.cloudsearch.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
