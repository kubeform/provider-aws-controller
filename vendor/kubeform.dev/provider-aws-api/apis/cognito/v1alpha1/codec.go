...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomEmailSender{}).Type1()):              UserPoolSpecLambdaConfigCustomEmailSenderCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomSmsSender{}).Type1()):                UserPoolSpecLambdaConfigCustomSmsSenderCodec{},
...
func (UserPoolSpecAccountRecoverySettingCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj UserPoolSpecAccountRecoverySetting
			...
			*(*UserPoolSpecAccountRecoverySetting)(ptr) = obj
		} else {
			*(*UserPoolSpecAccountRecoverySetting)(ptr) = UserPoolSpecAccountRecoverySetting{}
		}
	default:
...
func (UserPoolSpecAdminCreateUserConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecAdminCreateUserConfig
			...
			*(*UserPoolSpecAdminCreateUserConfig)(ptr) = obj
		} else {
			*(*UserPoolSpecAdminCreateUserConfig)(ptr) = UserPoolSpecAdminCreateUserConfig{}
		}
	default:
...
func (UserPoolSpecAdminCreateUserConfigInviteMessageTemplateCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecAdminCreateUserConfigInviteMessageTemplate
			...
			*(*UserPoolSpecAdminCreateUserConfigInviteMessageTemplate)(ptr) = obj
		} else {
			*(*UserPoolSpecAdminCreateUserConfigInviteMessageTemplate)(ptr) = UserPoolSpecAdminCreateUserConfigInviteMessageTemplate{}
		}
	default:
...
func (UserPoolSpecDeviceConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecDeviceConfiguration
			...
			*(*UserPoolSpecDeviceConfiguration)(ptr) = obj
		} else {
			*(*UserPoolSpecDeviceConfiguration)(ptr) = UserPoolSpecDeviceConfiguration{}
		}
	default:
...
func (UserPoolSpecEmailConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecEmailConfiguration
			...
			*(*UserPoolSpecEmailConfiguration)(ptr) = obj
		} else {
			*(*UserPoolSpecEmailConfiguration)(ptr) = UserPoolSpecEmailConfiguration{}
		}
	default:
...
func (UserPoolSpecLambdaConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecLambdaConfig
			...
			*(*UserPoolSpecLambdaConfig)(ptr) = obj
		} else {
			*(*UserPoolSpecLambdaConfig)(ptr) = UserPoolSpecLambdaConfig{}
		}
	default:
...
func (UserPoolSpecLambdaConfigCustomEmailSenderCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) == nil
}

func (UserPoolSpecLambdaConfigCustomEmailSenderCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*UserPoolSpecLambdaConfigCustomEmailSender)(ptr)
	var objs []UserPoolSpecLambdaConfigCustomEmailSender
	if obj != nil {
		objs = []UserPoolSpecLambdaConfigCustomEmailSender{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomEmailSender{}).Type1())),
	}.Froze()
...
func (UserPoolSpecLambdaConfigCustomEmailSenderCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	switch iter.WhatIsNext() {
	case jsoniter.NilValue:
		iter.Skip()
		*(*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) = UserPoolSpecLambdaConfigCustomEmailSender{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomEmailSender{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) = objs[0]
			} else {
				*(*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) = UserPoolSpecLambdaConfigCustomEmailSender{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecLambdaConfigCustomEmailSender
			...
			*(*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) = obj
		} else {
			*(*UserPoolSpecLambdaConfigCustomEmailSender)(ptr) = UserPoolSpecLambdaConfigCustomEmailSender{}
		}
	default:
		iter.ReportError("decode UserPoolSpecLambdaConfigCustomEmailSender", "unexpected JSON type")
	}
}
...
func (UserPoolSpecLambdaConfigCustomSmsSenderCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) == nil
}

func (UserPoolSpecLambdaConfigCustomSmsSenderCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*UserPoolSpecLambdaConfigCustomSmsSender)(ptr)
	var objs []UserPoolSpecLambdaConfigCustomSmsSender
	if obj != nil {
		objs = []UserPoolSpecLambdaConfigCustomSmsSender{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomSmsSender{}).Type1())),
	}.Froze()
...
func (UserPoolSpecLambdaConfigCustomSmsSenderCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	switch iter.WhatIsNext() {
	case jsoniter.NilValue:
		iter.Skip()
		*(*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) = UserPoolSpecLambdaConfigCustomSmsSender{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(UserPoolSpecLambdaConfigCustomSmsSender{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) = objs[0]
			} else {
				*(*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) = UserPoolSpecLambdaConfigCustomSmsSender{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecLambdaConfigCustomSmsSender
			...
			*(*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) = obj
		} else {
			*(*UserPoolSpecLambdaConfigCustomSmsSender)(ptr) = UserPoolSpecLambdaConfigCustomSmsSender{}
		}
	default:
		iter.ReportError("decode UserPoolSpecLambdaConfigCustomSmsSender", "unexpected JSON type")
	}
}
...
func (UserPoolSpecPasswordPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecPasswordPolicy
			...
			*(*UserPoolSpecPasswordPolicy)(ptr) = obj
		} else {
			*(*UserPoolSpecPasswordPolicy)(ptr) = UserPoolSpecPasswordPolicy{}
		}
	default:
...
func (UserPoolSpecSchemaNumberAttributeConstraintsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecSchemaNumberAttributeConstraints
			...
			*(*UserPoolSpecSchemaNumberAttributeConstraints)(ptr) = obj
		} else {
			*(*UserPoolSpecSchemaNumberAttributeConstraints)(ptr) = UserPoolSpecSchemaNumberAttributeConstraints{}
		}
	default:
...
func (UserPoolSpecSchemaStringAttributeConstraintsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecSchemaStringAttributeConstraints
			...
			*(*UserPoolSpecSchemaStringAttributeConstraints)(ptr) = obj
		} else {
			*(*UserPoolSpecSchemaStringAttributeConstraints)(ptr) = UserPoolSpecSchemaStringAttributeConstraints{}
		}
	default:
...
func (UserPoolSpecSmsConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecSmsConfiguration
			...
			*(*UserPoolSpecSmsConfiguration)(ptr) = obj
		} else {
			*(*UserPoolSpecSmsConfiguration)(ptr) = UserPoolSpecSmsConfiguration{}
		}
	default:
...
func (UserPoolSpecSoftwareTokenMfaConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecSoftwareTokenMfaConfiguration
			...
			*(*UserPoolSpecSoftwareTokenMfaConfiguration)(ptr) = obj
		} else {
			*(*UserPoolSpecSoftwareTokenMfaConfiguration)(ptr) = UserPoolSpecSoftwareTokenMfaConfiguration{}
		}
	default:
...
func (UserPoolSpecUserPoolAddOnsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecUserPoolAddOns
			...
			*(*UserPoolSpecUserPoolAddOns)(ptr) = obj
		} else {
			*(*UserPoolSpecUserPoolAddOns)(ptr) = UserPoolSpecUserPoolAddOns{}
		}
	default:
...
func (UserPoolSpecUsernameConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecUsernameConfiguration
			...
			*(*UserPoolSpecUsernameConfiguration)(ptr) = obj
		} else {
			*(*UserPoolSpecUsernameConfiguration)(ptr) = UserPoolSpecUsernameConfiguration{}
		}
	default:
...
func (UserPoolSpecVerificationMessageTemplateCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolSpecVerificationMessageTemplate
			...
			*(*UserPoolSpecVerificationMessageTemplate)(ptr) = obj
		} else {
			*(*UserPoolSpecVerificationMessageTemplate)(ptr) = UserPoolSpecVerificationMessageTemplate{}
		}
	default:
...
func (UserPoolClientSpecAnalyticsConfigurationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolClientSpecAnalyticsConfiguration
			...
			*(*UserPoolClientSpecAnalyticsConfiguration)(ptr) = obj
		} else {
			*(*UserPoolClientSpecAnalyticsConfiguration)(ptr) = UserPoolClientSpecAnalyticsConfiguration{}
		}
	default:
...
func (UserPoolClientSpecTokenValidityUnitsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj UserPoolClientSpecTokenValidityUnits
			...
			*(*UserPoolClientSpecTokenValidityUnits)(ptr) = obj
		} else {
			*(*UserPoolClientSpecTokenValidityUnits)(ptr) = UserPoolClientSpecTokenValidityUnits{}
		}
	default:
