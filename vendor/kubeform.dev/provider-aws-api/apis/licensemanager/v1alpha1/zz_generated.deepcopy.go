...
func (in *LicenseConfigurationSpec) DeepCopyInto(out *LicenseConfigurationSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(LicenseConfigurationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LicenseConfigurationSpecResource) DeepCopyInto(out *LicenseConfigurationSpecResource) {
	*out = *in
	if in.Arn != nil {
...
func (in *LicenseConfigurationSpecResource) DeepCopy() *LicenseConfigurationSpecResource {
	if in == nil {
		return nil
	}
	out := new(LicenseConfigurationSpecResource)
