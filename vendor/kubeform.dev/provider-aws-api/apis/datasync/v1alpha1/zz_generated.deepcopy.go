...
func (in *LocationFsxLustreFileSystem) DeepCopy() *LocationFsxLustreFileSystem {
	...
	out := new(LocationFsxLustreFileSystem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationFsxLustreFileSystemList) DeepCopyInto(out *LocationFsxLustreFileSystemList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]LocationFsxLustreFileSystem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LocationFsxLustreFileSystemList) DeepCopy() *LocationFsxLustreFileSystemList {
	...
	out := new(LocationFsxLustreFileSystemList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationFsxLustreFileSystemSpec) DeepCopyInto(out *LocationFsxLustreFileSystemSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(LocationFsxLustreFileSystemSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *LocationFsxLustreFileSystemSpec) DeepCopy() *LocationFsxLustreFileSystemSpec {
	...
	out := new(LocationFsxLustreFileSystemSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationFsxLustreFileSystemStatus) DeepCopy() *LocationFsxLustreFileSystemStatus {
	...
	out := new(LocationFsxLustreFileSystemStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationHdfsSpec) DeepCopyInto(out *LocationHdfsSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(LocationHdfsSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *LocationHdfsSpecNameNode) DeepCopy() *LocationHdfsSpecNameNode {
	...
	out := new(LocationHdfsSpecNameNode)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationHdfsSpecQopConfiguration) DeepCopyInto(out *LocationHdfsSpecQopConfiguration) {
	*out = *in
	if in.DataTransferProtection != nil {
		in, out := &in.DataTransferProtection, &out.DataTransferProtection
		*out = new(string)
		**out = **in
	}
	if in.RpcProtection != nil {
		in, out := &in.RpcProtection, &out.RpcProtection
		*out = new(string)
		**out = **in
	}
	return
...
func (in *LocationHdfsSpecQopConfiguration) DeepCopy() *LocationHdfsSpecQopConfiguration {
	...
	out := new(LocationHdfsSpecQopConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LocationHdfsSpecResource) DeepCopyInto(out *LocationHdfsSpecResource) {
	*out = *in
	...
	if in.KerberosKrb5Conf != nil {
		in, out := &in.KerberosKrb5Conf, &out.KerberosKrb5Conf
		*out = new(string)
		**out = **in
	}
	...
	if in.KmsKeyProviderURI != nil {
		in, out := &in.KmsKeyProviderURI, &out.KmsKeyProviderURI
		*out = new(string)
		**out = **in
	}
	if in.NameNode != nil {
		in, out := &in.NameNode, &out.NameNode
		*out = make([]LocationHdfsSpecNameNode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.QopConfiguration != nil {
		in, out := &in.QopConfiguration, &out.QopConfiguration
		*out = new(LocationHdfsSpecQopConfiguration)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.SimpleUser != nil {
		in, out := &in.SimpleUser, &out.SimpleUser
		*out = new(string)
		**out = **in
	}
	if in.Subdirectory != nil {
