...
var querydefinitionForceNewList = map[string]bool{}
...
func (r *QueryDefinition) ValidateUpdate(old runtime.Object) error {
	...
	for key := range querydefinitionForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`querydefinition "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
