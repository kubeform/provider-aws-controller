...
func (ElasticsearchDomainSpecAdvancedSecurityOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecAdvancedSecurityOptions
			...
			*(*ElasticsearchDomainSpecAdvancedSecurityOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecAdvancedSecurityOptions)(ptr) = ElasticsearchDomainSpecAdvancedSecurityOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecAdvancedSecurityOptionsMasterUserOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecAdvancedSecurityOptionsMasterUserOptions
			...
			*(*ElasticsearchDomainSpecAdvancedSecurityOptionsMasterUserOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecAdvancedSecurityOptionsMasterUserOptions)(ptr) = ElasticsearchDomainSpecAdvancedSecurityOptionsMasterUserOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecClusterConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecClusterConfig
			...
			*(*ElasticsearchDomainSpecClusterConfig)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecClusterConfig)(ptr) = ElasticsearchDomainSpecClusterConfig{}
		}
	default:
...
func (ElasticsearchDomainSpecClusterConfigZoneAwarenessConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecClusterConfigZoneAwarenessConfig
			...
			*(*ElasticsearchDomainSpecClusterConfigZoneAwarenessConfig)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecClusterConfigZoneAwarenessConfig)(ptr) = ElasticsearchDomainSpecClusterConfigZoneAwarenessConfig{}
		}
	default:
...
func (ElasticsearchDomainSpecCognitoOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecCognitoOptions
			...
			*(*ElasticsearchDomainSpecCognitoOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecCognitoOptions)(ptr) = ElasticsearchDomainSpecCognitoOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecDomainEndpointOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecDomainEndpointOptions
			...
			*(*ElasticsearchDomainSpecDomainEndpointOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecDomainEndpointOptions)(ptr) = ElasticsearchDomainSpecDomainEndpointOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecEbsOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecEbsOptions
			...
			*(*ElasticsearchDomainSpecEbsOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecEbsOptions)(ptr) = ElasticsearchDomainSpecEbsOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecEncryptAtRestCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecEncryptAtRest
			...
			*(*ElasticsearchDomainSpecEncryptAtRest)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecEncryptAtRest)(ptr) = ElasticsearchDomainSpecEncryptAtRest{}
		}
	default:
...
func (ElasticsearchDomainSpecNodeToNodeEncryptionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecNodeToNodeEncryption
			...
			*(*ElasticsearchDomainSpecNodeToNodeEncryption)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecNodeToNodeEncryption)(ptr) = ElasticsearchDomainSpecNodeToNodeEncryption{}
		}
	default:
...
func (ElasticsearchDomainSpecSnapshotOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecSnapshotOptions
			...
			*(*ElasticsearchDomainSpecSnapshotOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecSnapshotOptions)(ptr) = ElasticsearchDomainSpecSnapshotOptions{}
		}
	default:
...
func (ElasticsearchDomainSpecVpcOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ElasticsearchDomainSpecVpcOptions
			...
			*(*ElasticsearchDomainSpecVpcOptions)(ptr) = obj
		} else {
			*(*ElasticsearchDomainSpecVpcOptions)(ptr) = ElasticsearchDomainSpecVpcOptions{}
		}
	default:
...
func (SamlOptionsSpecSamlOptionsCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*SamlOptionsSpecSamlOptions)(ptr) == nil
}

func (SamlOptionsSpecSamlOptionsCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*SamlOptionsSpecSamlOptions)(ptr)
	var objs []SamlOptionsSpecSamlOptions
	if obj != nil {
		objs = []SamlOptionsSpecSamlOptions{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(SamlOptionsSpecSamlOptions{}).Type1())),
	}.Froze()
...
func (SamlOptionsSpecSamlOptionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*SamlOptionsSpecSamlOptions)(ptr) = SamlOptionsSpecSamlOptions{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(SamlOptionsSpecSamlOptions{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*SamlOptionsSpecSamlOptions)(ptr) = objs[0]
			} else {
				*(*SamlOptionsSpecSamlOptions)(ptr) = SamlOptionsSpecSamlOptions{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SamlOptionsSpecSamlOptions
			...
			*(*SamlOptionsSpecSamlOptions)(ptr) = obj
		} else {
			*(*SamlOptionsSpecSamlOptions)(ptr) = SamlOptionsSpecSamlOptions{}
		}
	default:
		iter.ReportError("decode SamlOptionsSpecSamlOptions", "unexpected JSON type")
	}
}
...
func (SamlOptionsSpecSamlOptionsIdpCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*SamlOptionsSpecSamlOptionsIdp)(ptr) == nil
}

func (SamlOptionsSpecSamlOptionsIdpCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*SamlOptionsSpecSamlOptionsIdp)(ptr)
	var objs []SamlOptionsSpecSamlOptionsIdp
	if obj != nil {
		objs = []SamlOptionsSpecSamlOptionsIdp{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(SamlOptionsSpecSamlOptionsIdp{}).Type1())),
	}.Froze()
...
func (SamlOptionsSpecSamlOptionsIdpCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*SamlOptionsSpecSamlOptionsIdp)(ptr) = SamlOptionsSpecSamlOptionsIdp{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(SamlOptionsSpecSamlOptionsIdp{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*SamlOptionsSpecSamlOptionsIdp)(ptr) = objs[0]
			} else {
				*(*SamlOptionsSpecSamlOptionsIdp)(ptr) = SamlOptionsSpecSamlOptionsIdp{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SamlOptionsSpecSamlOptionsIdp
			...
			*(*SamlOptionsSpecSamlOptionsIdp)(ptr) = obj
		} else {
			*(*SamlOptionsSpecSamlOptionsIdp)(ptr) = SamlOptionsSpecSamlOptionsIdp{}
		}
	default:
		iter.ReportError("decode SamlOptionsSpecSamlOptionsIdp", "unexpected JSON type")
	}
}
