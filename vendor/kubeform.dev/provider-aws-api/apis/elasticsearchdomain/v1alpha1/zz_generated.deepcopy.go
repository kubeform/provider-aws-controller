...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDomainSpecAutoTuneOptions) DeepCopyInto(out *ElasticsearchDomainSpecAutoTuneOptions) {
	*out = *in
	...
	if in.MaintenanceSchedule != nil {
		...
		*out = make([]ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ElasticsearchDomainSpecAutoTuneOptions) DeepCopy() *ElasticsearchDomainSpecAutoTuneOptions {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDomainSpecAutoTuneOptions)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule) DeepCopyInto(out *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule) {
	*out = *in
	...
	if in.Duration != nil {
		...
		*out = new(ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration)
		(*in).DeepCopyInto(*out)
	}
	if in.StartAt != nil {
...
func (in *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule) DeepCopy() *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDomainSpecAutoTuneOptionsMaintenanceSchedule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration) DeepCopyInto(out *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration) {
	*out = *in
	if in.Unit != nil {
...
func (in *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration) DeepCopy() *ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchDomainSpecAutoTuneOptionsMaintenanceScheduleDuration)
