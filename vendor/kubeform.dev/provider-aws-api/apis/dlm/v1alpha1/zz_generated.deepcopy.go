...
func (in *LifecyclePolicySpecPolicyDetailsSchedule) DeepCopyInto(out *LifecyclePolicySpecPolicyDetailsSchedule) {
	*out = *in
	...
	if in.CrossRegionCopyRule != nil {
		...
		*out = make([]LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule) DeepCopyInto(out *LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule) {
	*out = *in
	...
	if in.DeprecateRule != nil {
		...
		*out = new(LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRule)
		(*in).DeepCopyInto(*out)
	}
	if in.Encrypted != nil {
	...
	if in.RetainRule != nil {
		in, out := &in.RetainRule, &out.RetainRule
		*out = new(LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRuleRetainRule)
		(*in).DeepCopyInto(*out)
	}
	if in.Target != nil {
...
func (in *LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule) DeepCopy() *LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule {
	...
	out := new(LifecyclePolicySpecPolicyDetailsScheduleCrossRegionCopyRule)
	in.DeepCopyInto(out)
	return out
}
