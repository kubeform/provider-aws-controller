...
var configurationrecorderstatusForceNewList = map[string]bool{}
...
func (r *ConfigurationRecorderStatus) ValidateUpdate(old runtime.Object) error {
	...
	res := old.(*ConfigurationRecorderStatus)
	...
	for key, _ := range configurationrecorderstatusForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`configurationrecorderstatus "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
