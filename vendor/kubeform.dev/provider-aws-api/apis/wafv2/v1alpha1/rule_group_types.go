...
type RuleGroupSpecRuleActionAllowCustomRequestHandling struct {
	// +kubebuilder:validation:MinItems=1
	InsertHeader []RuleGroupSpecRuleActionAllowCustomRequestHandlingInsertHeader `json:"insertHeader" tf:"insert_header"`
}

type RuleGroupSpecRuleActionAllow struct {
	// +optional
	CustomRequestHandling *RuleGroupSpecRuleActionAllowCustomRequestHandling `json:"customRequestHandling,omitempty" tf:"custom_request_handling"`
}

type RuleGroupSpecRuleActionBlockCustomResponseResponseHeader struct {
	Name  *string `json:"name" tf:"name"`
	Value *string `json:"value" tf:"value"`
}
...
type RuleGroupSpecRuleActionBlock struct {
	// +optional
	CustomResponse *RuleGroupSpecRuleActionBlockCustomResponse `json:"customResponse,omitempty" tf:"custom_response"`
}

type RuleGroupSpecRuleActionCountCustomRequestHandlingInsertHeader struct {
	Name  *string `json:"name" tf:"name"`
	Value *string `json:"value" tf:"value"`
}

type RuleGroupSpecRuleActionCountCustomRequestHandling struct {
	// +kubebuilder:validation:MinItems=1
	InsertHeader []RuleGroupSpecRuleActionCountCustomRequestHandlingInsertHeader `json:"insertHeader" tf:"insert_header"`
}

type RuleGroupSpecRuleActionCount struct {
	// +optional
	CustomRequestHandling *RuleGroupSpecRuleActionCountCustomRequestHandling `json:"customRequestHandling,omitempty" tf:"custom_request_handling"`
}
