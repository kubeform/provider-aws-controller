...
type ReplicaExternalKey struct {
	...
	Spec              ReplicaExternalKeySpec   `json:"spec,omitempty"`
	Status            ReplicaExternalKeyStatus `json:"status,omitempty"`
}

type ReplicaExternalKeySpec struct {
	State *ReplicaExternalKeySpecResource `json:"state,omitempty" tf:"-"`

	Resource ReplicaExternalKeySpecResource `json:"resource" tf:"resource"`
...
type ReplicaExternalKeySpecResource struct {
...
type ReplicaExternalKeyList struct {
	...
	// Items is a list of ReplicaExternalKey CRD objects
	Items []ReplicaExternalKey `json:"items,omitempty"`
}
