...
type Discoverer struct {
	...
	Spec              DiscovererSpec   `json:"spec,omitempty"`
...
type DiscovererSpecResource struct {
...
// DiscovererList is a list of Discoverers
type DiscovererList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of Discoverer CRD objects
	Items []Discoverer `json:"items,omitempty"`
}
