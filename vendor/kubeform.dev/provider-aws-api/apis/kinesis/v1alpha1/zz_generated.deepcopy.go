...
func (in *AnalyticsApplicationSpec) DeepCopyInto(out *AnalyticsApplicationSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(AnalyticsApplicationSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *FirehoseDeliveryStreamSpec) DeepCopyInto(out *FirehoseDeliveryStreamSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FirehoseDeliveryStreamSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *FirehoseDeliveryStreamSpecExtendedS3Configuration) DeepCopyInto(out *FirehoseDeliveryStreamSpecExtendedS3Configuration) {
	*out = *in
	...
	if in.DynamicPartitioningConfiguration != nil {
		...
		*out = new(FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration) DeepCopyInto(out *FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
func (in *FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration) DeepCopy() *FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration {
	if in == nil {
		return nil
	}
	out := new(FirehoseDeliveryStreamSpecExtendedS3ConfigurationDynamicPartitioningConfiguration)
...
func (in *StreamConsumerSpec) DeepCopyInto(out *StreamConsumerSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(StreamConsumerSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *StreamSpecResource) DeepCopyInto(out *StreamSpecResource) {
	*out = *in
	...
	if in.StreamModeDetails != nil {
		...
		*out = new(StreamSpecStreamModeDetails)
		(*in).DeepCopyInto(*out)
	}
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamSpecStreamModeDetails) DeepCopyInto(out *StreamSpecStreamModeDetails) {
	*out = *in
...
func (in *StreamSpecStreamModeDetails) DeepCopy() *StreamSpecStreamModeDetails {
	if in == nil {
		return nil
	}
	out := new(StreamSpecStreamModeDetails)
...
func (in *VideoStreamSpec) DeepCopyInto(out *VideoStreamSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(VideoStreamSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
