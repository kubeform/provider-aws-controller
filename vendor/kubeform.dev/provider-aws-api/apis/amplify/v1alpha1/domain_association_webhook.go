...
var domainassociationForceNewList = map[string]bool{
	"/app_id":      true,
	"/domain_name": true,
}
...
func (r *DomainAssociation) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range domainassociationForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`domainassociation "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
