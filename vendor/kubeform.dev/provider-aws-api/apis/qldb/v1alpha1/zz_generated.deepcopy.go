...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LedgerSpecResource) DeepCopyInto(out *LedgerSpecResource) {
	*out = *in
	if in.Arn != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LedgerSpecResource.
func (in *LedgerSpecResource) DeepCopy() *LedgerSpecResource {
	if in == nil {
		return nil
	}
	out := new(LedgerSpecResource)
