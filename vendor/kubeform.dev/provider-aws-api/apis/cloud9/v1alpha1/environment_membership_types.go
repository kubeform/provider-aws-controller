...
type EnvironmentMembership struct {
	...
	Spec              EnvironmentMembershipSpec   `json:"spec,omitempty"`
	Status            EnvironmentMembershipStatus `json:"status,omitempty"`
}

type EnvironmentMembershipSpec struct {
	State *EnvironmentMembershipSpecResource `json:"state,omitempty" tf:"-"`

	Resource EnvironmentMembershipSpecResource `json:"resource" tf:"resource"`
...
type EnvironmentMembershipSpecResource struct {
...
type EnvironmentMembershipList struct {
	...
	// Items is a list of EnvironmentMembership CRD objects
	Items []EnvironmentMembership `json:"items,omitempty"`
}
