...
type ProtectionGroup struct {
	...
	Spec              ProtectionGroupSpec   `json:"spec,omitempty"`
	Status            ProtectionGroupStatus `json:"status,omitempty"`
}

type ProtectionGroupSpec struct {
	State *ProtectionGroupSpecResource `json:"state,omitempty" tf:"-"`

	Resource ProtectionGroupSpecResource `json:"resource" tf:"resource"`
...
type ProtectionGroupSpecResource struct {
	...
	// +optional
	ProtectionGroupArn *string `json:"protectionGroupArn,omitempty" tf:"protection_group_arn"`
...
type ProtectionGroupList struct {
	...
	// Items is a list of ProtectionGroup CRD objects
