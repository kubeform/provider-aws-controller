...
func (in *PrincipalAssociationSpec) DeepCopyInto(out *PrincipalAssociationSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		...
		*out = new(PrincipalAssociationSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ResourceAssociationSpec) DeepCopyInto(out *ResourceAssociationSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ResourceAssociationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ResourceShareAccepterSpec) DeepCopyInto(out *ResourceShareAccepterSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ResourceShareAccepterSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ResourceShareSpec) DeepCopyInto(out *ResourceShareSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(ResourceShareSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
