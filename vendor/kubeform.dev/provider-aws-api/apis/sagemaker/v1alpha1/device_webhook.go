...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-sagemaker-aws-kubeform-com-v1alpha1-device,mutating=false,failurePolicy=fail,groups=sagemaker.aws.kubeform.com,resources=devices,versions=v1alpha1,name=device.sagemaker.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
