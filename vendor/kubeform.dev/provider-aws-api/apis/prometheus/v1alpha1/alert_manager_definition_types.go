...
type AlertManagerDefinitionSpec struct {
	State *AlertManagerDefinitionSpecResource `json:"state,omitempty" tf:"-"`

	Resource AlertManagerDefinitionSpecResource `json:"resource" tf:"resource"`
...
type AlertManagerDefinitionSpecResource struct {
...
type AlertManagerDefinitionList struct {
	...
	// Items is a list of AlertManagerDefinition CRD objects
	Items []AlertManagerDefinition `json:"items,omitempty"`
}
