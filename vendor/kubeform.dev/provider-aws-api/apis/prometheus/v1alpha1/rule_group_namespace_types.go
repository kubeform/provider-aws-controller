...
type RuleGroupNamespace struct {
	...
	Spec              RuleGroupNamespaceSpec   `json:"spec,omitempty"`
	Status            RuleGroupNamespaceStatus `json:"status,omitempty"`
}

type RuleGroupNamespaceSpec struct {
	State *RuleGroupNamespaceSpecResource `json:"state,omitempty" tf:"-"`

	Resource RuleGroupNamespaceSpecResource `json:"resource" tf:"resource"`
...
type RuleGroupNamespaceSpecResource struct {
...
type RuleGroupNamespaceList struct {
	...
	// Items is a list of RuleGroupNamespace CRD objects
	Items []RuleGroupNamespace `json:"items,omitempty"`
}
