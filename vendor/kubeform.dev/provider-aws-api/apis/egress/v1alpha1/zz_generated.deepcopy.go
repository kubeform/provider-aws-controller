...
func (in *OnlyInternetGatewaySpec) DeepCopyInto(out *OnlyInternetGatewaySpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(OnlyInternetGatewaySpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OnlyInternetGatewaySpecResource) DeepCopyInto(out *OnlyInternetGatewaySpecResource) {
	*out = *in
	if in.Tags != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OnlyInternetGatewaySpecResource.
func (in *OnlyInternetGatewaySpecResource) DeepCopy() *OnlyInternetGatewaySpecResource {
	if in == nil {
		return nil
	}
	out := new(OnlyInternetGatewaySpecResource)
