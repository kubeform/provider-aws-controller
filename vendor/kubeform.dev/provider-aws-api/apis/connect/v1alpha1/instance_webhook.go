...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-connect-aws-kubeform-com-v1alpha1-instance,mutating=false,failurePolicy=fail,groups=connect.aws.kubeform.com,resources=instances,versions=v1alpha1,name=instance.connect.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Instance{}

var instanceForceNewList = map[string]bool{
	"/directory_id":             true,
	"/identity_management_type": true,
	"/instance_alias":           true,
}
