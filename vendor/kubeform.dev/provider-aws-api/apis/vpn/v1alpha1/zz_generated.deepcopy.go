...
func (in *ConnectionRouteSpec) DeepCopyInto(out *ConnectionRouteSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		...
		*out = new(ConnectionRouteSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectionRouteSpecResource) DeepCopyInto(out *ConnectionRouteSpecResource) {
	*out = *in
...
func (in *ConnectionRouteSpecResource) DeepCopy() *ConnectionRouteSpecResource {
	if in == nil {
		return nil
	}
	out := new(ConnectionRouteSpecResource)
...
func (in *GatewayAttachmentSpec) DeepCopyInto(out *GatewayAttachmentSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(GatewayAttachmentSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *GatewayRoutePropagationSpec) DeepCopyInto(out *GatewayRoutePropagationSpec) {
	*out = *in
	if in.KubeformOutput != nil {
		in, out := &in.KubeformOutput, &out.KubeformOutput
		*out = new(GatewayRoutePropagationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayRoutePropagationSpecResource) DeepCopyInto(out *GatewayRoutePropagationSpecResource) {
	*out = *in
...
func (in *GatewayRoutePropagationSpecResource) DeepCopy() *GatewayRoutePropagationSpecResource {
	if in == nil {
		return nil
	}
	out := new(GatewayRoutePropagationSpecResource)
