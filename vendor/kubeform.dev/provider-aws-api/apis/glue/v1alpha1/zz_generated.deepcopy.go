...
func (in *CatalogDatabaseSpec) DeepCopyInto(out *CatalogDatabaseSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(CatalogDatabaseSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogDatabaseSpecCreateTableDefaultPermission) DeepCopyInto(out *CatalogDatabaseSpecCreateTableDefaultPermission) {
	*out = *in
	...
	if in.Principal != nil {
		...
		*out = new(CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *CatalogDatabaseSpecCreateTableDefaultPermission) DeepCopy() *CatalogDatabaseSpecCreateTableDefaultPermission {
	if in == nil {
		return nil
	}
	out := new(CatalogDatabaseSpecCreateTableDefaultPermission)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal) DeepCopyInto(out *CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal) {
	*out = *in
...
func (in *CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal) DeepCopy() *CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal {
	if in == nil {
		return nil
	}
	out := new(CatalogDatabaseSpecCreateTableDefaultPermissionPrincipal)
...
func (in *CatalogDatabaseSpecResource) DeepCopyInto(out *CatalogDatabaseSpecResource) {
	*out = *in
	...
	if in.CreateTableDefaultPermission != nil {
		...
		*out = make([]CatalogDatabaseSpecCreateTableDefaultPermission, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetDatabase != nil {
		...
		*out = new(CatalogDatabaseSpecTargetDatabase)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *CatalogTableSpec) DeepCopyInto(out *CatalogTableSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(CatalogTableSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *CatalogTableSpecResource) DeepCopyInto(out *CatalogTableSpecResource) {
	*out = *in
	...
	if in.TargetTable != nil {
		...
		*out = new(CatalogTableSpecTargetTable)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ClassifierSpec) DeepCopyInto(out *ClassifierSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ClassifierSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *CrawlerSpecDeltaTarget) DeepCopy() *CrawlerSpecDeltaTarget {
	if in == nil {
		return nil
	}
	out := new(CrawlerSpecDeltaTarget)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CrawlerSpecResource) DeepCopyInto(out *CrawlerSpecResource) {
	*out = *in
	...
	if in.DeltaTarget != nil {
		...
		*out = make([]CrawlerSpecDeltaTarget, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DataCatalogEncryptionSettingsSpec) DeepCopyInto(out *DataCatalogEncryptionSettingsSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DataCatalogEncryptionSettingsSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *DevEndpointSpec) DeepCopyInto(out *DevEndpointSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DevEndpointSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *MlTransformSpec) DeepCopyInto(out *MlTransformSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(MlTransformSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *PartitionIndexSpec) DeepCopyInto(out *PartitionIndexSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(PartitionIndexSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *PartitionIndexSpec) DeepCopy() *PartitionIndexSpec {
	...
	out := new(PartitionIndexSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionIndexSpecPartitionIndex) DeepCopyInto(out *PartitionIndexSpecPartitionIndex) {
	*out = *in
	if in.IndexName != nil {
		in, out := &in.IndexName, &out.IndexName
		*out = new(string)
...
func (in *PartitionIndexSpecPartitionIndex) DeepCopy() *PartitionIndexSpecPartitionIndex {
	if in == nil {
		return nil
	}
	out := new(PartitionIndexSpecPartitionIndex)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionIndexSpecResource) DeepCopyInto(out *PartitionIndexSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *PartitionIndexSpecResource) DeepCopy() *PartitionIndexSpecResource {
	if in == nil {
		return nil
	}
	out := new(PartitionIndexSpecResource)
...
func (in *PartitionIndexStatus) DeepCopy() *PartitionIndexStatus {
	if in == nil {
		return nil
	}
	out := new(PartitionIndexStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecurityConfigurationSpec) DeepCopyInto(out *SecurityConfigurationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(SecurityConfigurationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerSpecEventBatchingCondition) DeepCopyInto(out *TriggerSpecEventBatchingCondition) {
	*out = *in
	if in.BatchSize != nil {
...
func (in *TriggerSpecEventBatchingCondition) DeepCopy() *TriggerSpecEventBatchingCondition {
	if in == nil {
		return nil
	}
	out := new(TriggerSpecEventBatchingCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TriggerSpecResource) DeepCopyInto(out *TriggerSpecResource) {
	*out = *in
	...
	if in.EventBatchingCondition != nil {
		...
		*out = make([]TriggerSpecEventBatchingCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *UserDefinedFunctionSpec) DeepCopyInto(out *UserDefinedFunctionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(UserDefinedFunctionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
