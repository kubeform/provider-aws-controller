...
func (in *DeploymentConfigSpec) DeepCopyInto(out *DeploymentConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DeploymentConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentConfigSpecResource) DeepCopyInto(out *DeploymentConfigSpecResource) {
	*out = *in
	if in.ComputePlatform != nil {
		in, out := &in.ComputePlatform, &out.ComputePlatform
		*out = new(string)
...
func (in *DeploymentConfigSpecResource) DeepCopy() *DeploymentConfigSpecResource {
	if in == nil {
		return nil
	}
	out := new(DeploymentConfigSpecResource)
...
func (in *DeploymentGroupSpec) DeepCopyInto(out *DeploymentGroupSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DeploymentGroupSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentGroupSpecResource) DeepCopyInto(out *DeploymentGroupSpecResource) {
	*out = *in
...
func (in *DeploymentGroupSpecResource) DeepCopy() *DeploymentGroupSpecResource {
	if in == nil {
		return nil
	}
	out := new(DeploymentGroupSpecResource)
