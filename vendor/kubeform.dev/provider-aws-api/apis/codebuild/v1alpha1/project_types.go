...
type ProjectSpecBuildBatchConfigRestrictions struct {
	// +optional
...
type ProjectSpecBuildBatchConfig struct {
	// +optional
	CombineArtifacts *bool `json:"combineArtifacts,omitempty" tf:"combine_artifacts"`
	// +optional
	Restrictions *ProjectSpecBuildBatchConfigRestrictions `json:"restrictions,omitempty" tf:"restrictions"`
...
type ProjectSpecFileSystemLocations struct {
	// +optional
...
type ProjectSpecResource struct {
	...
	// +optional
	BuildBatchConfig *ProjectSpecBuildBatchConfig `json:"buildBatchConfig,omitempty" tf:"build_batch_config"`
	// +optional
	...
	// +optional
	FileSystemLocations []ProjectSpecFileSystemLocations `json:"fileSystemLocations,omitempty" tf:"file_system_locations"`
	// +optional
