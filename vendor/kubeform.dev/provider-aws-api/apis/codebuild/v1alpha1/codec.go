...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfig{}).Type1()):                    ProjectSpecBuildBatchConfigCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfigRestrictions{}).Type1()):        ProjectSpecBuildBatchConfigRestrictionsCodec{},
		...
		jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSecondarySourcesBuildStatusConfig{}).Type1()):   ProjectSpecSecondarySourcesBuildStatusConfigCodec{},
		...
		jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSourceBuildStatusConfig{}).Type1()):             ProjectSpecSourceBuildStatusConfigCodec{},
...
func (ProjectSpecBuildBatchConfigCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ProjectSpecBuildBatchConfig)(ptr) == nil
}

func (ProjectSpecBuildBatchConfigCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ProjectSpecBuildBatchConfig)(ptr)
	var objs []ProjectSpecBuildBatchConfig
	if obj != nil {
		objs = []ProjectSpecBuildBatchConfig{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfig{}).Type1())),
	}.Froze()
...
func (ProjectSpecBuildBatchConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ProjectSpecBuildBatchConfig)(ptr) = ProjectSpecBuildBatchConfig{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfig{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ProjectSpecBuildBatchConfig)(ptr) = objs[0]
			} else {
				*(*ProjectSpecBuildBatchConfig)(ptr) = ProjectSpecBuildBatchConfig{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecBuildBatchConfig
			...
			*(*ProjectSpecBuildBatchConfig)(ptr) = obj
		} else {
			*(*ProjectSpecBuildBatchConfig)(ptr) = ProjectSpecBuildBatchConfig{}
		}
	default:
		iter.ReportError("decode ProjectSpecBuildBatchConfig", "unexpected JSON type")
	}
}
...
func (ProjectSpecBuildBatchConfigRestrictionsCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ProjectSpecBuildBatchConfigRestrictions)(ptr) == nil
}

func (ProjectSpecBuildBatchConfigRestrictionsCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ProjectSpecBuildBatchConfigRestrictions)(ptr)
	var objs []ProjectSpecBuildBatchConfigRestrictions
	if obj != nil {
		objs = []ProjectSpecBuildBatchConfigRestrictions{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfigRestrictions{}).Type1())),
	}.Froze()
...
func (ProjectSpecBuildBatchConfigRestrictionsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ProjectSpecBuildBatchConfigRestrictions)(ptr) = ProjectSpecBuildBatchConfigRestrictions{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecBuildBatchConfigRestrictions{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ProjectSpecBuildBatchConfigRestrictions)(ptr) = objs[0]
			} else {
				*(*ProjectSpecBuildBatchConfigRestrictions)(ptr) = ProjectSpecBuildBatchConfigRestrictions{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecBuildBatchConfigRestrictions
			...
			*(*ProjectSpecBuildBatchConfigRestrictions)(ptr) = obj
		} else {
			*(*ProjectSpecBuildBatchConfigRestrictions)(ptr) = ProjectSpecBuildBatchConfigRestrictions{}
		}
	default:
		iter.ReportError("decode ProjectSpecBuildBatchConfigRestrictions", "unexpected JSON type")
	}
}
...
func (ProjectSpecEnvironmentCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecEnvironment
			...
			*(*ProjectSpecEnvironment)(ptr) = obj
		} else {
			*(*ProjectSpecEnvironment)(ptr) = ProjectSpecEnvironment{}
		}
	default:
...
func (ProjectSpecEnvironmentRegistryCredentialCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecEnvironmentRegistryCredential
			...
			*(*ProjectSpecEnvironmentRegistryCredential)(ptr) = obj
		} else {
			*(*ProjectSpecEnvironmentRegistryCredential)(ptr) = ProjectSpecEnvironmentRegistryCredential{}
		}
	default:
...
func (ProjectSpecLogsConfigCloudwatchLogsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecLogsConfigCloudwatchLogs
			...
			*(*ProjectSpecLogsConfigCloudwatchLogs)(ptr) = obj
		} else {
			*(*ProjectSpecLogsConfigCloudwatchLogs)(ptr) = ProjectSpecLogsConfigCloudwatchLogs{}
		}
	default:
...
func (ProjectSpecLogsConfigS3LogsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecLogsConfigS3Logs
			...
			*(*ProjectSpecLogsConfigS3Logs)(ptr) = obj
		} else {
			*(*ProjectSpecLogsConfigS3Logs)(ptr) = ProjectSpecLogsConfigS3Logs{}
		}
	default:
...
func (ProjectSpecSecondarySourcesAuthCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecSecondarySourcesAuth
			...
			*(*ProjectSpecSecondarySourcesAuth)(ptr) = obj
		} else {
			*(*ProjectSpecSecondarySourcesAuth)(ptr) = ProjectSpecSecondarySourcesAuth{}
		}
	default:
...
func (ProjectSpecSecondarySourcesBuildStatusConfigCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) == nil
}

func (ProjectSpecSecondarySourcesBuildStatusConfigCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr)
	var objs []ProjectSpecSecondarySourcesBuildStatusConfig
	if obj != nil {
		objs = []ProjectSpecSecondarySourcesBuildStatusConfig{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSecondarySourcesBuildStatusConfig{}).Type1())),
	}.Froze()
...
func (ProjectSpecSecondarySourcesBuildStatusConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) = ProjectSpecSecondarySourcesBuildStatusConfig{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSecondarySourcesBuildStatusConfig{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) = objs[0]
			} else {
				*(*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) = ProjectSpecSecondarySourcesBuildStatusConfig{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecSecondarySourcesBuildStatusConfig
			...
			*(*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) = obj
		} else {
			*(*ProjectSpecSecondarySourcesBuildStatusConfig)(ptr) = ProjectSpecSecondarySourcesBuildStatusConfig{}
		}
	default:
		iter.ReportError("decode ProjectSpecSecondarySourcesBuildStatusConfig", "unexpected JSON type")
	}
}
...
func (ProjectSpecSecondarySourcesGitSubmodulesConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecSecondarySourcesGitSubmodulesConfig
			...
			*(*ProjectSpecSecondarySourcesGitSubmodulesConfig)(ptr) = obj
		} else {
			*(*ProjectSpecSecondarySourcesGitSubmodulesConfig)(ptr) = ProjectSpecSecondarySourcesGitSubmodulesConfig{}
		}
	default:
...
func (ProjectSpecSourceBuildStatusConfigCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ProjectSpecSourceBuildStatusConfig)(ptr) == nil
}

func (ProjectSpecSourceBuildStatusConfigCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ProjectSpecSourceBuildStatusConfig)(ptr)
	var objs []ProjectSpecSourceBuildStatusConfig
	if obj != nil {
		objs = []ProjectSpecSourceBuildStatusConfig{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSourceBuildStatusConfig{}).Type1())),
	}.Froze()
...
func (ProjectSpecSourceBuildStatusConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ProjectSpecSourceBuildStatusConfig)(ptr) = ProjectSpecSourceBuildStatusConfig{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ProjectSpecSourceBuildStatusConfig{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ProjectSpecSourceBuildStatusConfig)(ptr) = objs[0]
			} else {
				*(*ProjectSpecSourceBuildStatusConfig)(ptr) = ProjectSpecSourceBuildStatusConfig{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecSourceBuildStatusConfig
			...
			*(*ProjectSpecSourceBuildStatusConfig)(ptr) = obj
		} else {
			*(*ProjectSpecSourceBuildStatusConfig)(ptr) = ProjectSpecSourceBuildStatusConfig{}
		}
	default:
		iter.ReportError("decode ProjectSpecSourceBuildStatusConfig", "unexpected JSON type")
	}
}
...
func (ProjectSpecSourceGitSubmodulesConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ProjectSpecSourceGitSubmodulesConfig
			...
			*(*ProjectSpecSourceGitSubmodulesConfig)(ptr) = obj
		} else {
			*(*ProjectSpecSourceGitSubmodulesConfig)(ptr) = ProjectSpecSourceGitSubmodulesConfig{}
		}
	default:
...
func (ReportGroupSpecExportConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ReportGroupSpecExportConfig
			...
			*(*ReportGroupSpecExportConfig)(ptr) = obj
		} else {
			*(*ReportGroupSpecExportConfig)(ptr) = ReportGroupSpecExportConfig{}
		}
	default:
...
func (ReportGroupSpecExportConfigS3DestinationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ReportGroupSpecExportConfigS3Destination
			...
			*(*ReportGroupSpecExportConfigS3Destination)(ptr) = obj
		} else {
			*(*ReportGroupSpecExportConfigS3Destination)(ptr) = ReportGroupSpecExportConfigS3Destination{}
		}
	default:
