...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-codebuild-aws-kubeform-com-v1alpha1-resourcepolicy,mutating=false,failurePolicy=fail,groups=codebuild.aws.kubeform.com,resources=resourcepolicies,versions=v1alpha1,name=resourcepolicy.codebuild.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
