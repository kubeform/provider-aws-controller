...
func (in *ApigatewayResourceSpec) DeepCopyInto(out *ApigatewayResourceSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ApigatewayResourceSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *BasePathMappingSpec) DeepCopyInto(out *BasePathMappingSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(BasePathMappingSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ClientCertificateSpec) DeepCopyInto(out *ClientCertificateSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ClientCertificateSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *DocumentationPartSpec) DeepCopyInto(out *DocumentationPartSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DocumentationPartSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *DocumentationVersionSpec) DeepCopyInto(out *DocumentationVersionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(DocumentationVersionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *GatewayResponseSpec) DeepCopyInto(out *GatewayResponseSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(GatewayResponseSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *IntegrationResponseSpec) DeepCopyInto(out *IntegrationResponseSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(IntegrationResponseSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *MethodResponseSpec) DeepCopyInto(out *MethodResponseSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(MethodResponseSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *MethodSettingsSpec) DeepCopyInto(out *MethodSettingsSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(MethodSettingsSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *RequestValidatorSpec) DeepCopyInto(out *RequestValidatorSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(RequestValidatorSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *RestAPIPolicySpec) DeepCopyInto(out *RestAPIPolicySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(RestAPIPolicySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *UsagePlanKeySpec) DeepCopyInto(out *UsagePlanKeySpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(UsagePlanKeySpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *UsagePlanSpecApiStages) DeepCopyInto(out *UsagePlanSpecApiStages) {
	*out = *in
	...
	if in.Throttle != nil {
		...
		*out = make([]UsagePlanSpecApiStagesThrottle, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsagePlanSpecApiStagesThrottle) DeepCopyInto(out *UsagePlanSpecApiStagesThrottle) {
	*out = *in
	if in.BurstLimit != nil {
		in, out := &in.BurstLimit, &out.BurstLimit
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsagePlanSpecApiStagesThrottle.
func (in *UsagePlanSpecApiStagesThrottle) DeepCopy() *UsagePlanSpecApiStagesThrottle {
	if in == nil {
		return nil
	}
	out := new(UsagePlanSpecApiStagesThrottle)
	in.DeepCopyInto(out)
	return out
}
