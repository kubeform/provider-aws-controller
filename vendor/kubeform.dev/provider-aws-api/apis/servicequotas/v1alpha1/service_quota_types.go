...
type ServiceQuotaSpec struct {
	KubeformOutput *ServiceQuotaSpecResource `json:"kubeformOutput,omitempty" tf:"-"`

	Resource ServiceQuotaSpecResource `json:"resource" tf:"resource"`
...
type ServiceQuotaSpecResource struct {
