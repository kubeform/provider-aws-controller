...
func (in *CodeSigningConfigSpec) DeepCopyInto(out *CodeSigningConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(CodeSigningConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *EventSourceMappingSpec) DeepCopyInto(out *EventSourceMappingSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(EventSourceMappingSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventSourceMappingSpecFilterCriteria) DeepCopyInto(out *EventSourceMappingSpecFilterCriteria) {
	*out = *in
	if in.Filter != nil {
		in, out := &in.Filter, &out.Filter
		*out = make([]EventSourceMappingSpecFilterCriteriaFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EventSourceMappingSpecFilterCriteria) DeepCopy() *EventSourceMappingSpecFilterCriteria {
	if in == nil {
		return nil
	}
	out := new(EventSourceMappingSpecFilterCriteria)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventSourceMappingSpecFilterCriteriaFilter) DeepCopyInto(out *EventSourceMappingSpecFilterCriteriaFilter) {
	*out = *in
	if in.Pattern != nil {
...
func (in *EventSourceMappingSpecFilterCriteriaFilter) DeepCopy() *EventSourceMappingSpecFilterCriteriaFilter {
	if in == nil {
		return nil
	}
	out := new(EventSourceMappingSpecFilterCriteriaFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EventSourceMappingSpecResource) DeepCopyInto(out *EventSourceMappingSpecResource) {
	*out = *in
	...
	if in.SelfManagedEventSource != nil {
		...
		*out = new(EventSourceMappingSpecSelfManagedEventSource)
		(*in).DeepCopyInto(*out)
	}
	if in.SourceAccessConfiguration != nil {
		in, out := &in.SourceAccessConfiguration, &out.SourceAccessConfiguration
		*out = make([]EventSourceMappingSpecSourceAccessConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EventSourceMappingSpecSourceAccessConfiguration) DeepCopy() *EventSourceMappingSpecSourceAccessConfiguration {
	...
	out := new(EventSourceMappingSpecSourceAccessConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FunctionEventInvokeConfigSpec) DeepCopyInto(out *FunctionEventInvokeConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(FunctionEventInvokeConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *InvocationSpec) DeepCopyInto(out *InvocationSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(InvocationSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *InvocationSpecResource) DeepCopy() *InvocationSpecResource {
	if in == nil {
		return nil
	}
	out := new(InvocationSpecResource)
...
func (in *LayerVersionPermissionSpec) DeepCopyInto(out *LayerVersionPermissionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(LayerVersionPermissionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LayerVersionPermissionSpecResource) DeepCopyInto(out *LayerVersionPermissionSpecResource) {
	*out = *in
	if in.Action != nil {
...
func (in *LayerVersionPermissionSpecResource) DeepCopy() *LayerVersionPermissionSpecResource {
	if in == nil {
		return nil
	}
	out := new(LayerVersionPermissionSpecResource)
...
func (in *LayerVersionSpec) DeepCopyInto(out *LayerVersionSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(LayerVersionSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *ProvisionedConcurrencyConfigSpec) DeepCopyInto(out *ProvisionedConcurrencyConfigSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(ProvisionedConcurrencyConfigSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
