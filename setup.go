...
import (
	...
	aws "github.com/hashicorp/terraform-provider-aws/aws"
	...
	controllersaccount "kubeform.dev/provider-aws-controller/controllers/account"
	...
	controllersappconfig "kubeform.dev/provider-aws-controller/controllers/appconfig"
	...
	controllersappstream "kubeform.dev/provider-aws-controller/controllers/appstream"
	...
	controllerschime "kubeform.dev/provider-aws-controller/controllers/chime"
	controllerscloud9 "kubeform.dev/provider-aws-controller/controllers/cloud9"
	controllerscloudcontrolapi "kubeform.dev/provider-aws-controller/controllers/cloudcontrolapi"
	...
	controllerscloudsearch "kubeform.dev/provider-aws-controller/controllers/cloudsearch"
	...
	controllersconnect "kubeform.dev/provider-aws-controller/controllers/connect"
	...
	controllersdataexchange "kubeform.dev/provider-aws-controller/controllers/dataexchange"
	...
	controllersdetective "kubeform.dev/provider-aws-controller/controllers/detective"
	...
	controllersgrafana "kubeform.dev/provider-aws-controller/controllers/grafana"
	...
	controllersmemorydb "kubeform.dev/provider-aws-controller/controllers/memorydb"
	...
	controllersmskconnect "kubeform.dev/provider-aws-controller/controllers/mskconnect"
	...
	controllersroute53domains "kubeform.dev/provider-aws-controller/controllers/route53domains"
	controllersroute53recoverycontrolconfig "kubeform.dev/provider-aws-controller/controllers/route53recoverycontrolconfig"
	controllersroute53recoveryreadiness "kubeform.dev/provider-aws-controller/controllers/route53recoveryreadiness"
...
func SetupManager(ctx context.Context, mgr manager.Manager, gvk schema.GroupVersionKind, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersaccessanalyzer.AnalyzerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_accessanalyzer_analyzer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersaccount.AlternateContactReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("AlternateContact"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_account_alternate_contact"],
			TypeName: "aws_account_alternate_contact",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "AlternateContact")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersacm.CertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_acm_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersacm.CertificateValidationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_acm_certificate_validation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersacmpca.CertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_acmpca_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersacmpca.CertificateAuthorityReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_acmpca_certificate_authority"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersacmpca.CertificateAuthorityCertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_acmpca_certificate_authority_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.AlbReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb"],
			TypeName: "aws_alb",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.ListenerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb_listener"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.ListenerCertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb_listener_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.ListenerRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb_listener_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.TargetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb_target_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersalb.TargetGroupAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_alb_target_group_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersami.AmiReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ami"],
			TypeName: "aws_ami",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersami.CopyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ami_copy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersami.FromInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ami_from_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersami.LaunchPermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ami_launch_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersamplify.AppReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_amplify_app"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersamplify.BackendEnvironmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_amplify_backend_environment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersamplify.BranchReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_amplify_branch"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersamplify.DomainAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_amplify_domain_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersamplify.WebhookReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_amplify_webhook"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.AccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.ApiKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_api_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.AuthorizerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_authorizer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.BasePathMappingReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_base_path_mapping"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.ClientCertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_client_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.DeploymentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_deployment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.DocumentationPartReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_documentation_part"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.DocumentationVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_documentation_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.DomainNameReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_domain_name"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.GatewayResponseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_gateway_response"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.IntegrationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_integration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.IntegrationResponseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_integration_response"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.MethodReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_method"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.MethodResponseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_method_response"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.MethodSettingsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_method_settings"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.ModelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_model"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.RequestValidatorReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_request_validator"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.ApigatewayResourceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_resource"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.RestAPIReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_rest_api"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.RestAPIPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_rest_api_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.StageReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_stage"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.UsagePlanReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_usage_plan"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.UsagePlanKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_usage_plan_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigateway.VpcLinkReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_api_gateway_vpc_link"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.ApiReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_api"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.ApiMappingReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_api_mapping"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.AuthorizerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_authorizer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.DeploymentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_deployment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.DomainNameReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_domain_name"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.IntegrationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_integration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.IntegrationResponseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_integration_response"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.ModelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_model"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.RouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.RouteResponseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_route_response"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.StageReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_stage"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapigatewayv2.VpcLinkReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apigatewayv2_vpc_link"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapp.CookieStickinessPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_app_cookie_stickiness_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappautoscaling.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appautoscaling_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappautoscaling.ScheduledActionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appautoscaling_scheduled_action"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappautoscaling.TargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appautoscaling_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappconfig.ApplicationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Application"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappconfig.ConfigurationProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ConfigurationProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_configuration_profile"],
			TypeName: "aws_appconfig_configuration_profile",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ConfigurationProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appconfig.aws.kubeform.com",
		...
		if err := (&controllersappconfig.DeploymentReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Deployment"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_deployment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappconfig.DeploymentStrategyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DeploymentStrategy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_deployment_strategy"],
			TypeName: "aws_appconfig_deployment_strategy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DeploymentStrategy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appconfig.aws.kubeform.com",
		...
		if err := (&controllersappconfig.EnvironmentReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Environment"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_environment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappconfig.HostedConfigurationVersionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("HostedConfigurationVersion"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appconfig_hosted_configuration_version"],
			TypeName: "aws_appconfig_hosted_configuration_version",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "HostedConfigurationVersion")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.GatewayRouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_gateway_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.MeshReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_mesh"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.RouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.VirtualGatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_virtual_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.VirtualNodeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_virtual_node"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.VirtualRouterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_virtual_router"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappmesh.VirtualServiceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appmesh_virtual_service"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapprunner.AutoScalingConfigurationVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apprunner_auto_scaling_configuration_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapprunner.ConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apprunner_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapprunner.CustomDomainAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apprunner_custom_domain_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapprunner.ServiceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apprunner_service"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersapprunner.VpcConnectorReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VpcConnector"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_apprunner_vpc_connector"],
			TypeName: "aws_apprunner_vpc_connector",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VpcConnector")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersappstream.DirectoryConfigReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DirectoryConfig"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_directory_config"],
			TypeName: "aws_appstream_directory_config",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DirectoryConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&controllersappstream.FleetReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Fleet"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_fleet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappstream.FleetStackAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FleetStackAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_fleet_stack_association"],
			TypeName: "aws_appstream_fleet_stack_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FleetStackAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&controllersappstream.ImageBuilderReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ImageBuilder"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_image_builder"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappstream.StackReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Stack"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_stack"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappstream.UserReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("User"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappstream.UserStackAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("UserStackAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appstream_user_stack_association"],
			TypeName: "aws_appstream_user_stack_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "UserStackAssociation")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersappsync.ApiCacheReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ApiCache"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_api_cache"],
			TypeName: "aws_appsync_api_cache",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ApiCache")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
		...
		if err := (&controllersappsync.ApiKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_api_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappsync.DatasourceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_datasource"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappsync.DomainNameReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DomainName"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_domain_name"],
	...
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "DomainNameAPIAssociation",
	}:
		if err := (&controllersappsync.DomainNameAPIAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DomainNameAPIAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_domain_name_api_association"],
			TypeName: "aws_appsync_domain_name_api_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DomainNameAPIAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
		...
		if err := (&controllersappsync.FunctionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_function"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappsync.GraphqlAPIReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_graphql_api"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersappsync.ResolverReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_appsync_resolver"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersathena.DatabaseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_athena_database"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersathena.NamedQueryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_athena_named_query"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersathena.WorkgroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_athena_workgroup"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.AttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.GroupTagReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("GroupTag"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_group_tag"],
			TypeName: "aws_autoscaling_group_tag",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "GroupTag")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "autoscaling.aws.kubeform.com",
		...
		if err := (&controllersautoscaling.LifecycleHookReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_lifecycle_hook"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.NotificationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_notification"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscaling.ScheduleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscaling_schedule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersautoscalingplans.ScalingPlanReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_autoscalingplans_scaling_plan"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.FrameworkReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Framework"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_framework"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.GlobalSettingsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_global_settings"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.PlanReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_plan"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.RegionSettingsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_region_settings"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.ReportPlanReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ReportPlan"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_report_plan"],
			TypeName: "aws_backup_report_plan",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ReportPlan")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "backup.aws.kubeform.com",
		...
		if err := (&controllersbackup.SelectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_selection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.VaultReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_vault"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.VaultLockConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VaultLockConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_vault_lock_configuration"],
			TypeName: "aws_backup_vault_lock_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VaultLockConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "backup.aws.kubeform.com",
		...
		if err := (&controllersbackup.VaultNotificationsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_vault_notifications"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbackup.VaultPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_backup_vault_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbatch.ComputeEnvironmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_batch_compute_environment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbatch.JobDefinitionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_batch_job_definition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbatch.JobQueueReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_batch_job_queue"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbatch.SchedulingPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SchedulingPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_batch_scheduling_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbudgets.BudgetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_budgets_budget"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersbudgets.BudgetActionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_budgets_budget_action"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerschime.VoiceConnectorReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnector"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector"],
			TypeName: "aws_chime_voice_connector",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnector")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_group"],
			TypeName: "aws_chime_voice_connector_group",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorLoggingReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorLogging"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_logging"],
			TypeName: "aws_chime_voice_connector_logging",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorLogging")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorOriginationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorOrigination"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_origination"],
			TypeName: "aws_chime_voice_connector_origination",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorOrigination")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorStreamingReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorStreaming"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_streaming"],
			TypeName: "aws_chime_voice_connector_streaming",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorStreaming")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorTerminationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorTermination"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_termination"],
			TypeName: "aws_chime_voice_connector_termination",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorTermination")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&controllerschime.VoiceConnectorTerminationCredentialsReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VoiceConnectorTerminationCredentials"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_chime_voice_connector_termination_credentials"],
			TypeName: "aws_chime_voice_connector_termination_credentials",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VoiceConnectorTerminationCredentials")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloud9.EnvironmentEc2Reconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloud9_environment_ec2"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloud9.EnvironmentMembershipReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("EnvironmentMembership"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloud9_environment_membership"],
			TypeName: "aws_cloud9_environment_membership",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "EnvironmentMembership")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudcontrolapi.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "CloudcontrolapiResource",
	}:
		if err := (&controllerscloudcontrolapi.CloudcontrolapiResourceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("CloudcontrolapiResource"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudcontrolapi_resource"],
			TypeName: "aws_cloudcontrolapi_resource",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "CloudcontrolapiResource")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudformationstack.CloudformationStackReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudformation_stack"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudformationstack.SetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudformation_stack_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudformationstack.SetInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudformation_stack_set_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudformationtype.CloudformationTypeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudformation_type"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.CachePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_cache_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.DistributionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_distribution"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.FieldLevelEncryptionConfigReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FieldLevelEncryptionConfig"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_field_level_encryption_config"],
			TypeName: "aws_cloudfront_field_level_encryption_config",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FieldLevelEncryptionConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
		...
		if err := (&controllerscloudfront.FieldLevelEncryptionProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FieldLevelEncryptionProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_field_level_encryption_profile"],
			TypeName: "aws_cloudfront_field_level_encryption_profile",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FieldLevelEncryptionProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
		...
		if err := (&controllerscloudfront.FunctionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_function"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.KeyGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_key_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.MonitoringSubscriptionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("MonitoringSubscription"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_monitoring_subscription"],
			TypeName: "aws_cloudfront_monitoring_subscription",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "MonitoringSubscription")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
		...
		if err := (&controllerscloudfront.OriginAccessIdentityReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_origin_access_identity"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.OriginRequestPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_origin_request_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.PublicKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_public_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.RealtimeLogConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_realtime_log_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudfront.ResponseHeadersPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ResponseHeadersPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudfront_response_headers_policy"],
			TypeName: "aws_cloudfront_response_headers_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ResponseHeadersPolicy")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudhsmv2.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudhsm_v2_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudhsmv2.HsmReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudhsm_v2_hsm"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudsearch.DomainReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Domain"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudsearch_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudsearch.DomainServiceAccessPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DomainServiceAccessPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudsearch_domain_service_access_policy"],
			TypeName: "aws_cloudsearch_domain_service_access_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DomainServiceAccessPolicy")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudtrail.CloudtrailReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudtrail"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudtrail.EventDataStoreReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("EventDataStore"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudtrail_event_data_store"],
			TypeName: "aws_cloudtrail_event_data_store",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "EventDataStore")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.CompositeAlarmReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_composite_alarm"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.DashboardReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_dashboard"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventAPIDestinationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_api_destination"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventArchiveReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_archive"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventBusReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_bus"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventBusPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_bus_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventPermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.EventTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_event_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogDestinationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_destination"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogDestinationPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_destination_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogMetricFilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_metric_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogResourcePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_resource_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogStreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.LogSubscriptionFilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_log_subscription_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.MetricAlarmReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_metric_alarm"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.MetricStreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_metric_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscloudwatch.QueryDefinitionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cloudwatch_query_definition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodeartifact.DomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codeartifact_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodeartifact.DomainPermissionsPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codeartifact_domain_permissions_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodeartifact.RepositoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codeartifact_repository"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodeartifact.RepositoryPermissionsPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codeartifact_repository_permissions_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodebuild.ProjectReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codebuild_project"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodebuild.ReportGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codebuild_report_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodebuild.ResourcePolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ResourcePolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codebuild_resource_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodebuild.SourceCredentialReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codebuild_source_credential"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodebuild.WebhookReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codebuild_webhook"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodecommit.ApprovalRuleTemplateReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ApprovalRuleTemplate"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codecommit_approval_rule_template"],
			TypeName: "aws_codecommit_approval_rule_template",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ApprovalRuleTemplate")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "codecommit.aws.kubeform.com",
		...
		if err := (&controllerscodecommit.ApprovalRuleTemplateAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ApprovalRuleTemplateAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codecommit_approval_rule_template_association"],
			TypeName: "aws_codecommit_approval_rule_template_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ApprovalRuleTemplateAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "codecommit.aws.kubeform.com",
		...
		if err := (&controllerscodecommit.RepositoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codecommit_repository"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodecommit.TriggerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codecommit_trigger"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodedeploy.AppReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codedeploy_app"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodedeploy.DeploymentConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codedeploy_deployment_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodedeploy.DeploymentGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codedeploy_deployment_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodepipeline.CodepipelineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codepipeline"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodepipeline.WebhookReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codepipeline_webhook"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodestarconnections.ConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codestarconnections_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodestarconnections.HostReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codestarconnections_host"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscodestarnotifications.NotificationRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_codestarnotifications_notification_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.IdentityPoolReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_identity_pool"],
	...
	case schema.GroupVersionKind{
		Group:   "cognito.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "IdentityPoolProviderPrincipalTag",
	}:
		if err := (&controllerscognito.IdentityPoolProviderPrincipalTagReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IdentityPoolProviderPrincipalTag"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_identity_pool_provider_principal_tag"],
			TypeName: "aws_cognito_identity_pool_provider_principal_tag",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IdentityPoolProviderPrincipalTag")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cognito.aws.kubeform.com",
		...
		if err := (&controllerscognito.IdentityPoolRolesAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_identity_pool_roles_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.IdentityProviderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_identity_provider"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.ResourceServerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_resource_server"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("User"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserPoolReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user_pool"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserPoolClientReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user_pool_client"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserPoolDomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user_pool_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscognito.UserPoolUiCustomizationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cognito_user_pool_ui_customization"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.AggregateAuthorizationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_aggregate_authorization"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.ConfigRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_config_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.ConfigurationAggregatorReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_configuration_aggregator"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.ConfigurationRecorderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_configuration_recorder"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.ConfigurationRecorderStatusReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_configuration_recorder_status"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.ConformancePackReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_conformance_pack"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.DeliveryChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_delivery_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.OrganizationConformancePackReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OrganizationConformancePack"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_organization_conformance_pack"],
			TypeName: "aws_config_organization_conformance_pack",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OrganizationConformancePack")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "config.aws.kubeform.com",
		...
		if err := (&controllersconfig.OrganizationCustomRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_organization_custom_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.OrganizationManagedRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_organization_managed_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconfig.RemediationConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_config_remediation_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconnect.BotAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BotAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_bot_association"],
			TypeName: "aws_connect_bot_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BotAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.ContactFlowReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ContactFlow"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_contact_flow"],
			TypeName: "aws_connect_contact_flow",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ContactFlow")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.ContactFlowModuleReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ContactFlowModule"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_contact_flow_module"],
			TypeName: "aws_connect_contact_flow_module",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ContactFlowModule")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.HoursOfOperationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("HoursOfOperation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_hours_of_operation"],
			TypeName: "aws_connect_hours_of_operation",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "HoursOfOperation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.InstanceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Instance"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconnect.LambdaFunctionAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("LambdaFunctionAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_lambda_function_association"],
			TypeName: "aws_connect_lambda_function_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "LambdaFunctionAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.QueueReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Queue"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_queue"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersconnect.QuickConnectReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("QuickConnect"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_quick_connect"],
			TypeName: "aws_connect_quick_connect",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "QuickConnect")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.RoutingProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RoutingProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_routing_profile"],
			TypeName: "aws_connect_routing_profile",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "RoutingProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.SecurityProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SecurityProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_security_profile"],
			TypeName: "aws_connect_security_profile",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SecurityProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&controllersconnect.UserHierarchyStructureReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("UserHierarchyStructure"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_connect_user_hierarchy_structure"],
			TypeName: "aws_connect_user_hierarchy_structure",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "UserHierarchyStructure")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerscur.ReportDefinitionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_cur_report_definition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerscustomer.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_customer_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdataexchange.DataSetReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DataSet"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dataexchange_data_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdataexchange.RevisionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Revision"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dataexchange_revision"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatapipeline.PipelineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datapipeline_pipeline"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatapipeline.PipelineDefinitionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("PipelineDefinition"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datapipeline_pipeline_definition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.AgentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_agent"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.LocationEfsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_efs"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.LocationFsxLustreFileSystemReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("LocationFsxLustreFileSystem"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_fsx_lustre_file_system"],
			TypeName: "aws_datasync_location_fsx_lustre_file_system",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "LocationFsxLustreFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "datasync.aws.kubeform.com",
		...
		if err := (&controllersdatasync.LocationFsxWindowsFileSystemReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_fsx_windows_file_system"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.LocationHdfsReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("LocationHdfs"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_hdfs"],
			TypeName: "aws_datasync_location_hdfs",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "LocationHdfs")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "datasync.aws.kubeform.com",
		...
		if err := (&controllersdatasync.LocationNfsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_nfs"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.LocationS3Reconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_s3"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.LocationSmbReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_location_smb"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdatasync.TaskReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_datasync_task"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdax.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dax_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdax.ParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dax_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdax.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dax_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ClusterSnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_cluster_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.EventSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_event_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.InstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.InstanceRoleAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_instance_role_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.OptionGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_option_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ProxyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_proxy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ProxyDefaultTargetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_proxy_default_target_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ProxyEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_proxy_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.ProxyTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_proxy_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.SecurityGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_security_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.SnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdb.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_db_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.NetworkACLReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_network_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.RouteTableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_route_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.SecurityGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_security_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.SubnetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_subnet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.VpcReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_vpc"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdefault.VpcDHCPOptionsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_default_vpc_dhcp_options"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdetective.GraphReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Graph"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_detective_graph"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdetective.InvitationAccepterReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("InvitationAccepter"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_detective_invitation_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdetective.MemberReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Member"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_detective_member"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdevicefarm.DevicePoolReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DevicePool"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_device_pool"],
			TypeName: "aws_devicefarm_device_pool",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DevicePool")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "devicefarm.aws.kubeform.com",
		...
		if err := (&controllersdevicefarm.InstanceProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("InstanceProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_instance_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdevicefarm.NetworkProfileReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("NetworkProfile"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_network_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdevicefarm.ProjectReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_project"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdevicefarm.TestGridProjectReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TestGridProject"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_test_grid_project"],
			TypeName: "aws_devicefarm_test_grid_project",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TestGridProject")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "devicefarm.aws.kubeform.com",
		...
		if err := (&controllersdevicefarm.UploadReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Upload"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_devicefarm_upload"],
			TypeName: "aws_devicefarm_upload",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Upload")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersdirectoryservice.ConditionalForwarderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_directory_service_conditional_forwarder"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdirectoryservice.DirectoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_directory_service_directory"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdirectoryservice.LogSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_directory_service_log_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdlm.LifecyclePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dlm_lifecycle_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.CertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.EndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.EventSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_event_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.ReplicationInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_replication_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.ReplicationSubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_replication_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdms.ReplicationTaskReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dms_replication_task"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.ClusterInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_cluster_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.ClusterParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_cluster_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.ClusterSnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_cluster_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.GlobalClusterReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("GlobalCluster"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_global_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdocdb.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_docdb_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.BgpPeerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_bgp_peer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.ConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.ConnectionAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_connection_association"],
	...
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "ConnectionConfirmation",
	}:
		if err := (&controllersdx.ConnectionConfirmationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ConnectionConfirmation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_connection_confirmation"],
			TypeName: "aws_dx_connection_confirmation",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ConnectionConfirmation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
		...
		if err := (&controllersdx.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.GatewayAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_gateway_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.GatewayAssociationProposalReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_gateway_association_proposal"],
	...
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "HostedConnection",
	}:
		if err := (&controllersdx.HostedConnectionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("HostedConnection"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_connection"],
			TypeName: "aws_dx_hosted_connection",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "HostedConnection")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
		...
		if err := (&controllersdx.HostedPrivateVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_private_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.HostedPrivateVirtualInterfaceAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_private_virtual_interface_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.HostedPublicVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_public_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.HostedPublicVirtualInterfaceAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_public_virtual_interface_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.HostedTransitVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_transit_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.HostedTransitVirtualInterfaceAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_hosted_transit_virtual_interface_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.LagReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_lag"],
			TypeName: "aws_dx_lag",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.PrivateVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_private_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.PublicVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_public_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdx.TransitVirtualInterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dx_transit_virtual_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdynamodb.GlobalTableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dynamodb_global_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdynamodb.KinesisStreamingDestinationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dynamodb_kinesis_streaming_destination"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdynamodb.TableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dynamodb_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdynamodb.TableItemReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dynamodb_table_item"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersdynamodb.TagReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Tag"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_dynamodb_tag"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersebs.DefaultKmsKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_default_kms_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersebs.EncryptionByDefaultReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_encryption_by_default"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersebs.SnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersebs.SnapshotCopyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_snapshot_copy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersebs.SnapshotImportReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SnapshotImport"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_snapshot_import"],
			TypeName: "aws_ebs_snapshot_import",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SnapshotImport")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ebs.aws.kubeform.com",
		...
		if err := (&controllersebs.VolumeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ebs_volume"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.AvailabilityZoneGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_availability_zone_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.CapacityReservationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_capacity_reservation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.CarrierGatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_carrier_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ClientVPNAuthorizationRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_client_vpn_authorization_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ClientVPNEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_client_vpn_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ClientVPNNetworkAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_client_vpn_network_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ClientVPNRouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_client_vpn_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.FleetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_fleet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.HostReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Host"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_host"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.LocalGatewayRouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_local_gateway_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.LocalGatewayRouteTableVpcAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_local_gateway_route_table_vpc_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ManagedPrefixListReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_managed_prefix_list"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.ManagedPrefixListEntryReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ManagedPrefixListEntry"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_managed_prefix_list_entry"],
			TypeName: "aws_ec2_managed_prefix_list_entry",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ManagedPrefixListEntry")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.NetworkInsightsPathReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("NetworkInsightsPath"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_network_insights_path"],
			TypeName: "aws_ec2_network_insights_path",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "NetworkInsightsPath")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.SerialConsoleAccessReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SerialConsoleAccess"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_serial_console_access"],
			TypeName: "aws_ec2_serial_console_access",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SerialConsoleAccess")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.SubnetCIDRReservationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SubnetCIDRReservation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_subnet_cidr_reservation"],
			TypeName: "aws_ec2_subnet_cidr_reservation",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SubnetCIDRReservation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TagReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_tag"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TrafficMirrorFilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_traffic_mirror_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TrafficMirrorFilterRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_traffic_mirror_filter_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TrafficMirrorSessionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_traffic_mirror_session"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TrafficMirrorTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_traffic_mirror_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayConnectReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayConnect"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_connect"],
			TypeName: "aws_ec2_transit_gateway_connect",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayConnect")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayConnectPeerReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayConnectPeer"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_connect_peer"],
			TypeName: "aws_ec2_transit_gateway_connect_peer",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayConnectPeer")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayMulticastDomainReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayMulticastDomain"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_multicast_domain"],
			TypeName: "aws_ec2_transit_gateway_multicast_domain",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayMulticastDomain")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayMulticastDomainAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayMulticastDomainAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_multicast_domain_association"],
			TypeName: "aws_ec2_transit_gateway_multicast_domain_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayMulticastDomainAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayMulticastGroupMemberReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayMulticastGroupMember"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_multicast_group_member"],
			TypeName: "aws_ec2_transit_gateway_multicast_group_member",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayMulticastGroupMember")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayMulticastGroupSourceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TransitGatewayMulticastGroupSource"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_multicast_group_source"],
			TypeName: "aws_ec2_transit_gateway_multicast_group_source",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TransitGatewayMulticastGroupSource")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&controllersec2.TransitGatewayPeeringAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_peering_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayPeeringAttachmentAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_peering_attachment_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayPrefixListReferenceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_prefix_list_reference"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayRouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayRouteTableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_route_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayRouteTableAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_route_table_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayRouteTablePropagationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_route_table_propagation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayVpcAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_vpc_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersec2.TransitGatewayVpcAttachmentAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ec2_transit_gateway_vpc_attachment_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecr.LifecyclePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_lifecycle_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecr.PullThroughCacheRuleReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("PullThroughCacheRule"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_pull_through_cache_rule"],
			TypeName: "aws_ecr_pull_through_cache_rule",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "PullThroughCacheRule")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecr.aws.kubeform.com",
		...
		if err := (&controllersecr.RegistryPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_registry_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecr.RegistryScanningConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RegistryScanningConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_registry_scanning_configuration"],
			TypeName: "aws_ecr_registry_scanning_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "RegistryScanningConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecr.aws.kubeform.com",
		...
		if err := (&controllersecr.ReplicationConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_replication_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecr.RepositoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_repository"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecr.RepositoryPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecr_repository_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecrpublic.RepositoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecrpublic_repository"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecrpublic.RepositoryPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RepositoryPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecrpublic_repository_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.AccountSettingDefaultReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("AccountSettingDefault"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_account_setting_default"],
			TypeName: "aws_ecs_account_setting_default",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "AccountSettingDefault")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecs.aws.kubeform.com",
		...
		if err := (&controllersecs.CapacityProviderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_capacity_provider"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.ClusterCapacityProvidersReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ClusterCapacityProviders"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_cluster_capacity_providers"],
			TypeName: "aws_ecs_cluster_capacity_providers",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ClusterCapacityProviders")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecs.aws.kubeform.com",
		...
		if err := (&controllersecs.ServiceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_service"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.TagReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Tag"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_tag"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.TaskDefinitionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_task_definition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersecs.TaskSetReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("TaskSet"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ecs_task_set"],
			TypeName: "aws_ecs_task_set",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "TaskSet")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersefs.AccessPointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_efs_access_point"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersefs.BackupPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_efs_backup_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersefs.FileSystemReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_efs_file_system"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersefs.FileSystemPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_efs_file_system_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersefs.MountTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_efs_mount_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersegress.OnlyInternetGatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_egress_only_internet_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseip.EipReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eip"],
			TypeName: "aws_eip",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseip.AssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eip_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseks.AddonReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eks_addon"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseks.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eks_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseks.FargateProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eks_fargate_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerseks.IdentityProviderConfigReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IdentityProviderConfig"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eks_identity_provider_config"],
			TypeName: "aws_eks_identity_provider_config",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IdentityProviderConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "eks.aws.kubeform.com",
		...
		if err := (&controllerseks.NodeGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_eks_node_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticbeanstalk.ApplicationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastic_beanstalk_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticbeanstalk.ApplicationVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastic_beanstalk_application_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticbeanstalk.ConfigurationTemplateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastic_beanstalk_configuration_template"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticbeanstalk.EnvironmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastic_beanstalk_environment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.GlobalReplicationGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_global_replication_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.ParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.ReplicationGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_replication_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.SecurityGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_security_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.UserReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("User"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticache.UserGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("UserGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticache_user_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticsearchdomain.ElasticsearchDomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticsearch_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticsearchdomain.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticsearch_domain_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselasticsearchdomain.SamlOptionsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elasticsearch_domain_saml_options"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselastictranscoder.PipelineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastictranscoder_pipeline"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselastictranscoder.PresetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elastictranscoder_preset"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselb.ElbReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elb"],
			TypeName: "aws_elb",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerselb.AttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_elb_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.InstanceFleetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_instance_fleet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.InstanceGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_instance_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.ManagedScalingPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_managed_scaling_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.SecurityConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_security_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersemr.StudioReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Studio"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_studio"],
			TypeName: "aws_emr_studio",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Studio")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "emr.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "StudioSessionMapping",
	}:
		if err := (&controllersemr.StudioSessionMappingReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("StudioSessionMapping"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_emr_studio_session_mapping"],
			TypeName: "aws_emr_studio_session_mapping",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "StudioSessionMapping")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersflow.LogReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_flow_log"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersfms.AdminAccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fms_admin_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersfms.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fms_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersfsx.BackupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Backup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_backup"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersfsx.DataRepositoryAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DataRepositoryAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_data_repository_association"],
			TypeName: "aws_fsx_data_repository_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DataRepositoryAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.LustreFileSystemReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_lustre_file_system"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersfsx.OntapFileSystemReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OntapFileSystem"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_ontap_file_system"],
			TypeName: "aws_fsx_ontap_file_system",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OntapFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.OntapStorageVirtualMachineReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OntapStorageVirtualMachine"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_ontap_storage_virtual_machine"],
			TypeName: "aws_fsx_ontap_storage_virtual_machine",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OntapStorageVirtualMachine")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.OntapVolumeReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OntapVolume"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_ontap_volume"],
			TypeName: "aws_fsx_ontap_volume",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OntapVolume")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.OpenzfsFileSystemReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OpenzfsFileSystem"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_openzfs_file_system"],
			TypeName: "aws_fsx_openzfs_file_system",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OpenzfsFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "OpenzfsSnapshot",
	}:
		if err := (&controllersfsx.OpenzfsSnapshotReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OpenzfsSnapshot"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_openzfs_snapshot"],
			TypeName: "aws_fsx_openzfs_snapshot",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OpenzfsSnapshot")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.OpenzfsVolumeReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OpenzfsVolume"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_openzfs_volume"],
			TypeName: "aws_fsx_openzfs_volume",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "OpenzfsVolume")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&controllersfsx.WindowsFileSystemReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_fsx_windows_file_system"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgamelift.AliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_gamelift_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgamelift.BuildReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_gamelift_build"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgamelift.FleetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_gamelift_fleet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgamelift.GameSessionQueueReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_gamelift_game_session_queue"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgamelift.ScriptReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Script"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_gamelift_script"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglaciervault.GlacierVaultReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glacier_vault"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglaciervault.LockReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glacier_vault_lock"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglobalaccelerator.AcceleratorReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_globalaccelerator_accelerator"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglobalaccelerator.EndpointGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_globalaccelerator_endpoint_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglobalaccelerator.ListenerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_globalaccelerator_listener"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.CatalogDatabaseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_catalog_database"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.CatalogTableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_catalog_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.ClassifierReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_classifier"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.ConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.CrawlerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_crawler"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.DataCatalogEncryptionSettingsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_data_catalog_encryption_settings"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.DevEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_dev_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.JobReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_job"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.MlTransformReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_ml_transform"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.PartitionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_partition"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.PartitionIndexReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("PartitionIndex"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_partition_index"],
			TypeName: "aws_glue_partition_index",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "PartitionIndex")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "glue.aws.kubeform.com",
		...
		if err := (&controllersglue.RegistryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_registry"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.ResourcePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_resource_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.SchemaReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_schema"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.SecurityConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_security_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.TriggerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_trigger"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.UserDefinedFunctionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_user_defined_function"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersglue.WorkflowReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_glue_workflow"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersgrafana.LicenseAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("LicenseAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_grafana_license_association"],
			TypeName: "aws_grafana_license_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "LicenseAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "grafana.aws.kubeform.com",
		...
		if err := (&controllersgrafana.WorkspaceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Workspace"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_grafana_workspace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.DetectorReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_detector"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.FilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.InviteAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_invite_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.IpsetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_ipset"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.MemberReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_member"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.OrganizationAdminAccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_organization_admin_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.OrganizationConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_organization_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.PublishingDestinationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_publishing_destination"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersguardduty.ThreatintelsetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_guardduty_threatintelset"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.AccessKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_access_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.AccountAliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_account_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.AccountPasswordPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_account_password_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.GroupMembershipReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_group_membership"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.GroupPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_group_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.GroupPolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_group_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.InstanceProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_instance_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.OpenidConnectProviderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_openid_connect_provider"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.PolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.RoleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_role"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.RolePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_role_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.RolePolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_role_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.SamlProviderReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_saml_provider"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.ServerCertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_server_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.ServiceLinkedRoleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_service_linked_role"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.ServiceSpecificCredentialReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ServiceSpecificCredential"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_service_specific_credential"],
			TypeName: "aws_iam_service_specific_credential",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ServiceSpecificCredential")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iam.aws.kubeform.com",
		...
		if err := (&controllersiam.SigningCertificateReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SigningCertificate"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_signing_certificate"],
			TypeName: "aws_iam_signing_certificate",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SigningCertificate")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iam.aws.kubeform.com",
		...
		if err := (&controllersiam.UserReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.UserGroupMembershipReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user_group_membership"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.UserLoginProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user_login_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.UserPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.UserPolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.UserSSHKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_user_ssh_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiam.VirtualMfaDeviceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("VirtualMfaDevice"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iam_virtual_mfa_device"],
			TypeName: "aws_iam_virtual_mfa_device",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "VirtualMfaDevice")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.ComponentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_component"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.ContainerRecipeReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ContainerRecipe"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_container_recipe"],
			TypeName: "aws_imagebuilder_container_recipe",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ContainerRecipe")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "imagebuilder.aws.kubeform.com",
		...
		if err := (&controllersimagebuilder.DistributionConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_distribution_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.ImageReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_image"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.ImagePipelineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_image_pipeline"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.ImageRecipeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_image_recipe"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersimagebuilder.InfrastructureConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_imagebuilder_infrastructure_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinspector.AssessmentTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_inspector_assessment_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinspector.AssessmentTemplateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_inspector_assessment_template"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinspector.ResourceGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_inspector_resource_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinstance.InstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinternet.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_internet_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersinternet.GatewayAttachmentReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("GatewayAttachment"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_internet_gateway_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.AuthorizerReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Authorizer"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_authorizer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.CertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.PolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.RoleAliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_role_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.ThingReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_thing"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.ThingGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ThingGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_thing_group"],
			TypeName: "aws_iot_thing_group",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ThingGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iot.aws.kubeform.com",
		...
		if err := (&controllersiot.ThingGroupMembershipReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ThingGroupMembership"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_thing_group_membership"],
			TypeName: "aws_iot_thing_group_membership",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ThingGroupMembership")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iot.aws.kubeform.com",
		...
		if err := (&controllersiot.ThingPrincipalAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_thing_principal_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.ThingTypeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_thing_type"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersiot.TopicRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_iot_topic_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskey.PairReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_key_pair"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesis.AnalyticsApplicationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesis_analytics_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesis.FirehoseDeliveryStreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesis_firehose_delivery_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesis.StreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesis_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesis.StreamConsumerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesis_stream_consumer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesis.VideoStreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesis_video_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesisanalyticsv2.ApplicationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesisanalyticsv2_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskinesisanalyticsv2.ApplicationSnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kinesisanalyticsv2_application_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.AliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.CiphertextReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_ciphertext"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.ExternalKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_external_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.GrantReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_grant"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.KeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.ReplicaExternalKeyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ReplicaExternalKey"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_replica_external_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerskms.ReplicaKeyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ReplicaKey"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_kms_replica_key"],
			TypeName: "aws_kms_replica_key",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ReplicaKey")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerslakeformation.DataLakeSettingsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lakeformation_data_lake_settings"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslakeformation.PermissionsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lakeformation_permissions"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslakeformation.LakeformationResourceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lakeformation_resource"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.AliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.CodeSigningConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_code_signing_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.EventSourceMappingReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_event_source_mapping"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.FunctionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_function"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.FunctionEventInvokeConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_function_event_invoke_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.InvocationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Invocation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_invocation"],
			TypeName: "aws_lambda_invocation",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Invocation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "lambda.aws.kubeform.com",
		...
		if err := (&controllerslambda.LayerVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_layer_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.LayerVersionPermissionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("LayerVersionPermission"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_layer_version_permission"],
			TypeName: "aws_lambda_layer_version_permission",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "LayerVersionPermission")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "lambda.aws.kubeform.com",
		...
		if err := (&controllerslambda.PermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslambda.ProvisionedConcurrencyConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lambda_provisioned_concurrency_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslaunch.ConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_launch_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslaunch.TemplateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_launch_template"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.LbReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb"],
			TypeName: "aws_lb",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.CookieStickinessPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_cookie_stickiness_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.ListenerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_listener"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.ListenerCertificateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_listener_certificate"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.ListenerRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_listener_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.SslNegotiationPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_ssl_negotiation_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.TargetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_target_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslb.TargetGroupAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lb_target_group_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslex.BotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lex_bot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslex.BotAliasReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lex_bot_alias"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslex.IntentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lex_intent"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslex.SlotTypeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lex_slot_type"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslicensemanager.AssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_licensemanager_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslicensemanager.LicenseConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_licensemanager_license_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.DomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.InstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.InstancePublicPortsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_instance_public_ports"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.KeyPairReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_key_pair"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.StaticIPReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_static_ip"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerslightsail.StaticIPAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_lightsail_static_ip_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersloadbalancer.BackendServerPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_load_balancer_backend_server_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersloadbalancer.ListenerPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_load_balancer_listener_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersloadbalancer.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_load_balancer_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.AccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.ClassificationJobReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_classification_job"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.CustomDataIdentifierReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_custom_data_identifier"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.FindingsFilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_findings_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.InvitationAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_invitation_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.MemberReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_member"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie2.OrganizationAdminAccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie2_organization_admin_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie.MemberAccountAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie_member_account_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmacie.S3BucketAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_macie_s3_bucket_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmain.RouteTableAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_main_route_table_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmedia.ConvertQueueReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_media_convert_queue"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmedia.PackageChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_media_package_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmedia.StoreContainerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_media_store_container"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmedia.StoreContainerPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_media_store_container_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.AclReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Acl"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.ClusterReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Cluster"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.ParameterGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ParameterGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.SnapshotReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Snapshot"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.SubnetGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SubnetGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmemorydb.UserReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("User"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_memorydb_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmq.BrokerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_mq_broker"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmq.ConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_mq_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmsk.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_msk_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmsk.ConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_msk_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmsk.ScramSecretAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_msk_scram_secret_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersmskconnect.CustomPluginReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("CustomPlugin"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_mskconnect_custom_plugin"],
			TypeName: "aws_mskconnect_custom_plugin",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "CustomPlugin")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "mskconnect.aws.kubeform.com",
		...
		if err := (&controllersmskconnect.WorkerConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("WorkerConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_mskconnect_worker_configuration"],
			TypeName: "aws_mskconnect_worker_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "WorkerConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersmwaa.EnvironmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_mwaa_environment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnat.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_nat_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ClusterEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_cluster_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ClusterInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_cluster_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ClusterParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_cluster_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ClusterSnapshotReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_cluster_snapshot"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.EventSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_event_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.ParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersneptune.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_neptune_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetwork.AclReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetwork.AclAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("AclAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_acl_association"],
			TypeName: "aws_network_acl_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "AclAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "network.aws.kubeform.com",
		...
		if err := (&controllersnetwork.AclRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_acl_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetwork.InterfaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_interface"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetwork.InterfaceAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_interface_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetwork.InterfaceSgAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_network_interface_sg_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetworkfirewall.FirewallReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_networkfirewall_firewall"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetworkfirewall.FirewallPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_networkfirewall_firewall_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetworkfirewall.LoggingConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_networkfirewall_logging_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetworkfirewall.ResourcePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_networkfirewall_resource_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersnetworkfirewall.RuleGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_networkfirewall_rule_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.ApplicationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.CustomLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_custom_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.EcsClusterLayerReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("EcsClusterLayer"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_ecs_cluster_layer"],
			TypeName: "aws_opsworks_ecs_cluster_layer",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "EcsClusterLayer")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "opsworks.aws.kubeform.com",
		...
		if err := (&controllersopsworks.GangliaLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_ganglia_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.HaproxyLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_haproxy_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.InstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.JavaAppLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_java_app_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.MemcachedLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_memcached_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.MysqlLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_mysql_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.NodejsAppLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_nodejs_app_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.PermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.PhpAppLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_php_app_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.RailsAppLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_rails_app_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.RdsDbInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_rds_db_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.StackReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_stack"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.StaticWebLayerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_static_web_layer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersopsworks.UserProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_opsworks_user_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.AccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.DelegatedAdministratorReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_delegated_administrator"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.OrganizationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_organization"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.OrganizationalUnitReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_organizational_unit"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersorganizations.PolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_organizations_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.AdmChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_adm_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.ApnsChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_apns_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.ApnsSandboxChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_apns_sandbox_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.ApnsVoipChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_apns_voip_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.ApnsVoipSandboxChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_apns_voip_sandbox_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.AppReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_app"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.BaiduChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_baidu_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.EmailChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_email_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.EventStreamReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_event_stream"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.GcmChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_gcm_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerspinpoint.SmsChannelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_pinpoint_sms_channel"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersplacement.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_placement_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersprometheus.AlertManagerDefinitionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("AlertManagerDefinition"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_prometheus_alert_manager_definition"],
			TypeName: "aws_prometheus_alert_manager_definition",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "AlertManagerDefinition")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "prometheus.aws.kubeform.com",
		...
		if err := (&controllersprometheus.RuleGroupNamespaceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RuleGroupNamespace"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_prometheus_rule_group_namespace"],
			TypeName: "aws_prometheus_rule_group_namespace",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "RuleGroupNamespace")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "prometheus.aws.kubeform.com",
		...
		if err := (&controllersprometheus.WorkspaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_prometheus_workspace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersproxy.ProtocolPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_proxy_protocol_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersqldb.LedgerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_qldb_ledger"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersquicksight.DataSourceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DataSource"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_quicksight_data_source"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersquicksight.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_quicksight_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersquicksight.GroupMembershipReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("GroupMembership"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_quicksight_group_membership"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersquicksight.UserReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_quicksight_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersram.PrincipalAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ram_principal_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersram.ResourceAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ram_resource_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersram.ResourceShareReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ram_resource_share"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersram.ResourceShareAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ram_resource_share_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersrds.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersrds.ClusterEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_cluster_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersrds.ClusterInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_cluster_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersrds.ClusterParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_cluster_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersrds.ClusterRoleAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ClusterRoleAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_cluster_role_association"],
			TypeName: "aws_rds_cluster_role_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ClusterRoleAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "rds.aws.kubeform.com",
		...
		if err := (&controllersrds.GlobalClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_rds_global_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.ClusterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.EventSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_event_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.ParameterGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_parameter_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.ScheduledActionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ScheduledAction"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_scheduled_action"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.SecurityGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_security_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.SnapshotCopyGrantReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_snapshot_copy_grant"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.SnapshotScheduleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_snapshot_schedule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.SnapshotScheduleAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_snapshot_schedule_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersredshift.SubnetGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_redshift_subnet_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersresourcegroups.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_resourcegroups_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute.RouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route"],
			TypeName: "aws_route",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Route")
			return err
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.DelegationSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_delegation_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.HealthCheckReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_health_check"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.HostedZoneDnssecReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_hosted_zone_dnssec"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.KeySigningKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_key_signing_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.QueryLogReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_query_log"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.RecordReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_record"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverDnssecConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_dnssec_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverEndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverFirewallConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_firewall_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverFirewallDomainListReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_firewall_domain_list"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverFirewallRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_firewall_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverFirewallRuleGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_firewall_rule_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverFirewallRuleGroupAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_firewall_rule_group_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverQueryLogConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_query_log_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverQueryLogConfigAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_query_log_config_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ResolverRuleAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_resolver_rule_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.VpcAssociationAuthorizationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_vpc_association_authorization"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ZoneReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_zone"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53.ZoneAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53_zone_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53domains.RegisteredDomainReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RegisteredDomain"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53domains_registered_domain"],
			TypeName: "aws_route53domains_registered_domain",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "RegisteredDomain")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53recoverycontrolconfig.ClusterReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Cluster"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoverycontrolconfig_cluster"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53recoverycontrolconfig.ControlPanelReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ControlPanel"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoverycontrolconfig_control_panel"],
			TypeName: "aws_route53recoverycontrolconfig_control_panel",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ControlPanel")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoverycontrolconfig.aws.kubeform.com",
		...
		if err := (&controllersroute53recoverycontrolconfig.RoutingControlReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RoutingControl"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoverycontrolconfig_routing_control"],
			TypeName: "aws_route53recoverycontrolconfig_routing_control",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "RoutingControl")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoverycontrolconfig.aws.kubeform.com",
		...
		if err := (&controllersroute53recoverycontrolconfig.SafetyRuleReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("SafetyRule"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoverycontrolconfig_safety_rule"],
			TypeName: "aws_route53recoverycontrolconfig_safety_rule",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "SafetyRule")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53recoveryreadiness.CellReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Cell"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoveryreadiness_cell"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53recoveryreadiness.ReadinessCheckReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ReadinessCheck"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoveryreadiness_readiness_check"],
			TypeName: "aws_route53recoveryreadiness_readiness_check",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ReadinessCheck")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoveryreadiness.aws.kubeform.com",
		...
		if err := (&controllersroute53recoveryreadiness.RecoveryGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("RecoveryGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoveryreadiness_recovery_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute53recoveryreadiness.ResourceSetReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ResourceSet"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route53recoveryreadiness_resource_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute.TableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersroute.TableAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_route_table_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.AccessPointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_access_point"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.AccountPublicAccessBlockReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_account_public_access_block"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketAccelerateConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketAccelerateConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_accelerate_configuration"],
			TypeName: "aws_s3_bucket_accelerate_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketAccelerateConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketACLReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketACL"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketAnalyticsConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_analytics_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketCorsConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketCorsConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_cors_configuration"],
			TypeName: "aws_s3_bucket_cors_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketCorsConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketIntelligentTieringConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketIntelligentTieringConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_intelligent_tiering_configuration"],
			TypeName: "aws_s3_bucket_intelligent_tiering_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketIntelligentTieringConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketInventoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_inventory"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketLifecycleConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketLifecycleConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_lifecycle_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketLoggingReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketLogging"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_logging"],
			TypeName: "aws_s3_bucket_logging",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketLogging")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketMetricReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_metric"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketNotificationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_notification"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketObjectReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_object"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketObjectLockConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketObjectLockConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_object_lock_configuration"],
			TypeName: "aws_s3_bucket_object_lock_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketObjectLockConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketOwnershipControlsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_ownership_controls"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketPublicAccessBlockReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_public_access_block"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.BucketReplicationConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketReplicationConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_replication_configuration"],
			TypeName: "aws_s3_bucket_replication_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketReplicationConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketRequestPaymentConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketRequestPaymentConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_request_payment_configuration"],
			TypeName: "aws_s3_bucket_request_payment_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketRequestPaymentConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketServerSideEncryptionConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketServerSideEncryptionConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_server_side_encryption_configuration"],
			TypeName: "aws_s3_bucket_server_side_encryption_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketServerSideEncryptionConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketVersioningReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketVersioning"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_versioning"],
			TypeName: "aws_s3_bucket_versioning",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketVersioning")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.BucketWebsiteConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("BucketWebsiteConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_bucket_website_configuration"],
			TypeName: "aws_s3_bucket_website_configuration",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "BucketWebsiteConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&controllerss3.ObjectReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Object"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_object"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3.ObjectCopyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3_object_copy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3control.AccessPointPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("AccessPointPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_access_point_policy"],
			TypeName: "aws_s3control_access_point_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "AccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&controllerss3control.BucketReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_bucket"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3control.BucketLifecycleConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_bucket_lifecycle_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3control.BucketPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_bucket_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3control.MultiRegionAccessPointReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("MultiRegionAccessPoint"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_multi_region_access_point"],
			TypeName: "aws_s3control_multi_region_access_point",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "MultiRegionAccessPoint")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&controllerss3control.MultiRegionAccessPointPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("MultiRegionAccessPointPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_multi_region_access_point_policy"],
			TypeName: "aws_s3control_multi_region_access_point_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "MultiRegionAccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&controllerss3control.ObjectLambdaAccessPointReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ObjectLambdaAccessPoint"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_object_lambda_access_point"],
			TypeName: "aws_s3control_object_lambda_access_point",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ObjectLambdaAccessPoint")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&controllerss3control.ObjectLambdaAccessPointPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ObjectLambdaAccessPointPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3control_object_lambda_access_point_policy"],
			TypeName: "aws_s3control_object_lambda_access_point_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ObjectLambdaAccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerss3outposts.EndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_s3outposts_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.AppReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_app"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.AppImageConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_app_image_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.CodeRepositoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_code_repository"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.DeviceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Device"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_device"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.DeviceFleetReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("DeviceFleet"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_device_fleet"],
			TypeName: "aws_sagemaker_device_fleet",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "DeviceFleet")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.DomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.EndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_endpoint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.EndpointConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_endpoint_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.FeatureGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_feature_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.FlowDefinitionReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FlowDefinition"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_flow_definition"],
			TypeName: "aws_sagemaker_flow_definition",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FlowDefinition")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.HumanTaskUiReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("HumanTaskUi"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_human_task_ui"],
			TypeName: "aws_sagemaker_human_task_ui",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "HumanTaskUi")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.ImageReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_image"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.ImageVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_image_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.ModelReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_model"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.ModelPackageGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_model_package_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.ModelPackageGroupPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ModelPackageGroupPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_model_package_group_policy"],
			TypeName: "aws_sagemaker_model_package_group_policy",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ModelPackageGroupPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.NotebookInstanceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_notebook_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.NotebookInstanceLifecycleConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_notebook_instance_lifecycle_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.ProjectReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Project"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_project"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.StudioLifecycleConfigReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("StudioLifecycleConfig"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_studio_lifecycle_config"],
			TypeName: "aws_sagemaker_studio_lifecycle_config",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "StudioLifecycleConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.UserProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_user_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssagemaker.WorkforceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Workforce"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_workforce"],
			TypeName: "aws_sagemaker_workforce",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Workforce")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&controllerssagemaker.WorkteamReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Workteam"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sagemaker_workteam"],
			TypeName: "aws_sagemaker_workteam",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Workteam")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllersschemas.DiscovererReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_schemas_discoverer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersschemas.RegistryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_schemas_registry"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersschemas.SchemaReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_schemas_schema"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecretsmanager.SecretReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_secretsmanager_secret"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecretsmanager.SecretPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_secretsmanager_secret_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecretsmanager.SecretRotationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_secretsmanager_secret_rotation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecretsmanager.SecretVersionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_secretsmanager_secret_version"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurity.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_security_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurity.GroupRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_security_group_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.AccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.ActionTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_action_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.FindingAggregatorReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FindingAggregator"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_finding_aggregator"],
			TypeName: "aws_securityhub_finding_aggregator",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FindingAggregator")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "securityhub.aws.kubeform.com",
		...
		if err := (&controllerssecurityhub.InsightReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_insight"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.InviteAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_invite_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.MemberReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_member"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.OrganizationAdminAccountReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_organization_admin_account"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.OrganizationConfigurationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("OrganizationConfiguration"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_organization_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.ProductSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_product_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssecurityhub.StandardsControlReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("StandardsControl"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_standards_control"],
			TypeName: "aws_securityhub_standards_control",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "StandardsControl")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "securityhub.aws.kubeform.com",
		...
		if err := (&controllerssecurityhub.StandardsSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_securityhub_standards_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersserverlessapplicationrepository.CloudformationStackReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_serverlessapplicationrepository_cloudformation_stack"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicediscovery.HttpNamespaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_service_discovery_http_namespace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicediscovery.InstanceReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Instance"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_service_discovery_instance"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicediscovery.PrivateDNSNamespaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_service_discovery_private_dns_namespace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicediscovery.PublicDNSNamespaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_service_discovery_public_dns_namespace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicediscovery.ServiceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_service_discovery_service"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.BudgetResourceAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_budget_resource_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.ConstraintReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_constraint"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.OrganizationsAccessReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_organizations_access"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.PortfolioReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_portfolio"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.PortfolioShareReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_portfolio_share"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.PrincipalPortfolioAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_principal_portfolio_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.ProductReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_product"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.ProductPortfolioAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_product_portfolio_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.ProvisionedProductReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ProvisionedProduct"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_provisioned_product"],
			TypeName: "aws_servicecatalog_provisioned_product",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ProvisionedProduct")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "servicecatalog.aws.kubeform.com",
		...
		if err := (&controllersservicecatalog.ProvisioningArtifactReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_provisioning_artifact"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.ServiceActionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_service_action"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.TagOptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_tag_option"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicecatalog.TagOptionResourceAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicecatalog_tag_option_resource_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersservicequotas.ServiceQuotaReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_servicequotas_service_quota"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.ActiveReceiptRuleSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_active_receipt_rule_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.ConfigurationSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_configuration_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.DomainDkimReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_domain_dkim"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.DomainIdentityReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_domain_identity"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.DomainIdentityVerificationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_domain_identity_verification"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.DomainMailFromReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_domain_mail_from"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.EmailIdentityReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_email_identity"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.EventDestinationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_event_destination"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.IdentityNotificationTopicReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_identity_notification_topic"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.IdentityPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_identity_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.ReceiptFilterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_receipt_filter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.ReceiptRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_receipt_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.ReceiptRuleSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_receipt_rule_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersses.TemplateReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ses_template"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssfn.ActivityReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sfn_activity"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssfn.StateMachineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sfn_state_machine"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersshield.ProtectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_shield_protection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersshield.ProtectionGroupReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ProtectionGroup"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_shield_protection_group"],
			TypeName: "aws_shield_protection_group",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ProtectionGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "shield.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "ProtectionHealthCheckAssociation",
	}:
		if err := (&controllersshield.ProtectionHealthCheckAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("ProtectionHealthCheckAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_shield_protection_health_check_association"],
			TypeName: "aws_shield_protection_health_check_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "ProtectionHealthCheckAssociation")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&controllerssigner.SigningJobReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_signer_signing_job"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssigner.SigningProfileReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_signer_signing_profile"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssigner.SigningProfilePermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_signer_signing_profile_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssimpledb.DomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_simpledb_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssnapshot.CreateVolumePermissionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_snapshot_create_volume_permission"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssns.PlatformApplicationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sns_platform_application"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssns.SmsPreferencesReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sns_sms_preferences"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssns.TopicReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sns_topic"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssns.TopicPolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sns_topic_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssns.TopicSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sns_topic_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersspot.DatafeedSubscriptionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_spot_datafeed_subscription"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersspot.FleetRequestReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_spot_fleet_request"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersspot.InstanceRequestReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_spot_instance_request"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssqsqueue.SqsQueueReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sqs_queue"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssqsqueue.PolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_sqs_queue_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.ActivationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_activation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.AssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.DocumentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_document"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.MaintenanceWindowReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_maintenance_window"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.MaintenanceWindowTargetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_maintenance_window_target"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.MaintenanceWindowTaskReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_maintenance_window_task"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.ParameterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_parameter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.PatchBaselineReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_patch_baseline"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.PatchGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_patch_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssm.ResourceDataSyncReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssm_resource_data_sync"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssoadmin.AccountAssignmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssoadmin_account_assignment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssoadmin.ManagedPolicyAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssoadmin_managed_policy_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssoadmin.PermissionSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssoadmin_permission_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersssoadmin.PermissionSetInlinePolicyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_ssoadmin_permission_set_inline_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.CacheReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_cache"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.CachedIscsiVolumeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_cached_iscsi_volume"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.FileSystemAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("FileSystemAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_file_system_association"],
			TypeName: "aws_storagegateway_file_system_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "FileSystemAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "storagegateway.aws.kubeform.com",
		...
		if err := (&controllersstoragegateway.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.NfsFileShareReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_nfs_file_share"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.SmbFileShareReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_smb_file_share"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.StoredIscsiVolumeReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_stored_iscsi_volume"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.TapePoolReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_tape_pool"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.UploadBufferReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_upload_buffer"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersstoragegateway.WorkingStorageReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_storagegateway_working_storage"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssubnet.SubnetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_subnet"],
			TypeName: "aws_subnet",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Subnet")
			return err
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersswf.DomainReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_swf_domain"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerssynthetics.CanaryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_synthetics_canary"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstimestreamwrite.DatabaseReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_timestreamwrite_database"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstimestreamwrite.TableReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_timestreamwrite_table"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstransfer.AccessReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Access"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_transfer_access"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstransfer.ServerReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_transfer_server"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstransfer.SshKeyReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_transfer_ssh_key"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerstransfer.UserReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_transfer_user"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvolume.AttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_volume_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.VpcReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc"],
			TypeName: "aws_vpc",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Vpc")
			return err
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.DhcpOptionsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_dhcp_options"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.DhcpOptionsAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_dhcp_options_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint"],
	...
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "EndpointConnectionAccepter",
	}:
		if err := (&controllersvpc.EndpointConnectionAccepterReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("EndpointConnectionAccepter"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_connection_accepter"],
			TypeName: "aws_vpc_endpoint_connection_accepter",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "EndpointConnectionAccepter")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.EndpointConnectionNotificationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_connection_notification"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointPolicyReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("EndpointPolicy"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_policy"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointRouteTableAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_route_table_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointServiceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_service"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointServiceAllowedPrincipalReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_service_allowed_principal"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.EndpointSubnetAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_endpoint_subnet_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.IpamReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Ipam"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam"],
	...
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "IpamOrganizationAdminAccount",
	}:
		if err := (&controllersvpc.IpamOrganizationAdminAccountReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamOrganizationAdminAccount"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_organization_admin_account"],
			TypeName: "aws_vpc_ipam_organization_admin_account",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamOrganizationAdminAccount")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.IpamPoolReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamPool"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_pool"],
			TypeName: "aws_vpc_ipam_pool",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamPool")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.IpamPoolCIDRReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamPoolCIDR"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_pool_cidr"],
			TypeName: "aws_vpc_ipam_pool_cidr",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamPoolCIDR")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "IpamPoolCIDRAllocation",
	}:
		if err := (&controllersvpc.IpamPoolCIDRAllocationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamPoolCIDRAllocation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_pool_cidr_allocation"],
			TypeName: "aws_vpc_ipam_pool_cidr_allocation",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamPoolCIDRAllocation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "IpamPreviewNextCIDR",
	}:
		if err := (&controllersvpc.IpamPreviewNextCIDRReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamPreviewNextCIDR"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_preview_next_cidr"],
			TypeName: "aws_vpc_ipam_preview_next_cidr",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamPreviewNextCIDR")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.IpamScopeReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("IpamScope"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipam_scope"],
			TypeName: "aws_vpc_ipam_scope",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "IpamScope")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.Ipv4CIDRBlockAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipv4_cidr_block_association"],
	...
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		Version: "v1alpha1",
		Kind:    "Ipv6CIDRBlockAssociation",
	}:
		if err := (&controllersvpc.Ipv6CIDRBlockAssociationReconciler{
			Client:   mgr.GetClient(),
			Log:      ctrl.Log.WithName("controllers").WithName("Ipv6CIDRBlockAssociation"),
			Scheme:   mgr.GetScheme(),
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_ipv6_cidr_block_association"],
			TypeName: "aws_vpc_ipv6_cidr_block_association",
		}).SetupWithManager(ctx, mgr, auditor, restrictToNamespace); err != nil {
			setupLog.Error(err, "unable to create controller", "controller", "Ipv6CIDRBlockAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&controllersvpc.PeeringConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_peering_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.PeeringConnectionAccepterReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_peering_connection_accepter"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpc.PeeringConnectionOptionsReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpc_peering_connection_options"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpn.ConnectionReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpn_connection"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpn.ConnectionRouteReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpn_connection_route"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpn.GatewayReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpn_gateway"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpn.GatewayAttachmentReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpn_gateway_attachment"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersvpn.GatewayRoutePropagationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_vpn_gateway_route_propagation"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.ByteMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_byte_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.GeoMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_geo_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.IpsetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_ipset"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.RateBasedRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_rate_based_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.RegexMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_regex_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.RegexPatternSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_regex_pattern_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.RuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.RuleGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_rule_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.SizeConstraintSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_size_constraint_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.SqlInjectionMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_sql_injection_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.WebACLReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_web_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswaf.XssMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_waf_xss_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.ByteMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_byte_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.GeoMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_geo_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.IpsetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_ipset"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.RateBasedRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_rate_based_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.RegexMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_regex_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.RegexPatternSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_regex_pattern_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.RuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_rule"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.RuleGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_rule_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.SizeConstraintSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_size_constraint_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.SqlInjectionMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_sql_injection_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.WebACLReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_web_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.WebACLAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_web_acl_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafregional.XssMatchSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafregional_xss_match_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.IpSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_ip_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.RegexPatternSetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_regex_pattern_set"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.RuleGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_rule_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.WebACLReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_web_acl"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.WebACLAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_web_acl_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllerswafv2.WebACLLoggingConfigurationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_wafv2_web_acl_logging_configuration"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersworklink.FleetReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_worklink_fleet"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersworklink.WebsiteCertificateAuthorityAssociationReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_worklink_website_certificate_authority_association"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersworkspaces.DirectoryReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_workspaces_directory"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersworkspaces.IpGroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_workspaces_ip_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersworkspaces.WorkspaceReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_workspaces_workspace"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersxray.EncryptionConfigReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_xray_encryption_config"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersxray.GroupReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_xray_group"],
	...
	case schema.GroupVersionKind{
		...
		if err := (&controllersxray.SamplingRuleReconciler{
			...
			Gvk:      gvk,
			Provider: _provider,
			Resource: _provider.ResourcesMap["aws_xray_sampling_rule"],
...
func SetupWebhook(mgr manager.Manager, gvk schema.GroupVersionKind) error {
	...
	case schema.GroupVersionKind{
		...
		if err := (&accountv1alpha1.AlternateContact{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "AlternateContact")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "acm.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&appconfigv1alpha1.Application{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&appconfigv1alpha1.ConfigurationProfile{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ConfigurationProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appconfig.aws.kubeform.com",
		...
		if err := (&appconfigv1alpha1.Deployment{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Deployment")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&appconfigv1alpha1.DeploymentStrategy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DeploymentStrategy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appconfig.aws.kubeform.com",
		...
		if err := (&appconfigv1alpha1.Environment{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&appconfigv1alpha1.HostedConfigurationVersion{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "HostedConfigurationVersion")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appmesh.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&apprunnerv1alpha1.VpcConnector{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VpcConnector")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&appstreamv1alpha1.DirectoryConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DirectoryConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&appstreamv1alpha1.Fleet{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&appstreamv1alpha1.FleetStackAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FleetStackAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&appstreamv1alpha1.ImageBuilder{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ImageBuilder")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appstream.aws.kubeform.com",
		...
		if err := (&appstreamv1alpha1.Stack{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&appstreamv1alpha1.User{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&appstreamv1alpha1.UserStackAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "UserStackAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
		...
		if err := (&appsyncv1alpha1.ApiCache{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ApiCache")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&appsyncv1alpha1.DomainName{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DomainName")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&appsyncv1alpha1.DomainNameAPIAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DomainNameAPIAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "appsync.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&autoscalingv1alpha1.GroupTag{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "GroupTag")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "autoscaling.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&backupv1alpha1.Framework{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&backupv1alpha1.ReportPlan{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ReportPlan")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "backup.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&backupv1alpha1.VaultLockConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VaultLockConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "backup.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&batchv1alpha1.SchedulingPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SchedulingPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "budgets.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&chimev1alpha1.VoiceConnector{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnector")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorLogging{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorLogging")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorOrigination{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorOrigination")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorStreaming{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorStreaming")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorTermination{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorTermination")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "chime.aws.kubeform.com",
		...
		if err := (&chimev1alpha1.VoiceConnectorTerminationCredentials{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VoiceConnectorTerminationCredentials")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloud9.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloud9v1alpha1.EnvironmentMembership{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "EnvironmentMembership")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudcontrolapi.aws.kubeform.com",
		...
		if err := (&cloudcontrolapiv1alpha1.CloudcontrolapiResource{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "CloudcontrolapiResource")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudformationstack.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudfrontv1alpha1.FieldLevelEncryptionConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FieldLevelEncryptionConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
		...
		if err := (&cloudfrontv1alpha1.FieldLevelEncryptionProfile{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FieldLevelEncryptionProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudfrontv1alpha1.MonitoringSubscription{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "MonitoringSubscription")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudfront.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudfrontv1alpha1.ResponseHeadersPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ResponseHeadersPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudhsmv2.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudsearchv1alpha1.Domain{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudsearchv1alpha1.DomainServiceAccessPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DomainServiceAccessPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudtrail.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cloudtrailv1alpha1.EventDataStore{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "EventDataStore")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cloudwatch.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&codebuildv1alpha1.ResourcePolicy{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&codecommitv1alpha1.ApprovalRuleTemplate{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ApprovalRuleTemplate")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "codecommit.aws.kubeform.com",
		...
		if err := (&codecommitv1alpha1.ApprovalRuleTemplateAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ApprovalRuleTemplateAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "codecommit.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cognitov1alpha1.IdentityPoolProviderPrincipalTag{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IdentityPoolProviderPrincipalTag")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cognito.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&cognitov1alpha1.User{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "User")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&configv1alpha1.OrganizationConformancePack{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OrganizationConformancePack")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "config.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&connectv1alpha1.BotAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BotAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.ContactFlow{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ContactFlow")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.ContactFlowModule{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ContactFlowModule")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.HoursOfOperation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "HoursOfOperation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.Instance{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&connectv1alpha1.LambdaFunctionAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "LambdaFunctionAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.Queue{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&connectv1alpha1.QuickConnect{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "QuickConnect")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.RoutingProfile{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RoutingProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.SecurityProfile{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SecurityProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "connect.aws.kubeform.com",
		...
		if err := (&connectv1alpha1.UserHierarchyStructure{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "UserHierarchyStructure")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "cur.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&dataexchangev1alpha1.DataSet{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&dataexchangev1alpha1.Revision{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&datapipelinev1alpha1.PipelineDefinition{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "PipelineDefinition")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "datasync.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&datasyncv1alpha1.LocationFsxLustreFileSystem{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "LocationFsxLustreFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "datasync.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&datasyncv1alpha1.LocationHdfs{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "LocationHdfs")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "datasync.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&detectivev1alpha1.Graph{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Graph")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "detective.aws.kubeform.com",
		...
		if err := (&detectivev1alpha1.InvitationAccepter{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&detectivev1alpha1.Member{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&devicefarmv1alpha1.DevicePool{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DevicePool")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "devicefarm.aws.kubeform.com",
		...
		if err := (&devicefarmv1alpha1.InstanceProfile{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&devicefarmv1alpha1.NetworkProfile{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "NetworkProfile")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "devicefarm.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&devicefarmv1alpha1.TestGridProject{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TestGridProject")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "devicefarm.aws.kubeform.com",
		...
		if err := (&devicefarmv1alpha1.Upload{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Upload")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "directoryservice.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&docdbv1alpha1.GlobalCluster{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&dxv1alpha1.ConnectionConfirmation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ConnectionConfirmation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&dxv1alpha1.HostedConnection{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "HostedConnection")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "dx.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&dynamodbv1alpha1.Tag{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&ebsv1alpha1.SnapshotImport{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SnapshotImport")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ebs.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ec2v1alpha1.Host{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Host")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&ec2v1alpha1.ManagedPrefixListEntry{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ManagedPrefixListEntry")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.NetworkInsightsPath{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "NetworkInsightsPath")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.SerialConsoleAccess{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SerialConsoleAccess")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.SubnetCIDRReservation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SubnetCIDRReservation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ec2v1alpha1.TransitGatewayConnect{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayConnect")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.TransitGatewayConnectPeer{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayConnectPeer")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.TransitGatewayMulticastDomain{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayMulticastDomain")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.TransitGatewayMulticastDomainAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayMulticastDomainAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.TransitGatewayMulticastGroupMember{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayMulticastGroupMember")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
		...
		if err := (&ec2v1alpha1.TransitGatewayMulticastGroupSource{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TransitGatewayMulticastGroupSource")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ec2.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecrv1alpha1.PullThroughCacheRule{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "PullThroughCacheRule")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecr.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecrv1alpha1.RegistryScanningConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RegistryScanningConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecr.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecrpublicv1alpha1.RepositoryPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RepositoryPolicy")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&ecsv1alpha1.AccountSettingDefault{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "AccountSettingDefault")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecs.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecsv1alpha1.ClusterCapacityProviders{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ClusterCapacityProviders")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "ecs.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecsv1alpha1.Tag{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Tag")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&ecsv1alpha1.TaskSet{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "TaskSet")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "efs.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&eksv1alpha1.IdentityProviderConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IdentityProviderConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "eks.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&elasticachev1alpha1.User{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "User")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&elasticachev1alpha1.UserGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "UserGroup")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&emrv1alpha1.Studio{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Studio")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "emr.aws.kubeform.com",
		...
		if err := (&emrv1alpha1.StudioSessionMapping{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "StudioSessionMapping")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "flow.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&fsxv1alpha1.Backup{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&fsxv1alpha1.DataRepositoryAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DataRepositoryAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&fsxv1alpha1.OntapFileSystem{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OntapFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&fsxv1alpha1.OntapStorageVirtualMachine{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OntapStorageVirtualMachine")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&fsxv1alpha1.OntapVolume{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OntapVolume")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&fsxv1alpha1.OpenzfsFileSystem{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OpenzfsFileSystem")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&fsxv1alpha1.OpenzfsSnapshot{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OpenzfsSnapshot")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
		...
		if err := (&fsxv1alpha1.OpenzfsVolume{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OpenzfsVolume")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "fsx.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&gameliftv1alpha1.Script{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&gluev1alpha1.PartitionIndex{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "PartitionIndex")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "glue.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&grafanav1alpha1.LicenseAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "LicenseAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "grafana.aws.kubeform.com",
		...
		if err := (&grafanav1alpha1.Workspace{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&iamv1alpha1.ServiceSpecificCredential{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ServiceSpecificCredential")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iam.aws.kubeform.com",
		...
		if err := (&iamv1alpha1.SigningCertificate{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SigningCertificate")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iam.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&iamv1alpha1.VirtualMfaDevice{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "VirtualMfaDevice")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "imagebuilder.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&imagebuilderv1alpha1.ContainerRecipe{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ContainerRecipe")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "imagebuilder.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&internetv1alpha1.GatewayAttachment{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&iotv1alpha1.Authorizer{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Authorizer")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&iotv1alpha1.ThingGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ThingGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iot.aws.kubeform.com",
		...
		if err := (&iotv1alpha1.ThingGroupMembership{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ThingGroupMembership")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "iot.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&kmsv1alpha1.ReplicaExternalKey{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ReplicaExternalKey")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "kms.aws.kubeform.com",
		...
		if err := (&kmsv1alpha1.ReplicaKey{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ReplicaKey")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "lakeformation.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&lambdav1alpha1.Invocation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Invocation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "lambda.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&lambdav1alpha1.LayerVersionPermission{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "LayerVersionPermission")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "lambda.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.Acl{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.Cluster{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Cluster")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.ParameterGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ParameterGroup")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.Snapshot{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Snapshot")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.SubnetGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SubnetGroup")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&memorydbv1alpha1.User{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "User")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&mskconnectv1alpha1.CustomPlugin{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "CustomPlugin")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "mskconnect.aws.kubeform.com",
		...
		if err := (&mskconnectv1alpha1.WorkerConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "WorkerConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "mwaa.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&networkv1alpha1.AclAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "AclAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "network.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&opsworksv1alpha1.EcsClusterLayer{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "EcsClusterLayer")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "opsworks.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&prometheusv1alpha1.AlertManagerDefinition{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "AlertManagerDefinition")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "prometheus.aws.kubeform.com",
		...
		if err := (&prometheusv1alpha1.RuleGroupNamespace{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RuleGroupNamespace")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "prometheus.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&quicksightv1alpha1.DataSource{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DataSource")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&quicksightv1alpha1.GroupMembership{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "GroupMembership")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&rdsv1alpha1.ClusterRoleAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ClusterRoleAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "rds.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&redshiftv1alpha1.ScheduledAction{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ScheduledAction")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&route53domainsv1alpha1.RegisteredDomain{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RegisteredDomain")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoverycontrolconfig.aws.kubeform.com",
		...
		if err := (&route53recoverycontrolconfigv1alpha1.Cluster{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Cluster")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&route53recoverycontrolconfigv1alpha1.ControlPanel{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ControlPanel")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoverycontrolconfig.aws.kubeform.com",
		...
		if err := (&route53recoverycontrolconfigv1alpha1.RoutingControl{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RoutingControl")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoverycontrolconfig.aws.kubeform.com",
		...
		if err := (&route53recoverycontrolconfigv1alpha1.SafetyRule{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "SafetyRule")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoveryreadiness.aws.kubeform.com",
		...
		if err := (&route53recoveryreadinessv1alpha1.Cell{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&route53recoveryreadinessv1alpha1.ReadinessCheck{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ReadinessCheck")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoveryreadiness.aws.kubeform.com",
		...
		if err := (&route53recoveryreadinessv1alpha1.RecoveryGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "RecoveryGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route53recoveryreadiness.aws.kubeform.com",
		...
		if err := (&route53recoveryreadinessv1alpha1.ResourceSet{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ResourceSet")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "route.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketAccelerateConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketAccelerateConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketACL{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketCorsConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketCorsConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketIntelligentTieringConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketIntelligentTieringConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketLifecycleConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketLogging{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketLogging")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketObjectLockConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketObjectLockConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3v1alpha1.BucketReplicationConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketReplicationConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketRequestPaymentConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketRequestPaymentConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketServerSideEncryptionConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketServerSideEncryptionConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketVersioning{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketVersioning")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.BucketWebsiteConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "BucketWebsiteConfiguration")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3.aws.kubeform.com",
		...
		if err := (&s3v1alpha1.Object{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3controlv1alpha1.AccessPointPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "AccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&s3controlv1alpha1.MultiRegionAccessPoint{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "MultiRegionAccessPoint")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&s3controlv1alpha1.MultiRegionAccessPointPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "MultiRegionAccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&s3controlv1alpha1.ObjectLambdaAccessPoint{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ObjectLambdaAccessPoint")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3control.aws.kubeform.com",
		...
		if err := (&s3controlv1alpha1.ObjectLambdaAccessPointPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ObjectLambdaAccessPointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "s3outposts.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.Device{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.DeviceFleet{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "DeviceFleet")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.FlowDefinition{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FlowDefinition")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&sagemakerv1alpha1.HumanTaskUi{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "HumanTaskUi")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.ModelPackageGroupPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ModelPackageGroupPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.Project{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Project")
			return err
		}
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.StudioLifecycleConfig{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "StudioLifecycleConfig")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&sagemakerv1alpha1.Workforce{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Workforce")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "sagemaker.aws.kubeform.com",
		...
		if err := (&sagemakerv1alpha1.Workteam{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Workteam")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "schemas.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&securityhubv1alpha1.FindingAggregator{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FindingAggregator")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "securityhub.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&securityhubv1alpha1.OrganizationConfiguration{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "OrganizationConfiguration")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&securityhubv1alpha1.StandardsControl{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "StandardsControl")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "securityhub.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&servicediscoveryv1alpha1.Instance{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Instance")
			return err
		}
	case schema.GroupVersionKind{
	...
	case schema.GroupVersionKind{
		...
		if err := (&servicecatalogv1alpha1.ProvisionedProduct{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ProvisionedProduct")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "servicecatalog.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&shieldv1alpha1.ProtectionGroup{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ProtectionGroup")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "shield.aws.kubeform.com",
		...
		if err := (&shieldv1alpha1.ProtectionHealthCheckAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "ProtectionHealthCheckAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "signer.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&storagegatewayv1alpha1.FileSystemAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "FileSystemAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "storagegateway.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&transferv1alpha1.Access{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&vpcv1alpha1.EndpointConnectionAccepter{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "EndpointConnectionAccepter")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&vpcv1alpha1.EndpointPolicy{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "EndpointPolicy")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&vpcv1alpha1.Ipam{}).SetupWebhookWithManager(mgr); err != nil {
	...
	case schema.GroupVersionKind{
		...
		if err := (&vpcv1alpha1.IpamOrganizationAdminAccount{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamOrganizationAdminAccount")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&vpcv1alpha1.IpamPool{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamPool")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&vpcv1alpha1.IpamPoolCIDR{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamPoolCIDR")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&vpcv1alpha1.IpamPoolCIDRAllocation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamPoolCIDRAllocation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&vpcv1alpha1.IpamPreviewNextCIDR{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamPreviewNextCIDR")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
		...
		if err := (&vpcv1alpha1.IpamScope{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "IpamScope")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
	...
	case schema.GroupVersionKind{
		...
		if err := (&vpcv1alpha1.Ipv6CIDRBlockAssociation{}).SetupWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "Ipv6CIDRBlockAssociation")
			return err
		}
	case schema.GroupVersionKind{
		Group:   "vpc.aws.kubeform.com",
